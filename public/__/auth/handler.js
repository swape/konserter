...
*/
	...
	var I = function () {}
	var K = function (a) {
		if (sa !== sa) throw Error('SafeUrl is not meant to be built directly')
		this.ga = a
	}
	...
	var ta = {},
		ua = function () {
			if (ta !== ta) throw Error('SafeStyle is not meant to be built directly')
			this.fa = ''
		}
	...
	var va = {},
		wa = function () {
			if (va !== va) throw Error('SafeStyleSheet is not meant to be built directly')
			this.ea = ''
		}
	...
	var xa = {},
		ya = function () {
			...
			if (xa !== xa) throw Error('SafeHtml is not meant to be built directly')
			this.da = a
		}
	...
	var N,
		...
		Ja = function () {
			if (l.Promise && l.Promise.resolve) {
				...
				N = function () {
					var b = Ka
					'function' !== typeof l.setImmediate || (l.Window && l.Window.prototype && (G() || !F('Edge')) && l.Window.prototype.setImmediate == l.setImmediate)
						? (L || (L = Aa()), L(b))
						: l.setImmediate(b)
				}
		},
			...
			if (0 == a.g)
				if (a.m) {
					...
					if (c.i) {
						...
						e && (0 == c.g && 1 == d ? Ra(c, b) : (g ? ((d = g), w(c.i), w(null != d), d.next == c.s && (c.s = d), (d.next = d.next.next)) : Sa(c), Ta(c, e, 3, b)))
					}
					a.m = null
				} else P(a, 3, b)
		},
	...
	var P = function (a, b, c) {
			0 == a.g &&
				...
				(a.g = 1),
				Oa(c, a.ja, a.ka, a) || ((a.U = c), (a.g = b), (a.m = null), Ua(a), 3 != b || c instanceof Q || Wa(a, c)))
		},
		Oa = function (a, b, c, d) {
			if (a instanceof R)
				return (
	...
	V.prototype.la = function (a) {
		void 0 !== this.h && void 0 !== this.h[a] && (delete this.h[a], --this.T, 0 === this.T && void 0 !== this.J && this.J(this))
	}
	var db = function (a, b) {
	...
	function eb(a) {
		...
		for (var b = fa(['next', 'error', 'complete']), c = b.next(); !c.done; c = b.next()) if (((c = c.value), c in a && 'function' === typeof a[c])) return !0
		return !1
	}
	function fb() {}
	var W = $a,
	...
	X.prototype.aa = function (a, b) {
		...
		var c = b || '[DEFAULT]'
		return 'undefined' === typeof this.j[a][c] ? ((b = this.R.INTERNAL.factories[a](this, this.Z.bind(this), b)), (this.j[a][c] = b)) : this.j[a][c]
	}
	...
	function hb() {
		...
		function c(f, h) {
			...
			var p = h
			f = f.options
			'auth' === h && (f.serviceAccount || f.credential) && ((p = 'serverAuth'), 'serverAuth' in e || Z('sa-not-supported'))
			return p
		}
		var d = {},
			e = {},
			...
			k = {
				...
				initializeApp: function (f, h) {
					void 0 === h ? (h = '[DEFAULT]') : ('string' !== typeof h || '' === h) && Z('bad-app-name', {name: h + ''})
...
*/
	...
	n('Promise', function (a) {
		...
		e.prototype.pf = function () {
			...
			var h = this,
				k = !1
			return {resolve: g(this.ek), reject: g(this.mg)}
		}
		e.prototype.ek = function (g) {
			if (g === this) this.mg(new TypeError('A Promise cannot resolve to itself'))
			else if (g instanceof e) this.vk(g)
			else {
				a: switch (typeof g) {
					case 'object':
						var h = null != g
		...
		e.prototype.oi = function (g, h) {
			if (0 != this.R) throw Error('Cannot settle(' + g + ', ' + h + '): Promise already settled in state' + this.R)
			this.R = g
			this.ma = h
			2 === this.R && this.kk()
			this.dj()
		...
		e.prototype.dj = function () {
			if (null != this.tc) {
				for (var g = 0; g < this.tc.length; ++g) f.Ig(this.tc[g])
				this.tc = null
			}
		}
		var f = new b()
		...
		e.race = function (g) {
			return new e(function (h, k) {
				for (var m = ia(g), p = m.next(); !p.done; p = m.next()) c(p.value).Qd(h, k)
			})
		}
		e.all = function (g) {
			var h = ia(g),
			...
			return k.done
				...
				: new e(function (m, p) {
						...
						var t = [],
							z = 0
						do (t.push(void 0), z++, c(k.value).Qd(r(t.length - 1), p), (k = h.next()))
						while (!k.done)
					})
		}
		return e
	...
	n('Map', function (a) {
		...
		c.prototype.set = function (h, k) {
			...
			m.ha
				? (m.ha.value = k)
				: ((m.ha = {next: this[1], hb: this[1].hb, head: this[1], key: h, value: k}), m.list.push(m.ha), (this[1].hb.next = m.ha), (this[1].hb = m.ha), this.size++)
			return this
		}
		c.prototype.delete = function (h) {
			h = d(this, h)
			return h.ha && h.list
				? (h.list.splice(h.index, 1), h.list.length || delete this[0][h.id], (h.ha.hb.next = h.ha.next), (h.ha.next.hb = h.ha.hb), (h.ha.head = null), this.size--, !0)
				: !1
		}
		...
		var d = function (h, k) {
				...
				if (p && ka(h[0], m))
					for (h = 0; h < p.length; h++) {
						var r = p[h]
						if ((k !== k && r.key !== r.key) || k === r.key) return {id: m, list: p, index: h, ha: r}
					}
				return {id: m, list: p, index: -1, ha: void 0}
			},
			e = function (h, k) {
				var m = h[1]
				return fa(function () {
					if (m) {
						for (; m.head != h[1]; ) m = m.hb
	...
	var wb = hb() ? !1 : B('Opera'),
		...
		yb = B('Edge'),
		zb = yb || xb,
		Ab = B('Gecko') && !(A(db().toLowerCase(), 'webkit') && !B('Edge')) && !(B('Trident') || B('MSIE')) && !B('Edge'),
		Bb = A(db().toLowerCase(), 'webkit') && !B('Edge'),
		Cb = function () {
			var a = u.document
	...
	y(8 === Math.log2(256))
	y(9 === Math.log2(Math.max.apply(Math, ja(Object.values({al: 1, Zk: 2, Yk: 4, cl: 8, bl: 16, Ok: 32, il: 64, Vk: 128, Uk: 256, Xk: 512})))))
 ...
 SPDX-License-Identifier: Apache-2.0 */
	...
	var $b = !1,
		ac = !1
	function bc(a) {
		if (!a) throw Error('Expected value to be defined')
		return a
	}
	function cc(a) {
		var b = $b
	...
	function gc(a, b, c) {
		...
		if ('string' === typeof c) a.cssText = c
			...
			a.cssText = ''
			for (var d in c) ec.call(c, d) && ((b = c[d]), 0 <= d.indexOf('-') ? a.setProperty(d, b) : (a[d] = b))
		}
	}
	function hc(a, b, c) {
		var d = typeof c
	...
	function lc(a) {
		...
		if ((c = 11 === c.nodeType || 9 === c.nodeType ? c.activeElement : null) && a.contains(c))
			for (a = []; c !== b; ) ((c = bc(c)), a.push(c), (c = c.parentNode || (b ? c.host : null)))
	}
	var nc = function (a) {
		this.Fg = null
		this.key = a
	...
	function qc(a, b) {
		...
		return function (d, e, f) {
			...
			try {
				var r = a(d, e, f)
				if ($b) throw Error('elementOpenEnd() must be called after calling elementOpenStart().')
				return r
			} finally {
				;((oc = g), (pc = h), (mc = k), cc(m), dc(p))
			}
		}
	}
	var rc = ic()
	...
	var Gc = function (a) {
			if (a instanceof Fc && a.constructor === Fc && a.Ni === Ec) return a.zg
		...
		Dc = {}
	var Jc = function (a, b) {
		if (b !== Ic) throw Error('TrustedResourceUrl is not meant to be built directly')
		this.hg = a
	}
	...
	var Kc = function (a) {
			if (a instanceof Jc && a.constructor === Jc) return a.hg
			Ia("expected object of type TrustedResourceUrl, got '" + a + "' of type " + xa(a))
			return 'type_error:TrustedResourceUrl'
		},
		Oc = function (a, b) {
			var c = Gc(a)
			if (!Lc.test(c)) throw Error('Invalid TrustedResourceUrl format: ' + c)
	...
	var D = function (a, b) {
		if (b !== Pc) throw Error('SafeUrl is not meant to be built directly')
		this.gg = a
	}
	...
	var Qc = function (a) {
			if (a instanceof D && a.constructor === D) return a.gg
		...
		Tc = function (a) {
			...
			Sc.test(a) ? (a = new D(a, Pc)) : ((a = String(a).replace(/(%0A|%0D)/g, '')), (a = a.match(Rc) ? new D(a, Pc) : null))
			return a
		},
		Uc
	try {
	...
	var Yc = {},
		Zc = function () {
			if (Yc !== Yc) throw Error('SafeStyle is not meant to be built directly')
			this.Yh = ''
			this.bb = !0
		}
	...
	var $c = {},
		ad = function (a, b) {
			if (b !== $c) throw Error('SafeStyleSheet is not meant to be built directly')
			this.fg = a
			this.bb = !0
		}
	...
	var cd = {},
		dd = function (a, b) {
			if (b !== cd) throw Error('SafeHtml is not meant to be built directly')
			this.eg = a
			this.bb = !0
		}
	...
	var ed = function (a) {
			if (a instanceof dd && a.constructor === dd) return a.eg
	...
	var pd = function (a) {
		...
		rd = function (a, b, c) {
			...
			else for (var d = qd(a), e = pd(a), f = e.length, g = 0; g < f; g++) b.call(c, e[g], d && d[g], a)
		}
		...
		if (a instanceof ud) {
			...
			a && (b = String(a).match(sd))
				? ((this.Aa = !1),
					...
					Ad(this, b[6] || '', !0),
					Bd(this, b[7] || '', !0))
				: ((this.Aa = !1), (this.xa = new Dd(null, this.Aa)))
	}
	ud.prototype.toString = function () {
		...
		if ((c = this.fb)) (this.ga && '/' != c.charAt(0) && a.push('/'), a.push(Ed(c, '/' == c.charAt(0) ? Gd : Hd, !0)))
	...
	var vd = function (a, b, c) {
		...
		Ad = function (a, b, c) {
			wd(a)
			b instanceof Dd ? ((a.xa = b), a.xa.tg(a.Aa)) : (c || (b = Ed(b, Jd)), (a.xa = new Dd(b, a.Aa)))
			return a
		}
	...
	var wd = function (a) {
		if (a.Gj) throw Error('Tried to modify a read-only Uri')
	}
	...
	var G = function (a) {
		...
		Ed = function (a, b, c) {
			return 'string' === typeof a ? ((a = encodeURI(a).replace(b, Ld)), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, '%$1')), a) : null
		},
		Ld = function (a) {
			a = a.charCodeAt(0)
	...
	l.remove = function (a) {
		Md(this)
		a = this.va(a)
		return this.K.has(a) ? ((this.ua = null), (this.ea = Ja(this.ea) - this.K.get(a).length), this.K.delete(a)) : !1
	}
	l.clear = function () {
		this.K = this.ua = null
		this.ea = 0
	...
	l.ae = function () {
		Md(this)
		for (var a = Array.from(this.K.values()), b = Array.from(this.K.keys()), c = [], d = 0; d < b.length; d++) for (var e = a[d], f = 0; f < e.length; f++) c.push(b[d])
		return c
	}
	l.qb = function (a) {
		Md(this)
		var b = []
		if ('string' === typeof a) this.Pc(a) && (b = b.concat(this.K.get(this.va(a))))
		else {
	...
	var Nd = function (a, b, c) {
		a.remove(b)
		0 < c.length && ((a.ua = null), a.K.set(a.va(b), ub(c)), (a.ea = Ja(a.ea) + c.length))
	}
	l = Dd.prototype
	l.toString = function () {
...
*/
	...
	var Rd = function () {},
		Sd = function (a, b) {
			if (b !== Qd) throw Error('Bad secret')
			this.Wj = a
		}
	q(Sd, Rd)
	...
	var ee = function (a, b) {
		...
		fe = function (a) {
			...
			if (a.parent) return fe(a.parent)
		...
		le = function (a, b, c) {
			...
			if (d) {
				...
				if (0 < e.Rd) {
					var f = (e.ah + 1) % e.Rd
					e.ah = f
					e.Dh ? ((e = e.Mg[f]), e.reset(b, c, a), (a = e)) : ((e.Dh = f == e.Rd - 1), (a = e.Mg[f] = new de(b, c, a)))
				} else a = new de(b, c, a)
				ge(d, a)
			}
		},
	...
	re.prototype.yi = function () {
		if (this.Wg !== qe) throw Error('Sanitized content was not of kind HTML.')
	...
	;(function (a) {
		if (
			...
			(!Ud && a === a.raw) ||
			!((Ud && (!Object.isFrozen(Td) || !Object.isFrozen(Td.raw))) || (Object.isFrozen(a) && Object.isFrozen(a.raw))) ||
			1 !== a.length
		)
			throw new TypeError(
		...
		if (0 === b.indexOf('on') || 0 === 'on'.indexOf(b))
			throw Error(
				"Prefix '" + a[0] + "' does not guarantee the attribute to be safe as it is also a prefix for event handler attributesPlease use 'addEventListener' to set event handlers."
			)
	...
	;(function (a) {
		return qc(function (b, c, d) {
			...
			pc = e
			c(d)
			if (b.__incrementalDOMData) c = b.__incrementalDOMData
			else if (
				((c = Zb),
				...
				if (h) {
					var k
					if (!(k = c.Fg)) {
						for (k = Array(2 * h); 0 < k.length; ) k.pop()
						k = c.Fg = k
					}
					for (var m = 0, p = 0; m < h; m += 1, p += 2) {
						var r = d[m],
							t = r.value
						k[p] = r.name
						k[p + 1] = t
			...
			if (!((d.nextSibling === f && d.previousSibling === g) || h || d === c)) throw Error('There must be exactly one top level call corresponding to the patched element.')
			if (mc) for (b = b.nextSibling, f = mc, g = pc ? pc.nextSibling : mc.firstChild; g !== b; ) ((c = g.nextSibling), f.removeChild(g), oc.Xi.push(g), (g = c))
			return e === pc ? null : pc
		}, a)
	})(Je)
	Object.assign({}, {yj: !0}, Je)
	Object.assign({}, {yj: !0, Wh: !0}, Je)
	try {
	...
	var Ke = function (a) {
		...
		Xe = {SCRIPT: 1, STYLE: 1, HEAD: 1, IFRAME: 1, OBJECT: 1},
		Ye = {IMG: ' ', BR: '\n'},
		$e = function (a) {
			var b = []
			Ze(a, b, !0)
		...
		Ze = function (a, b, c) {
			if (!(a.nodeName in Xe))
				...
				else for (a = a.firstChild; a; ) (Ze(a, b, c), (a = a.nextSibling))
		},
		af = function (a) {
...
*/
	...
	Zb = 'ssk'
	var ef = function (a, b) {
			return Ae['fireauth.oauthhelper.ui.soy.pendingScreen']
				? Ae['fireauth.oauthhelper.ui.soy.pendingScreen'](a, b)
				: ve(
						'<div id="pending-screen"><div id="progressBar" class="' +
							...
							H('mdl-js-progress') +
							' ' +
							H('mdl-progress__indeterminate') +
							' ' +
							H('firebase-progress-bar') +
							'"></div></div>'
					)
		},
		ff = function (a, b) {
			...
			a = a.appName
			Ge()
			Ae['fireauth.oauthhelper.ui.soy.continueScreen']
				? (b = Ae['fireauth.oauthhelper.ui.soy.continueScreen']({appName: a}, b))
				: ((a = Ee(null == a || 'string' === typeof a, 'appName', a, 'null|string|undefined')),
					(b =
						...
						H('mdl-shadow--2dp') +
						' ' +
						H('firebase-container') +
						'"><button id="continue" class="' +
						H('mdl-button') +
						' ' +
						H('mdl-button--raised') +
						' ' +
						H('mdl-button--colored') +
						'">'),
					a ? ((a = 'Continue to ' + ye(a)), (b += a)) : (b += 'Continue to the app'),
					(b = ve(b + '</button></div>')))
			return b
		},
		gf = function (a, b) {
			a = a.errorMessage
			Ge()
			Ae['fireauth.oauthhelper.ui.soy.errorScreen']
				? (b = Ae['fireauth.oauthhelper.ui.soy.errorScreen']({errorMessage: a}, b))
				: ((b = Ee('string' === typeof a, 'errorMessage', a, 'string')),
					(b = ve('<div id="error-screen" class="' + H('mdl-card') + ' ' + H('mdl-shadow--2dp') + ' ' + H('firebase-container') + '">' + ye(b) + '</div>')))
			return b
		},
		hf = function (a, b) {
			if (Ae['fireauth.oauthhelper.ui.soy.appVerificationScreen']) return Ae['fireauth.oauthhelper.ui.soy.appVerificationScreen'](a, b)
			a =
	...
	var mf = function (a, b) {
		...
		kf
	x(mf, jf)
	for (var nf = [], of = 0; 63 > of; of++) nf[of] = 0
	...
	var qf = function (a) {
		...
		for (var c = a.Ik, d = 0, e = 0; e < b.length; ) ((c[d++] = (b[e] << 24) | (b[e + 1] << 16) | (b[e + 2] << 8) | b[e + 3]), (e = 4 * d))
		for (b = 16; 64 > b; b++) {
			e = c[b - 15] | 0
			d = c[b - 2] | 0
	...
	mf.prototype.update = function (a, b) {
		...
		var c = 0,
			d = this.pc
		if ('string' === typeof a) for (; c < b; ) ((this.Td[d++] = a.charCodeAt(c++)), d == this.blockSize && (qf(this), (d = 0)))
		else if (ya(a))
			for (; c < b; ) {
				var e = a[c++]
				if (!('number' == typeof e && 0 <= e && 255 >= e && e == (e | 0))) throw Error('message must be a byte array')
				this.Td[d++] = e
				d == this.blockSize && (qf(this), (d = 0))
			}
	...
	mf.prototype.digest = function () {
		...
		for (var c = 63; 56 <= c; c--) ((this.Td[c] = b & 255), (b /= 256))
		qf(this)
		for (c = b = 0; c < this.Oj; c++) for (var d = 24; 0 <= d; d -= 8) a[b++] = (this.F[c] >> d) & 255
		return a
	}
	var lf = [
	...
	tf.prototype.Gb = function () {
		this.Vc || ((this.Vc = !0), this.Uc())
	}
	tf.prototype.Uc = function () {
		if (this.xe) for (; this.xe.length; ) this.xe.shift()()
	}
	var uf = function (a, b) {
		this.type = a
	...
	x(wf, uf)
	var xf = Vd({2: 'touch', 3: 'pen', 4: 'mouse'})
	wf.prototype.init = function (a, b) {
		...
		d
			...
			: ((this.offsetX = Bb || void 0 !== a.offsetX ? a.offsetX : a.layerX),
	...
	Cf.prototype.add = function (a, b, c, d, e) {
		var f = a.toString()
		a = this.ia[f]
		a || ((a = this.ia[f] = []), this.Dd++)
		var g = Df(a, b, d, e)
		;-1 < g ? ((b = a[g]), c || (b.Pd = !1)) : ((b = new Af(b, this.src, f, !!d, e)), (b.Pd = c), a.push(b))
		return b
	}
	Cf.prototype.remove = function (a, b, c, d) {
		...
		var e = this.ia[a]
		b = Df(e, b, c, d)
		return -1 < b ? (Bf(e[b]), sb(e, b), 0 == e.length && (delete this.ia[a], this.Dd--), !0) : !1
	}
	var Ef = function (a, b) {
		var c = b.type
		c in a.ia && rb(a.ia[c], b) && (Bf(b), 0 == a.ia[c].length && (delete a.ia[c], a.Dd--))
	}
	...
	var Df = function (a, b, c, d) {
		for (var e = 0; e < a.length; ++e) {
			var f = a[e]
			if (!f.ud && f.listener == b && f.capture == !!c && f.ee == d) return e
		}
		return -1
	}
	var Ff = 'closure_lm_' + ((1e6 * Math.random()) | 0),
		...
		Rf = function (a, b, c, d, e) {
			if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Rf(a, b[f], c, d, e)
			else ((d = v(d) ? !!d.capture : !!d), (c = Kf(c)), a && a[yf] ? a.Da.remove(String(b), c, d, e) : a && (a = Mf(a)) && (b = a.Df(b, c, d, e)) && Sf(b))
		},
		Sf = function (a) {
			if ('number' !== typeof a && a && !a.ud) {
				...
				if (b && b[yf]) Ef(b.Da, a)
					...
					Hf--
					;(c = Mf(b)) ? (Ef(c, a), 0 == c.Dd && ((c.src = null), (b[Ff] = null))) : Bf(a)
				}
			}
		},
		Of = function (a) {
	...
	l.dispatchEvent = function (a) {
		...
		if (b) {
			var c = []
			for (var d = 1; b; b = b.Yf) (c.push(b), y(1e3 > ++d, 'infinite loop'))
		}
		b = this.Oi
		d = a.type || a
		if ('string' === typeof a) a = new uf(a, b)
		else if (a instanceof uf) a.target = a.target || b
		else {
			var e = a
			a = new uf(d, b)
			Ac(a, e)
		...
		a.pd || ((g = a.currentTarget = b), (e = Wf(g, d, !0, a) && e), a.pd || (e = Wf(g, d, !1, a) && e))
		if (c) for (f = 0; !a.pd && f < c.length; f++) ((g = a.currentTarget = c[f]), (e = Wf(g, d, !1, a) && e))
		return e
	}
	l.Uc = function () {
		Uf.Fc.Uc.call(this)
		if (this.Da) {
			var a = this.Da,
				...
				c
			for (c in a.ia) {
				for (var d = a.ia[c], e = 0; e < d.length; e++) (++b, Bf(d[e]))
				delete a.ia[c]
				a.Dd--
			}
		}
	...
	fg.prototype.send = function (a) {
		...
		this.Sa = !0
		var b = {headers: this.ng, method: this.Lh, credentials: this.Fb, cache: this.dc}
		a && (b.body = a)
	...
	fg.prototype.abort = function () {
		...
		this.status = 0
		this.Rc &&
			this.Rc.cancel('Request was aborted.').catch(function () {
				var b = a.P
				b && le(b, Zd, 'Fetch reader cancellation error.')
			})
		1 <= this.readyState && this.Sa && 4 != this.readyState && ((this.Sa = !1), hg(this))
		this.readyState = 0
	}
	fg.prototype.qj = function (a) {
		if (
			this.Sa &&
			((this.Xd = a),
			this.Dc || ((this.status = this.Xd.status), (this.statusText = this.Xd.statusText), (this.Dc = a.headers), (this.readyState = 2), gg(this)),
			this.Sa && ((this.readyState = 3), gg(this), this.Sa))
		)
			if ('arraybuffer' === this.responseType) a.arrayBuffer().then(this.oj.bind(this), this.ce.bind(this))
			else if ('undefined' !== typeof u.ReadableStream && 'body' in a) {
				this.Rc = a.body.getReader()
				if (this.zd) {
					if (this.responseType) throw Error('responseType must be empty for "streamBinaryChunks" mode responses.')
					this.response = []
				} else ((this.response = this.responseText = ''), (this.Ag = new TextDecoder()))
				ig(this)
			} else a.text().then(this.pj.bind(this), this.ce.bind(this))
	}
	var ig = function (a) {
	...
	fg.prototype.kj = function (a) {
		if (this.Sa) {
			if (this.zd && a.value) this.response.push(a.value)
			else if (!this.zd) {
				var b = a.value ? a.value : new Uint8Array(0)
				if ((b = this.Ag.decode(b, {stream: !a.done}))) this.response = this.responseText += b
			}
	...
	fg.prototype.pj = function (a) {
		this.Sa && ((this.response = this.responseText = a), hg(this))
	}
	fg.prototype.oj = function (a) {
		this.Sa && ((this.response = a), hg(this))
	}
	...
	l.getAllResponseHeaders = function () {
		...
		a = []
		for (var b = this.Dc.entries(), c = b.next(); !c.done; ) ((c = c.value), a.push(c[0] + ': ' + c[1]), (c = b.next()))
		return a.join('\r\n')
	}
	l.rg = function (a) {
		this.Fb = a
	...
	jg.prototype.put = function (a) {
		this.ck(a)
		this.ve < this.Jj && (this.ve++, (a.next = this.fe), (this.fe = a))
	}
	var kg,
		lg = function () {
	...
	mg.prototype.add = function (a, b) {
		var c = ng.get()
		c.set(a, b)
		this.Xe ? (this.Xe.next = c) : (y(!this.ac), (this.ac = c))
		this.Xe = c
	}
	mg.prototype.remove = function () {
		var a = null
		this.ac && ((a = this.ac), (this.ac = this.ac.next), this.ac || (this.Xe = null), (a.next = null))
		return a
	}
	var ng = new jg(
			function () {
	...
	var sg,
		...
		vg = function () {
			if (u.Promise && u.Promise.resolve) {
				...
				sg = function () {
					var b = xg
					'function' !== typeof u.setImmediate || (u.Window && u.Window.prototype && (hb() || !B('Edge')) && u.Window.prototype.setImmediate == u.setImmediate)
						? (kg || (kg = lg()), kg(b))
						: u.setImmediate(b)
				}
		},
	...
	var Dg = new jg(
		...
		Ig = function (a) {
			return new I(function (b) {
				...
				if (c)
					for (
						var e = function (h, k, m) {
								c--
								d[h] = k ? {oh: !0, value: m} : {oh: !1, reason: m}
								0 == c && b(d)
							},
							f = 0,
							g;
	...
	var Mg = function (a, b) {
			if (0 == a.R)
				if (a.sa) {
					var c = a.sa
					if (c.Za) {
						for (var d = 0, e = null, f = null, g = c.Za; g && (g.Mc || (d++, g.child == a && (e = g), !(e && 1 < d))); g = g.next) e || (f = g)
						e && (0 == c.R && 1 == d ? Mg(c, b) : (f ? ((d = f), y(c.Za), y(null != d), d.next == c.ec && (c.ec = d), (d.next = d.next.next)) : Ng(c), Og(c, e, 3, b)))
					}
					a.sa = null
				} else Ag(a, 3, b)
		},
	...
	var Ag = function (a, b, c) {
			0 == a.R &&
				(a === c && ((b = 3), (c = new TypeError('Promise cannot resolve to itself'))),
				(a.R = 1),
				Fg(c, a.Dk, a.Ek, a) || ((a.ma = c), (a.R = b), (a.sa = null), Pg(a), 3 != b || c instanceof Bg || Qg(a, c)))
		},
		Fg = function (a, b, c, d) {
			if (a instanceof I)
				return (
					null != b && La(b, 'opt_onFulfilled should be a function.'),
			...
			if (zg(a)) return (a.then(b, c, d), !0)
			if (v(a))
				try {
					var e = a.then
					if ('function' === typeof e) return (Rg(a, e, b, c, d), !0)
				} catch (f) {
					return (c.call(d, f), !0)
				}
			return !1
	...
	I.prototype.cj = function () {
		for (var a; (a = Ng(this)); ) Og(this, a, this.R, this.ma)
		this.xf = !1
	}
	var Og = function (a, b, c, d) {
			if (3 == c && b.sc && !b.Mc) for (; a && a.be; a = a.sa) a.be = !1
			if (b.child) ((b.child.sa = null), Sg(b, c, d))
			else
				try {
...
*/
	...
	Ug.prototype.cancel = function (a) {
		if (this.jc) this.ma instanceof Ug && this.ma.cancel()
		else {
			if (this.sa) {
				var b = this.sa
				delete this.sa
				a ? b.cancel(a) : (b.hf--, 0 >= b.hf && b.cancel())
			}
	...
	var eh = function (a) {
		...
		Yg = function (a) {
			if (a.Te && a.jc && eh(a)) {
				var b = a.Te,
					c = fh[b]
				c && (u.clearTimeout(c.Ea), delete fh[b])
				a.Te = 0
			}
			a.sa && (a.sa.hf--, delete a.sa)
			b = a.ma
			for (var d = (c = !1); a.Le.length && !a.gf; ) {
				...
				if ((f = a.bd ? g : f))
					try {
						...
						h === dh && (h = void 0)
						void 0 !== h && ((a.bd = a.bd && (h == b || h instanceof Error)), (a.ma = b = h))
						if (zg(b) || ('function' === typeof u.Promise && b instanceof u.Promise)) ((d = !0), (a.gf = !0))
					} catch (k) {
						;((b = k), (a.bd = !0), eh(a) || (c = !0))
					}
			}
			a.ma = b
			d && ((h = w(a.Xg, a, !0)), (d = w(a.Xg, a, !1)), b instanceof Ug ? (bh(b, h, d), (b.Lg = !0)) : b.then(h, d))
			c && ((b = new gh(b)), (fh[b.Ea] = b), (a.Te = b.Ea))
		},
		Zg = function () {
			Da.call(this)
		}
	...
	var lh = function (a) {
			...
			e.onload = e.onreadystatechange = function () {
				;(e.readyState && 'loaded' != e.readyState && 'complete' != e.readyState) || (ih(e, b.ll || !1, h), g.callback(null))
			}
			e.onerror = function () {
				ih(e, !0, h)
	...
	L.prototype.send = function (a, b, c, d) {
		if (this.j) throw Error('[goog.net.XhrIo] Object is active with another request=' + this.pe + '; newUri=' + a)
		...
		this.Xj &&
			...
			((this.j.onprogress = w(function (g) {
				this.Uh(g, !0)
			}, this)),
			this.j.upload && (this.j.upload.onprogress = w(this.Uh, this)))
		try {
			;(ne(this.P, qh(this, 'Opening Xhr')), (this.Jf = !0), this.j.open(b, String(a), !0), (this.Jf = !1))
		} catch (g) {
		...
		b = ia(c)
		for (d = b.next(); !d.done; d = b.next()) ((c = ia(d.value)), (d = c.next().value), (c = c.next().value), this.j.setRequestHeader(d, c))
		...
		try {
			;(rh(this),
				0 < this.Gc &&
					...
					this.Ue ? ((this.j.timeout = this.Gc), (this.j.ontimeout = w(this.Cd, this))) : (this.Qe = mh(this.Cd, this.Gc, this))),
				ne(this.P, qh(this, 'Sending request')),
				(this.ke = !0),
				this.j.send(a),
				(this.ke = !1))
		} catch (g) {
			;(ne(this.P, qh(this, 'Send error: ' + g.message)), this.Y(5, g))
		}
	}
	var sh = function (a) {
	...
	L.prototype.Cd = function () {
		'undefined' != typeof wa && this.j && ((this.gd = 'Timed out after ' + this.Gc + 'ms, aborting'), ne(this.P, qh(this, this.gd)), this.dispatchEvent('timeout'), this.abort(8))
	}
	L.prototype.Y = function (a, b) {
		this.lb = !1
		this.j && ((this.Nb = !0), this.j.abort(), (this.Nb = !1))
		this.gd = b
		th(this)
		uh(this)
	}
	var th = function (a) {
		a.vf || ((a.vf = !0), a.dispatchEvent('complete'), a.dispatchEvent('error'))
	}
	L.prototype.abort = function () {
		this.j &&
			this.lb &&
			(ne(this.P, qh(this, 'Aborting')), (this.lb = !1), (this.Nb = !0), this.j.abort(), (this.Nb = !1), this.dispatchEvent('complete'), this.dispatchEvent('abort'), uh(this))
	}
	L.prototype.Uc = function () {
		this.j && (this.lb && ((this.lb = !1), (this.Nb = !0), this.j.abort(), (this.Nb = !1)), uh(this, !0))
		L.Fc.Uc.call(this)
	}
	...
	var vh = function (a) {
		if (a.lb && 'undefined' != typeof wa)
			if (a.Ye[1] && 4 == wh(a) && 2 == xh(a)) ne(a.P, qh(a, 'Local request error detected and ignored'))
			else if (a.ke && 4 == wh(a)) mh(a.Vh, 0, a)
			else if ((a.dispatchEvent('readystatechange'), 4 == wh(a))) {
				...
				try {
					...
					if (d) (a.dispatchEvent('complete'), a.dispatchEvent('success'))
						...
						try {
							...
							;(ne(a.P, 'Can not get status: ' + h.message), (g = ''))
						}
						a.gd = g + ' [' + xh(a) + ']'
						th(a)
					}
	...
	var yh = function (a, b) {
		...
		rh = function (a) {
			...
			a.Qe && (u.clearTimeout(a.Qe), (a.Qe = null))
		}
	...
	L.prototype.getResponse = function () {
		try {
			...
			return (ne(this.P, 'Can not get response: ' + a.message), null)
		}
	}
	L.prototype.getResponseHeader = function (a) {
		if (this.j && 4 == wh(this)) return ((a = this.j.getResponseHeader(a)), null === a ? void 0 : a)
	}
	...
	var zh = {
		...
		Ah = function (a) {
			for (var b in zh) if (zh[b].id === a) return ((a = zh[b]), {firebaseEndpoint: a.Yd, secureTokenEndpoint: a.Ie, identityPlatformEndpoint: a.he})
			return null
		},
		Bh
	...
	var Ch = function () {
		...
		Nh = function (a, b, c) {
			...
			'Firefox' == Jh(M()) && ((a = a || 'http://localhost'), (b.scrollbars = !0))
			e = a || ''
			b || (b = {})
			a = window
			...
			var h = f.join(',')
			;((B('iPhone') && !B('iPod') && !B('iPad')) || B('iPad') || B('iPod')) && a.navigator && a.navigator.standalone && e && '_self' != e
				? ((h = Pe(document, 'A')),
					sc(h, 'A'),
				...
				: c
					? ((h = md('', a, e, h)),
						...
						h &&
							...
							(d = h.document) && d.write && (d.write(ed(a)), d.close())))
					: ((h = md(d, a, e, h)) && b.noopener && (h.opener = null), h && b.noreferrer && (h.opener = null))
			if (h)
				try {
					h.focus()
				} catch (k) {}
		...
		Rh = function (a, b) {
			...
			for (var d = 0; d < a.length; d++) {
				...
				0 == e.indexOf('chrome-extension://')
					? (e = G(e).ga == c && 'chrome-extension' == b)
					: 'http' != b && 'https' != b
						? (e = !1)
						: Qh.test(e)
							? (e = c == e)
							: ((e = e.split('.').join('\\.')), (e = new RegExp('^(.+\\.' + e + '|' + e + ')$', 'i').test(c)))
				if (e) return !0
			}
			return !1
		},
		...
		Jh = function (a) {
			...
			if (!A(b, 'safari/') || A(b, 'chrome/') || A(b, 'crios/') || A(b, 'android'))
				if ((!A(b, 'chrome/') && !A(b, 'crios/')) || A(b, 'edge/')) {
					...
					if ((a = a.match(RegExp('([a-zA-Z\\d\\.]+)/[a-zA-Z\\d\\.]*$'))) && 2 == a.length) return a[1]
				} else return 'Chrome'
			else return 'Safari'
			return 'Other'
		},
		ci = {Pk: 'FirebaseCore-web', Rk: 'FirebaseUI-web', Wk: 'gcip-iap'},
		di = function (a, b, c) {
			c = c || []
			var d = [],
				e = {},
				f
			for (f in ci) e[ci[f]] = !0
		...
		N = function (a, b) {
			...
			try {
				var a = u.localStorage,
					b = ei()
				if (a) return (a.setItem(b, '1'), a.removeItem(b), Ch() ? !!u.indexedDB : !0)
			} catch (c) {
	...
	pi.prototype.get = function () {
		var a = u.navigator
		return (a && 'boolean' === typeof a.onLine && (gi() || 'chrome-extension:' === Wh() || 'undefined' !== typeof a.connection) ? a.onLine : 1)
			? this.Ej
				? this.Mj
				: this.ri
	...
	var qi = function () {
		...
		ri = function () {
			...
			return qi() || !a
				...
				: new I(function (c) {
						b = function () {
							qi() && (a.removeEventListener('visibilitychange', b, !1), c())
						}
		...
		vi = function () {
			if (u.document)
				try {
					var a = Oe('META', {name: 'referrer', content: 'no-referrer'}),
	...
	var zi = {},
		Ai = function (a) {
			zi[a] || ((zi[a] = !0), 'undefined' !== typeof console && 'function' === typeof console.warn && console.warn(a))
		}
	var Bi
	try {
		var Ci = {}
		Object.defineProperty(Ci, 'abcd', {configurable: !0, enumerable: !0, value: 1})
		Object.defineProperty(Ci, 'abcd', {configurable: !0, enumerable: !0, value: 2})
		Bi = 2 == Ci.abcd
	} catch (a) {
		Bi = !1
	}
	var O = function (a, b, c) {
			Bi ? Object.defineProperty(a, b, {configurable: !0, enumerable: !0, value: c}) : (a[b] = c)
		},
		Di = function (a, b) {
	...
	var Hi = 'oauth_consumer_key oauth_nonce oauth_signature oauth_signature_method oauth_timestamp oauth_token oauth_version'.split(' '),
		...
		Ji = {
			Qk: {fd: 'locale', wc: 700, vc: 600, providerId: 'facebook.com', vd: Ii},
			Sk: {fd: null, wc: 500, vc: 750, providerId: 'github.com', vd: Ii},
			Tk: {fd: 'hl', wc: 515, vc: 680, providerId: 'google.com', vd: Ii},
			jl: {fd: 'lang', wc: 485, vc: 705, providerId: 'twitter.com', vd: Hi},
			Mk: {fd: 'locale', wc: 640, vc: 600, providerId: 'apple.com', vd: []}
		},
		Ki = function (a) {
			for (var b in Ji) if (Ji[b].providerId == a) return Ji[b]
			return null
		},
		Li = function (a) {
			return ((a = Ki(a)) && a.vd) || []
	...
	var Pi = function (a, b, c, d, e, f, g) {
		...
		if (this.Xa || this.Y) {
			...
			if (this.Xa && !this.xd) throw new P('invalid-auth-event')
	...
	l.m = function () {
		return {type: this.Ic, eventId: this.T, urlResponse: this.Xa, sessionId: this.xd, postBody: this.dg, tenantId: this.C, error: this.Y && this.Y.m()}
	}
	var Qi = function (a) {
		a = a || {}
	...
	var Si = function (a, b) {
		if (!b || !a || !a.mfaEnrollmentId) throw new P('internal-error', 'Internal assert: invalid MultiFactorInfo object')
	...
	var Vi = function (a) {
			try {
				if (a.phoneInfo) return new Ti(a)
				if (a.totpInfo) return new Ui(a)
			} catch (b) {}
			return null
		},
		Ti = function (a) {
			var b = a.phoneInfo
			if (!b) throw new P('internal-error', 'Internal assert: invalid Phone MultiFactorInfo object')
	...
	var Ui = function (a) {
		var b = a.totpInfo
		if (!b) throw new P('internal-error', 'Internal assert: invalid TOTP MultiFactorInfo object')
		Si.call(this, a, 'totp')
		O(this, 'totpInfo', b)
	}
	q(Ui, Si)
	...
	var Yi = function (a) {
			...
			Di(this, {apiKey: b, operation: d, code: c, continueUrl: F(a, 'continueUrl') || null, languageCode: F(a, 'languageCode') || null, tenantId: F(a, 'tenantId') || null})
		},
		Zi = function (a) {
			try {
				return new Yi(a)
	...
	var $i = function (a, b, c, d, e, f, g) {
		...
		bj = function (a) {
			...
			var c = F(b, 'platform'),
				...
				f = F(b, 'link')
			b = F(b, 'appName')
			return a && c && d && e && f && b ? ((a = new $i(a, c, d, e, f)), aj(a, b), a) : null
		},
		cj = function (a) {
			var b = G(a),
				c = F(b, 'link'),
		...
		dj = function (a, b) {
			...
			'android' == a.Ae ? (E(c, 'apn', a.Jd), E(c, 'afl', b)) : 'ios' == a.Ae && (E(c, 'ibi', a.Jd), E(c, 'ifl', b))
			return c
		}
	$i.prototype.toString = function (a) {
		if ('android_non_gmscore' == this.Ae) a = this.qe
		else if (this.Af)
			if (a) {
				...
				E(b, 'link', a.toString())
				a = b.toString()
			} else ((a = dj(this, this.jh)), E(a, 'link', this.qe), (a = a.toString()))
		else
	...
	jj.prototype.m = function () {
		return 'enroll' == this.type ? {multiFactorSession: {idToken: this.ge}} : {multiFactorSession: {pendingCredential: this.Mh}}
	}
	var kj = function () {}
	...
	var lj = function (a, b) {
			return a
				.then(function (c) {
					if (c.idToken) {
						var d = hj(c.idToken)
						if (!d || b != d.Kj) throw new P('user-mismatch')
						return c
					}
	...
	var qj = function (a) {
		...
		rj = function (a, b, c) {
			...
			else if (b.oauthToken && b.oauthTokenSecret) (O(this, 'accessToken', b.oauthToken), O(this, 'secret', b.oauthTokenSecret))
			else throw new P('internal-error', 'failed to construct a credential')
			O(this, 'providerId', a)
	...
	l.Pb = function () {
		...
		a = {postBody: Od(a).toString(), requestUri: 'http://localhost'}
	...
	var sj = function (a) {
		...
		tj = function (a, b) {
			this.bk = b || []
			Di(this, {providerId: a, isOAuthProvider: !0})
			this.dh = {}
	...
	var uj = function (a) {
		if (!Mi(a)) throw new P('argument-error', 'SAML provider IDs must be prefixed with "saml."')
		tj.call(this, a, [])
	}
	x(uj, tj)
	var vj = function (a) {
	...
	vj.prototype.credential = function (a, b) {
		a = v(a) ? {idToken: a.idToken || null, accessToken: a.accessToken || null, nonce: a.rawNonce || null} : {idToken: a || null, accessToken: b || null}
	...
	var xj = function (a) {
			...
			var b = a
			v(a) && (b = a.accessToken)
			return new wj().credential({accessToken: b})
		},
		yj = function () {
	...
	var zj = function (a) {
			...
			var b = a
			v(a) && (b = a.accessToken)
			return new yj().credential({accessToken: b})
		},
		Aj = function () {
	...
	var Bj = function (a, b) {
			var c = a
			v(a) && ((c = a.idToken), (b = a.accessToken))
			return new Aj().credential({idToken: c, accessToken: b})
		},
		Cj = function () {
	...
	var Dj = function (a, b) {
			var c = a
			v(c) || (c = {oauthToken: a, oauthTokenSecret: b})
	...
	Fj.prototype.Mb = function (a) {
		return this.signInMethod == Ej.EMAIL_LINK_SIGN_IN_METHOD ? Q(a, Gj, {email: this.Hb, oobCode: this.jd}) : Q(a, Hj, {email: this.Hb, password: this.jd})
	}
	Fj.prototype.rc = function (a, b) {
		return this.signInMethod == Ej.EMAIL_LINK_SIGN_IN_METHOD ? Q(a, Ij, {idToken: b, email: this.Hb, oobCode: this.jd}) : Q(a, Jj, {idToken: b, email: this.Hb, password: this.jd})
	}
	Fj.prototype.hd = function (a, b) {
		return lj(this.Mb(a), b)
	}
	Fj.prototype.m = function () {
		return {email: this.Hb, password: this.jd, signInMethod: this.signInMethod}
	}
	var Kj = function (a) {
			return a && a.email && a.password ? new Fj(a.email, a.password, a.signInMethod) : null
		},
		Ej = function () {
			Di(this, {providerId: 'password', isOAuthProvider: !1})
		},
		Mj = function (a, b) {
			b = Lj(b)
	...
	Di(Ej, {PROVIDER_ID: 'password'})
	Di(Ej, {EMAIL_LINK_SIGN_IN_METHOD: 'emailLink'})
	Di(Ej, {EMAIL_PASSWORD_SIGN_IN_METHOD: 'password'})
	var Nj = function (a) {
		if (!((a.verificationId && a.Ve) || (a.Bd && a.phoneNumber))) throw new P('internal-error')
		this.V = a
	...
	var Rj = function (a) {
		...
		Oj = function (a) {
			return a.V.Bd && a.V.phoneNumber ? {temporaryProof: a.V.Bd, phoneNumber: a.V.phoneNumber} : {sessionInfo: a.V.verificationId, code: a.V.Ve}
		},
		Sj = function (a) {
			try {
			...
			Di(this, {providerId: 'phone', isOAuthProvider: !1})
		}
		...
		return J(b.verify()).then(function (d) {
			...
			switch (b.type) {
				case 'recaptcha':
					...
					return (
						e && 'enroll' == e.type
							? e.Zc().then(function (g) {
									return Tj(c, {idToken: g, phoneEnrollmentInfo: {phoneNumber: f, recaptchaToken: d}})
								})
							: e && 'signin' == e.type
								? e.Zc().then(function (g) {
										return Uj(c, {mfaPendingCredential: g, mfaEnrollmentId: (a.multiFactorHint && a.multiFactorHint.uid) || a.multiFactorUid, phoneSignInInfo: {recaptchaToken: d}})
									})
								: Vj(c, {phoneNumber: f, recaptchaToken: d})
					).then(
						function (g) {
	...
	var Wj = function (a, b) {
		...
		return new Nj({verificationId: a, Ve: b})
	}
	Di(Sj, {PROVIDER_ID: 'phone'})
	Di(Sj, {PHONE_SIGN_IN_METHOD: 'phone'})
	var Xj = function (a) {
			if (a.temporaryProof && a.phoneNumber) return new Nj({Bd: a.temporaryProof, phoneNumber: a.phoneNumber})
					...
					default:
						return c || d || f || g
							? g
								? 0 == b.indexOf('saml.')
									? new mj(b, g)
									: new rj(b, {pendingToken: g, idToken: a.oauthIdToken, accessToken: a.oauthAccessToken}, b)
								: new vj(b).credential({idToken: f, accessToken: c, rawNonce: e})
							: null
				}
			} catch (h) {
				return null
	...
	var ak = function (a) {
		if (a.code) {
			...
			var c = {credential: Xj(a), tenantId: a.tenantId}
	...
	var gk = function (a, b, c, d) {
			...
			c && ((this.Kb['X-Client-Version'] = c), (this.Je['X-Client-Version'] = c))
			d && (this.Kb['X-Firebase-AppCheck'] = d)
			a = 'Node' == $h()
			a = u.XMLHttpRequest || (a && firebase.INTERNAL.node && firebase.INTERNAL.node.XMLHttpRequest)
			if (!a && !Zh()) throw new P('internal-error', 'The XMLHttpRequest compatibility library was not found.')
			this.He = void 0
			Zh() ? (this.He = new eg({Kk: self})) : ai() ? (this.He = new bk(a)) : (this.He = new bg())
			this.C = null
		},
		hk,
		ik = function (a, b) {
		...
		kk = function (a, b) {
			b &&
				((a.ii = jk('https://securetoken.googleapis.com/v1/token', b)),
		...
		lk = function (a, b) {
			b ? ((a.Kb['X-Client-Version'] = b), (a.Je['X-Client-Version'] = b)) : (delete a.Kb['X-Client-Version'], delete a.Je['X-Client-Version'])
		},
		nk = function (a, b, c, d, e, f, g) {
			Kh() || Zh()
				? (a = w(a.qk, a))
				: (hk ||
						(hk = new I(function (h, k) {
							mk(h, k)
						})),
					(a = w(a.pk, a)))
			a(b, c, d, e, f, g)
		...
		g.listen('complete', function () {
			...
			try {
				...
				try {
					...
					;(ne(this.P, 'Can not get responseText: ' + t.message), (r = ''))
				}
				k = p.call(m, r) || null
			} catch (t) {
				k = null
	...
	var rk = function (a, b) {
			return new I(function (c, d) {
				;('refresh_token' == b.grant_type && b.refresh_token) || ('authorization_code' == b.grant_type && b.code)
					? nk(
							a,
							a.ii + '?key=' + encodeURIComponent(a.A),
							function (e) {
		...
		sk = function (a, b, c, d, e, f, g) {
			...
			var k = 'GET' == d
			if (k) for (var m in e) e.hasOwnProperty(m) && E(h, m, e[m])
		...
		tk = function (a) {
			a = a.email
			if ('string' !== typeof a || !Sh.test(a)) throw new P('invalid-email')
		},
		uk = function (a) {
			'email' in a && tk(a)
		},
		wk = function (a, b, c, d, e, f) {
			...
			c = {identifier: null, providerId: b, continueUri: c, customParameter: d || {}, oauthScope: e, sessionId: f}
			g && (delete c.customParameter, delete c.oauthScope)
			f && 'google.com' == b && (c.authFlowType = 'CODE_FLOW')
			return Q(a, vk, c)
		},
		yk = function (a, b) {
			return Q(a, xk, {identifier: b, continueUri: gi() ? Fh() : 'http://localhost'}).then(function (c) {
		...
		Bk = function (a, b) {
			return Q(a, zk, {iosBundleId: b}).then(function () {})
		},
		Ck = function (a, b, c) {
		...
		Dk = function (a, b) {
			return Q(a, zk, {clientId: b}).then(function () {})
		},
		Ek = function (a, b) {
			return Q(a, zk, {firebaseAppId: b}).then(function () {})
		},
		Fk = function (a) {
			if (!a.idToken) {
				if (a.mfaPendingCredential) throw new P('multi-factor-auth-required', null, yc(a))
	...
	l.updateEmail = function (a, b) {
		return Q(this, Ik, {idToken: a, email: b})
	}
	l.updatePassword = function (a, b) {
		return Q(this, Jj, {idToken: a, password: b})
	}
	...
	var Tj = function (a, b) {
		...
		Uk = function (a, b, c) {
			return Q(a, Tk, {idToken: b, deleteProvider: c})
		},
		Vk = function (a) {
		...
		Wk = function (a, b) {
			b.oauthIdToken &&
				...
				!b.pendingToken &&
				(a.sessionId ? (b.nonce = a.sessionId) : a.postBody && ((a = new Dd(a.postBody)), a.Pc('nonce') && (b.nonce = a.get('nonce'))))
			return b
		},
		Yk = function (a) {
			var b = null
			a.needConfirmation
				? ((a.code = 'account-exists-with-different-credential'), (b = ak(a)))
				: 'FEDERATED_USER_ID_ALREADY_LINKED' == a.errorMessage
					? ((a.code = 'credential-already-in-use'), (b = ak(a)))
					: 'EMAIL_EXISTS' == a.errorMessage
						? ((a.code = 'email-already-in-use'), (b = ak(a)))
						: a.errorMessage && (b = Xk(a.errorMessage))
			if (b) throw b
			Fk(a)
		},
		nj = function (a, b) {
	...
	gk.prototype.confirmPasswordReset = function (a, b) {
		return Q(this, cl, {oobCode: a, newPassword: b})
	}
	gk.prototype.checkActionCode = function (a) {
		return Q(this, dl, {oobCode: a})
	}
	gk.prototype.applyActionCode = function (a) {
		return Q(this, el, {oobCode: a})
	}
	var Q = function (a, b, c) {
			if (!Fi(c, b.ba)) return K(new P('internal-error'))
			var d = !!b.Ed,
				e = b.httpMethod || 'POST',
				f
			return J(c)
		...
		Xk = function (a) {
			return qk({error: {errors: [{message: a}], code: 400, reason: a}})
		},
		qk = function (a, b) {
		...
		ck = new pi(3e4, 6e4),
		dk = {'Content-Type': 'application/x-www-form-urlencoded'},
		ek = new pi(3e4, 6e4),
		fk = {'Content-Type': 'application/json'},
		pk = Hc('https://apis.google.com/js/client.js?onload=%{onload}'),
		ok = '__fcb' + Math.floor(1e6 * Math.random()).toString(),
		Jk = {displayName: 'DISPLAY_NAME', photoUrl: 'PHOTO_URL'},
		el = {endpoint: 'setAccountInfo', G: bl, Va: 'email', I: !0},
		dl = {
		...
		xk = {endpoint: 'createAuthUri', I: !0},
		gl = {endpoint: 'deleteAccount', ba: ['idToken']},
		Tk = {
		...
		Gj = {endpoint: 'emailLinkSignin', ba: ['email', 'oobCode'], G: tk, O: Fk, Ja: !0, I: !0},
		Ij = {endpoint: 'emailLinkSignin', ba: ['idToken', 'email', 'oobCode'], G: tk, O: Fk, Ja: !0},
		hl = {endpoint: 'accounts/mfaEnrollment:finalize', ba: ['idToken', 'phoneVerificationInfo'], G: Rk, O: Fk, I: !0, Ed: !0},
		il = {endpoint: 'accounts/mfaSignIn:finalize', ba: ['mfaPendingCredential', 'phoneVerificationInfo'], G: Rk, O: Fk, I: !0, Ed: !0},
		jl = {endpoint: 'getAccountInfo'},
		vk = {
			endpoint: 'createAuthUri',
			G: function (a) {
				if (!a.continueUri) throw new P('missing-continue-uri')
				if (!a.providerId) throw new P('internal-error', 'A provider ID must be provided in the request.')
			},
			O: function (a) {
				if (!a.authUri)
		...
		zk = {Od: !0, endpoint: 'getProjectConfig', httpMethod: 'GET'},
		kl = {
			Od: !0,
		...
		cl = {endpoint: 'resetPassword', G: bl, Va: 'email', I: !0},
		ll = {Od: !0, endpoint: 'getProjectConfig', httpMethod: 'GET', Va: 'dynamicLinksDomain'},
		Ok = {endpoint: 'sendVerificationCode', ba: ['phoneNumber', 'recaptchaToken'], Va: 'sessionInfo', I: !0},
		Ik = {endpoint: 'setAccountInfo', ba: ['idToken'], G: uk, Ja: !0},
		Jj = {
			endpoint: 'setAccountInfo',
			ba: ['idToken'],
			G: function (a) {
		...
		Hk = {endpoint: 'signupNewUser', O: Fk, Ja: !0, I: !0},
		Qk = {
		...
		Zk = {endpoint: 'verifyAssertion', G: Vk, Ee: Wk, O: Yk, Ja: !0, I: !0},
		al = {
			...
			O: function (a) {
				...
				if (a.errorMessage) throw Xk(a.errorMessage)
				Fk(a)
			},
			Ja: !0,
			I: !0
		...
		Pk = {endpoint: 'verifyPhoneNumber', G: Gk, O: Fk, I: !0},
		Pj = {
			...
			O: function (a) {
				if (a.temporaryProof) throw ((a.code = 'credential-already-in-use'), ak(a))
				Fk(a)
			}
		},
		Qj = {bh: {USER_NOT_FOUND: 'user-not-found'}, endpoint: 'verifyPhoneNumber', G: Gk, O: Fk, I: !0},
		nl = {
	...
	var wl = function (a, b, c, d) {
		...
		this.s = d
		this.Zb = null
		this.s ? ((a = G(this.s.url)), (a = Kd(a.ta, a.ga, a.Ua, '/emulator/auth/iframe', null, null))) : (a = Kd('https', this.J, null, '/__/auth/iframe', null, null))
		this.jb = a
	...
	xl.prototype.toString = function () {
		...
		} else a = Kd('https', this.J, null, '/__/auth/handler', null, null)
		E(a, 'apiKey', this.A)
		E(a, 'appName', this.B)
		...
		'function' === typeof this.zc.rh && ((d = this.zc.rh()), d.length && E(a, 'scopes', d.join(',')))
		...
		if (this.Hd) for (var e in this.Hd) this.Hd.hasOwnProperty(e) && !F(a, e) && E(a, e, this.Hd[e])
	...
	l.nd = function (a, b, c, d, e, f, g, h) {
		if (!a) return K(new P('popup-blocked'))
		if (g && !ii())
			return (
				this.Ob().h(function (m) {
					Mh(a)
					e(m)
				}),
				d(),
	...
	var Dl = function (a) {
		a.i || ((a.ph = a.Pa ? di('JsCore', a.Pa, yl(a.B)) : null), (a.i = new gk(a.A, Ah(a.pa), a.ph)), a.s && kk(a.i, a.s))
		return a.i
	}
	...
	var El = function (a, b, c, d, e, f, g, h, k, m, p, r) {
		...
		Bl = function (a) {
			if (!a.ie) throw Error('IfcHandler must be initialized!')
			sl(a.ie, function (b) {
				var c = {}
				if (b && b.authEvent) {
					var d = !1
	...
	var Pl = function (a) {
		if (a.za) throw Error('reCAPTCHA mock was already deleted!')
	}
	var Ql = function () {}
	...
	var Sl = function (a, b, c, d, e, f, g) {
		...
		this.Oc = b
		this.ad = null
		g ? (Rl || (Rl = new Ql()), (g = Rl)) : (Jl || (Jl = new Gl()), (g = Jl))
		this.ci = g
		this.Ta = c || {theme: 'light', type: 'image'}
		this.Z = []
		if (this.Ta.sitekey) throw new P('argument-error', 'sitekey should not be provided for reCAPTCHA as one is automatically provisioned for the current project.')
		this.ne = 'invisible' === this.Ta.size
		if (!u.document) throw new P('operation-not-supported-in-this-environment', 'RecaptchaVerifier is only supported in a browser HTTP/HTTPS environment with DOM support.')
		if (!Ke(b) || (!this.ne && Ke(b).hasChildNodes())) throw new P('argument-error', 'reCAPTCHA container is either not found or already contains inner elements!')
	...
	var Ul = function (a) {
		if (a.Sc) throw new P('internal-error', 'RecaptchaVerifier instance has been destroyed.')
	}
	Sl.prototype.clear = function () {
		Ul(this)
		this.Sc = !0
		this.ci.Sg()
		for (var a = 0; a < this.Z.length; a++) this.Z[a].cancel('RecaptchaVerifier instance has been destroyed.')
	...
	Yl.prototype.send = function (a, b, c) {
		...
		var f,
			...
			h,
			k = null
		if (this.Tg) return K(Error('connection_unavailable'))
		var m = c ? 800 : 50,
					...
					(f = function (z) {
						z.data.eventId === e &&
							('ack' === z.data.status
								...
								: 'done' === z.data.status
									? (clearTimeout(h), 'undefined' !== typeof z.data.response ? r(z.data.response) : t(Error('unknown_error')))
									: (clearTimeout(g), clearTimeout(h), t(Error('invalid_response'))))
					}),
					(k = {messageChannel: p, onMessage: f}),
					d.se.push(k),
					p.port1.addEventListener('message', f),
					d.Vj.postMessage({eventType: a, eventId: e, data: b}, [p.port2]))
	...
	Yl.prototype.close = function () {
		for (; 0 < this.se.length; ) $l(this, this.se[0])
		this.Tg = !0
	}
	var am = function (a) {
			this.wf = a
	...
	am.prototype.unsubscribe = function (a, b) {
		'undefined' !== typeof this.Ca[a] && b
			? (tb(this.Ca[a], function (c) {
					return c == b
				}),
	...
	var dm = function (a) {
		...
		if (!this.ya) throw new P('internal-error', 'The React Native compatibility library was not found.')
	...
	var hm = function () {
			if (!fm()) {
				if ('Node' == $h()) throw new P('internal-error', 'The LocalStorage compatibility library was not found.')
	...
	var lm = function () {
			if (!jm()) {
				if ('Node' == $h()) throw new P('internal-error', 'The SessionStorage compatibility library was not found.')
				throw new P('web-storage-unsupported')
			}
	...
	l.yb = function () {}
	var om = function () {
			if (!mm()) throw new P('web-storage-unsupported')
				...
				? ((this.lg = cm()),
					this.lg.subscribe('keyChanged', function (b, c) {
						return nm(a).then(function (d) {
							...
							return {keyProcessed: pb(d, c.key)}
						})
					}),
		...
		rm = function (a) {
			return new I(function (b, c) {
				...
				d.onupgradeneeded = function (e) {
					e = e.target.result
					try {
						e.createObjectStore(a.ue, {keyPath: a.qf})
					} catch (f) {
						c(f)
					}
				}
				d.onsuccess = function (e) {
					e = e.target.result
					e.objectStoreNames.contains(a.ue)
						? b(e)
						: qm(a)
								.then(function () {
									return rm(a)
		...
		return tm(this, function (e) {
			...
			.then(function (e) {
				return tm(c, function (f) {
					f = um(c, vm(c, f, !0))
					if (e) return ((e.value = b), wm(f.put(e)))
					c.kd++
					d = !0
					var g = {}
					g[c.qf] = a
	...
	var xm = function (a, b) {
		return a.Ke && a.af && wi() === a.af
			? a.Ke.send('keyChanged', {key: b}, a.ki)
					.then(function () {})
					.h(function () {})
			: J()
	}
		...
		return sm(a)
			...
			.then(function (b) {
				var c = {},
					d = []
				if (0 == a.kd) {
					for (d = 0; d < b.length; d++) c[b[d][a.qf]] = b[d][a.Hi]
					d = Ih(a.ka, c)
					a.ka = c
				}
				return d
	...
	var Dm = function () {
			this.uf = {Browser: zm, Node: Am, ReactNative: Bm, Worker: Cm}[$h()]
		},
		Em,
		zm = {M: hm, Oe: lm},
		Am = {M: hm, Oe: lm},
	...
	Gm.prototype.cb = function (a) {
		...
		if ((b = a.iOS) && 'object' === typeof b)
			if (((b = b.bundleId), 'string' === typeof b && b.length)) this.cd = b
			else {
	...
	var Hm = function (a) {
		...
		if ((b.androidPackageName = a.cc)) ((b.androidMinimumVersion = a.Gg), (b.androidInstallApp = a.Bh))
		b.iOSBundleId = a.cd
	...
	var Km = function (a, b, c) {
		...
		this.uc = null
		this.Qb = this.re
		if (this.Eg < this.re) throw Error('Proactive refresh lower bound greater than upper bound!')
	}
	...
	var Tm = function (a) {
			...
			try {
				if (c) return b[c] ? new b[c](a) : new Rm(a)
				if ('undefined' !== typeof a.idToken) return new Sm(a)
			} catch (d) {}
			return null
		},
		Sm = function (a) {
	...
	q(Qm, Rm)
	var Um = {LOCAL: 'local', NONE: 'none', SESSION: 'session'},
		Vm = function (a) {
			...
			switch ($h()) {
				...
				case 'Node':
					...
					break
				case 'Worker':
					if ('session' === a || (!mm() && 'none' !== a)) throw c
					break
				default:
					if (!fi() && 'none' !== a) throw c
			}
		},
		Wm = function () {
			var a = !ni(M()) && Xh() ? !0 : !1,
	...
	var $m = function (a, b, c) {
		...
		return a.get(b, c).then(function (f) {
			...
			if (g && !f) return (u.localStorage.removeItem(d), a.set(b, g, c))
			...
			a.Qf = setInterval(function () {
				for (var b in a.ra) {
					var c = u.localStorage.getItem(b),
						d = a.ka[b]
					c != d && ((a.ka[b] = c), (c = new wf({type: 'storage', key: b, target: window, oldValue: d, newValue: c, Zf: !0})), a.ui(c))
				}
			}, 1e3)
		},
		bn = function (a) {
			a.Qf && (clearInterval(a.Qf), (a.Qf = null))
		}
		...
		if (a && a.gj) {
			...
			if (null == b)
				for (var c in this.ra) {
					...
					e !== d && ((this.ka[c] = e), this.jf(c))
				}
			else if (0 == b.indexOf(this.Nh + this.pg) && this.ra[b]) {
				'undefined' !== typeof a.qa.Zf ? Zm(this, 'local').yb(this.yg) : bn(this)
				if (this.ik)
					if (((c = u.localStorage.getItem(b)), (d = a.qa.newValue), d !== c)) null !== d ? u.localStorage.setItem(b, d) : u.localStorage.removeItem(b)
					else if (this.ka[b] === d && 'undefined' === typeof a.qa.Zf) return
				var f = this
				c = function () {
					if ('undefined' !== typeof a.qa.Zf || f.ka[b] !== u.localStorage.getItem(b)) ((f.ka[b] = u.localStorage.getItem(b)), f.jf(b))
				}
				xb && Kb && 10 == Kb && u.localStorage.getItem(b) !== a.qa.newValue && a.qa.newValue !== a.qa.oldValue ? setTimeout(c, 10) : c()
			}
		} else C(a, w(this.jf, this))
	}
	Wm.prototype.jf = function (a) {
		this.ra[a] &&
			C(this.ra[a], function (b) {
				b()
			})
	}
	var cn = function (a) {
	...
	var dn = {name: 'authEvent', M: 'local'},
		fn = {name: 'redirectEvent', M: 'session'}
	var gn = function () {
		this.o = Ym()
	}
	...
	var kn = function (a) {
		...
		jn = {name: 'oauthHelperState', M: 'session'},
		hn = {name: 'sessionId', M: 'session'}
	var mn = function () {
		this.Sf = null
		this.Sd = []
	}
	mn.prototype.subscribe = function (a) {
		...
		this.Sf ||
			((this.Sf = function (c) {
				for (var d = 0; d < b.Sd.length; d++) b.Sd[d](c)
			}),
	...
	on.prototype.Ob = function () {
		return this.ed
			...
			: (this.ed = Vh().then(
					function () {
						if ('function' !== typeof N('universalLinks.subscribe', u)) throw pn('cordova-universal-links-plugin-fix is not installed')
						if ('undefined' === typeof N('BuildInfo.packageName', u)) throw pn('cordova-plugin-buildinfo is not installed')
						if ('function' !== typeof N('cordova.plugins.browsertab.openUrl', u)) throw pn('cordova-plugin-browsertab is not installed')
						if ('function' !== typeof N('cordova.InAppBrowser.open', u)) throw pn('cordova-plugin-inappbrowser is not installed')
					},
					function () {
	...
	l.od = function (a, b, c, d) {
		if (this.ze) return K(new P('redirect-operation-pending'))
		var e = this,
			f = u.document,
			g = null,
			h = null,
			...
			.then(function () {
				return new I(function (p, r) {
					h = function () {
						...
						p()
						'function' === typeof t && t()
						e.dd && 'function' === typeof e.dd.close && (e.dd.close(), (e.dd = null))
						return !1
					}
					e.bc(h)
					k = function () {
						g ||
							(g = nh(e.Yj).then(function () {
	...
	var tn = function (a, b, c, d, e) {
		...
		if (
			...
			m.apn = h
		else return K(new P('operation-not-supported-in-this-environment'))
	...
	var sn = function (a) {
		...
		vn = function (a) {
			...
			u.handleOpenURL = function (g) {
				0 == g.toLowerCase().indexOf(N('BuildInfo.packageName', u).toLowerCase() + '://') && e({url: g})
				if ('function' === typeof f)
					try {
						f(g)
					} catch (h) {
	...
	on.prototype.bc = function (a) {
		...
		sn(this).h(function (b) {
			'auth/invalid-cordova-configuration' === b.code && ((b = new Pi('unknown', null, null, null, new P('no-auth-event'))), a(b))
		})
	}
	...
	var wn = function (a) {
		...
		xn = {name: 'pendingRedirect', M: 'session'}
	...
	Fn.prototype.initialize = function () {
		var a = this
		this.qc || ((this.qc = !0), this.wa.bc(this.ef))
		var b = this.wa
	...
	l.Ff = function (a) {
		...
		6e5 <= Date.now() - this.Of && ((this.De = {}), (this.Of = 0))
		if (a && a.getUid() && this.De.hasOwnProperty(a.getUid())) return !1
		for (var b = !1, c = 0; c < this.Ad.length; c++) {
			var d = this.Ad[c]
			if (d.Pg(a.getType(), a.T)) {
				if ((b = this.Bb[a.getType()])) (b.Zh(a, d), a && (a.mc() || a.T) && ((this.De[a.getUid()] = !0), (this.Of = Date.now())))
				b = !0
				break
			}
		}
	...
	Fn.prototype.od = function (a, b, c, d) {
		...
		return yn(this.ld).then(function () {
			return e.wa
				.od(a, b, c, d)
				.h(function (g) {
					if (Gn(g)) throw new P('operation-not-supported-in-this-environment')
					f = g
	...
	Bn.prototype.Zh = function (a, b) {
		if (a) {
			...
			this.Ai = !(!e && !f)
			'unknown' != c || e || f ? (a.Y ? this.ig(a, b) : b.Xc(c, d) ? this.jg(a, b) : K(new P('invalid-auth-event'))) : (Nn(this, !1, null, null), J())
		} else K(new P('invalid-auth-event'))
	}
	var Hn = function (a) {
		a.sd || ((a.sd = !0), Nn(a, !1, null, null))
	}
	...
	var On = function (a, b) {
			...
			if (a.qd.length) for (var c = 0; c < a.qd.length; c++) a.qd[c](b)
		},
		Pn = function (a, b) {
			a.Cc = function () {
				return J(b)
			}
			if (a.rd.length) for (var c = 0; c < a.rd.length; c++) a.rd[c](b)
		},
		Nn = function (a, b, c, d) {
			b ? (d ? On(a, d) : Pn(a, c)) : Pn(a, {user: null})
			a.rd = []
			a.qd = []
		}
	Bn.prototype.getRedirectResult = function () {
		var a = this
		return new I(function (b, c) {
			a.Cc ? a.Cc().then(b, c) : (a.rd.push(b), a.qd.push(c), Qn(a))
		})
	}
	var Qn = function (a) {
			var b = new P('timeout')
	...
	var Vn = function (a, b, c, d) {
			return c.Zc().then(function (e) {
				...
				Ac(e, {phoneVerificationInfo: Oj(a.Uf)})
				return Q(b, hl, e)
			})
		},
		Wn = function (a, b, c) {
			return c.Zc().then(function (d) {
				...
				Ac(d, {phoneVerificationInfo: Oj(a.Uf)})
				return Q(b, il, d)
			})
		},
		Xn = function (a) {
	...
	var Yn = function (a) {
		Xn.call(this, a)
		if (this.Uf.providerId != Sj.PROVIDER_ID) throw new P('argument-error', 'firebase.auth.PhoneMultiFactorAssertion requires a valid firebase.auth.PhoneAuthCredential')
	}
	x(Yn, Xn)
	var Zn = function (a, b) {
		uf.call(this, a)
	...
	var ao = function (a, b) {
			...
			b &&
				...
				C(b.multiFactor.enrolledFactors, function (d) {
					var e = null,
						f = {}
					if (d) {
	...
	l.unenroll = function (a) {
		...
		return this.kb
			.getIdToken()
			.then(function (e) {
				return Q(d, nl, {idToken: e, mfaEnrollmentId: c})
			})
			.then(function (e) {
	...
	eo.prototype.m = function () {
		return {apiKey: this.i.A, refreshToken: this.la, accessToken: this.na && this.na.toString(), expirationTime: this.ic}
	}
	var fo = function (a, b) {
			'undefined' === typeof b && (a.na ? ((b = a.na), (b = b.yf - b.wj)) : (b = 0))
			a.ic = Date.now() + 1e3 * b
		},
		go = function (a, b) {
			a.na = hj(b.idToken || '')
	...
	eo.prototype.getToken = function (a) {
		...
		return this.na && !this.la
			? K(new P('user-token-expired'))
			: a || !this.na || Date.now() > this.ic - 3e4
				? this.la
					? ho(this, {grant_type: 'refresh_token', refresh_token: this.la})
					: J(null)
				: J({accessToken: this.na.toString(), refreshToken: this.la})
	}
	var io = function (a, b) {
		this.Zg = a || null
		this.Hh = b || null
		Di(this, {lastSignInTime: ti(b || null), creationTime: ti(a || null)})
	}
	...
	var jo = function (a, b, c, d, e, f) {
			Di(this, {uid: a, displayName: d || null, photoURL: e || null, email: c || null, phoneNumber: f || null, providerId: b})
		},
		R = function (a, b, c) {
			Uf.call(this)
			this.Z = []
	...
	var no = function (a, b) {
			a.s = b
			kk(a.i, b)
			a.v && ((b = a.v), (a.v = Ln(a.J, a.A, a.B, a.s)), a.md && (b.unsubscribe(a), a.v.subscribe(a)))
		},
		po = function (a, b) {
	...
	R.prototype.Hf = function () {
		this.xc.uc && (this.xc.stop(), this.xc.start())
	}
	var so = function (a) {
			try {
		...
		to = function (a) {
			a.Sc || a.xc.uc || (a.xc.start(), Rf(a, 'tokenChanged', a.Kc), Jf(a, 'tokenChanged', a.Kc))
		},
		uo = function (a) {
		...
		wo = function (a) {
			for (var b = [], c = 0; c < a.Me.length; c++) b.push(a.Me[c](a))
			return Ig(b).then(function () {
				return a
			})
		},
		xo = function (a) {
			a.v && !a.md && ((a.md = !0), a.v.subscribe(a))
		},
		lo = function (a, b) {
			Di(a, {
				uid: b.uid,
		...
		zo = function (a) {
			return J().then(function () {
				if (a.Sc) throw new P('app-deleted')
			})
		},
		Ao = function (a) {
		...
		Co = function (a, b) {
			b && (Bo(a, b.providerId), a.providerData.push(b))
		},
		Bo = function (a, b) {
		...
		return this.l(
			zo(this)
				...
				.then(function (c) {
					...
					c.accessToken != b.Gh && (ko(b, c.accessToken), b.tb())
	...
	var co = function (a, b) {
		b.idToken && a.Gh != b.idToken && (go(a.Ka, b), a.tb(), ko(a, b.idToken), Do(a, 'refreshToken', a.Ka.la))
	}
	...
	var Go = function (a, b, c) {
			var d = Xj(b)
			b = Tm(b)
			return Ei({user: a, credential: d, additionalUserInfo: b, operationType: c})
		},
		Io = function (a, b) {
			co(a, b)
	...
	l.updateProfile = function (a) {
		if (void 0 === a.displayName && void 0 === a.photoURL) return zo(this)
		var b = this
		return this.l(
			this.getIdToken()
				.then(function (c) {
	...
	l.unlink = function (a) {
		var b = this
		return this.l(
			Eo(this).then(function (c) {
				return pb(Ao(b), a)
					? Uk(b.i, c, [a]).then(function (d) {
							var e = {}
	...
	l.Pg = function (a, b) {
		return ('linkViaPopup' == a && (this.Ha || null) == b && this.Ga) ||
			('reauthViaPopup' == a && (this.Ha || null) == b && this.Ga) ||
			('linkViaRedirect' == a && (this.vb || null) == b) ||
			('reauthViaRedirect' == a && (this.vb || null) == b)
			? !0
			: !1
	}
	l.Vb = function (a, b, c, d) {
		;('linkViaPopup' != a && 'reauthViaPopup' != a) ||
			d != (this.Ha || null) ||
			(c && this.Sb ? this.Sb(c) : b && !c && this.Ga && this.Ga(b), this.aa && (this.aa.cancel(), (this.aa = null)), delete this.Ga, delete this.Sb)
	}
	l.Xc = function (a, b) {
		return 'linkViaPopup' == a && b == (this.Ha || null)
			? w(this.kh, this)
			: 'reauthViaPopup' == a && b == (this.Ha || null)
				? w(this.lh, this)
				: 'linkViaRedirect' == a && (this.vb || null) == b
					? w(this.kh, this)
					: 'reauthViaRedirect' == a && (this.vb || null) == b
	...
	var Jo = function (a, b, c, d, e) {
		if (!hi()) return K(new P('operation-not-supported-in-this-environment'))
		if (a.La && !e) return K(a.La)
	...
	var Lo = function (a, b, c, d, e) {
			...
			d = d()
				...
				.then(function (h) {
					a.wb && ((h = a.wb), (h = h.o.set(Mo, a.m(), h.D)))
					return h
				})
				.then(function () {
		...
		Ko = function (a) {
			if (!a.v || !a.md) {
				if (a.v && !a.md) throw new P('internal-error')
	...
	l.kh = function (a, b, c, d) {
		...
		c = this.getIdToken()
			.then(function (g) {
				return oj(e.i, {requestUri: a, postBody: d, sessionId: b, idToken: g})
			})
			.then(function (g) {
				f = Go(e, g, 'link')
				return Io(e, g)
	...
	l.lh = function (a, b, c, d) {
		...
		var f = null,
			g = J()
				.then(function () {
					return lj(pj(e.i, {requestUri: a, sessionId: b, postBody: d, tenantId: c}), e.uid)
				})
				.then(function (h) {
	...
	var Oo = function (a, b, c) {
		return a.La && !c
			? (b.cancel(), K(a.La))
			: b.h(function (d) {
					!d || ('auth/user-disabled' != d.code && 'auth/user-token-expired' != d.code) || (a.La || a.dispatchEvent(new Zn('userInvalidated')), (a.La = d))
					throw d
				})
	}
	...
	var So = function (a) {
		...
		Mo = {name: 'redirectUser', M: 'session'}
	var Vo = function (a) {
		this.D = a
		this.o = Ym()
		this.oa = null
	...
	var Xo = function (a, b) {
		var c = [],
			d
		for (d in Um) Um[d] !== b && c.push(a.o.remove(Uo(Um[d]), a.D))
					...
					: a.o.get(d, a.D).then(function (f) {
							return f
								...
								: a.o.get(b, a.D).then(function (g) {
										return g
											? b
											: a.o.get(Yo, a.D).then(function (h) {
													return h ? Uo(h) : b
												})
									})
						})
	...
	var S = function (a) {
		...
		if (this.u().options && this.u().options.apiKey)
			((a = firebase.SDK_VERSION ? di('JsCore', firebase.SDK_VERSION) : null), (this.i = new gk(this.u().options && this.u().options.apiKey, Ah(Bh), a)))
		else throw new P('invalid-api-key')
		this.Z = []
		this.Db = []
		this.Jc = []
	...
	S.prototype.Ec = function (a) {
		this.Fa === a || this.za || ((this.Fa = a), ik(this.i, this.Fa), this.dispatchEvent(new hp(this.Fa)))
	}
	...
	S.prototype.useEmulator = function (a, b) {
		if (!this.s) {
			if (this.v) throw new P('argument-error', 'useEmulator() must be called immediately following firebase.auth() initialization.')
	...
	S.prototype.ug = function (a) {
		this.C === a || this.za || ((this.C = a), (this.i.C = this.C))
	}
	var gp = function (a) {
		...
		Object.defineProperty(a, 'emulatorConfig', {
			get: function () {
				if (this.s) {
					var b = G(this.s.url)
					b = Ei({protocol: b.ta, host: b.ga, port: b.Ua, options: Ei({disableWarnings: this.s.disableWarnings})})
				} else b = null
				return b
			},
			enumerable: !1
	...
	S.prototype.toJSON = function () {
		return {apiKey: this.u().options.apiKey, authDomain: this.u().options.authDomain, appName: this.u().name, currentUser: T(this) && T(this).m()}
	}
	var lp = function (a) {
	...
	l.signInWithPopup = function (a) {
		...
		;(!ii() || Xh()) &&
			...
			a.isOAuthProvider &&
			(e = El(this.u().options.authDomain, this.u().options.apiKey, this.u().name, 'signInViaPopup', a, null, d, firebase.SDK_VERSION || null, null, null, this.C, this.s))
	...
	S.prototype.updateCurrentUser = function (a) {
		if (!a) return K(new P('null-user'))
		if (this.C != a.tenantId) return K(new P('tenant-id-mismatch'))
		var b = this,
			c = {}
	...
	var op = function (a, b) {
		...
		cp = function (a, b) {
			T(a) && (vo(T(a), a.Gi), Rf(T(a), 'tokenChanged', a.Kc), Rf(T(a), 'userDeleted', a.Ei), Rf(T(a), 'userInvalidated', a.Fi), uo(T(a)))
			b && (b.Me.push(a.Gi), Jf(b, 'tokenChanged', a.Kc), Jf(b, 'userDeleted', a.Ei), Jf(b, 'userInvalidated', a.Fi), 0 < a.Lb && to(b))
			O(a, 'currentUser', b)
			b && (b.Ec(a.Fa), po(b, a), oo(b, a.U), ro(b, a), no(b, a.s), qo(b, a))
		}
	...
	l.yk = function () {
		...
		return bp(this.Ma, b).then(function (c) {
			if (!a.za) {
				...
				if (T(a) || c) (cp(a, c), c && (xo(c), (c.wb = a.Ub)), a.v && a.v.subscribe(a), a.tb())
			}
		})
	}
	l.rb = function (a) {
	...
	var mp = function (a, b) {
		...
		return a.l(
			b
				...
				.then(function () {
					return Ei({user: T(a), credential: c, additionalUserInfo: d, operationType: 'signIn'})
				})
		)
	}
	l = S.prototype
	...
	l.signInWithEmailAndPassword = function (a, b) {
		var c = this
		return this.Ia.then(function () {
			return mp(c, Q(c.i, Hj, {email: a, password: b}))
		})
	}
	l.createUserWithEmailAndPassword = function (a, b) {
		var c = this
		return this.Ia.then(function () {
			return mp(c, Q(c.i, fl, {email: a, password: b}))
		})
	}
	...
	l.signInAnonymously = function () {
		...
		return this.Ia.then(function () {
			var b = T(a)
			if (b && b.isAnonymous) {
				var c = Ei({providerId: null, isNewUser: !1})
				return Ei({user: b, credential: null, additionalUserInfo: c, operationType: 'signIn'})
			}
	...
	l.tb = function () {
		if (this.oe) {
			for (var a = 0; a < this.Db.length; a++) if (this.Db[a]) this.Db[a](rp(this))
			if (this.Fd !== this.getUid() && this.Jc.length) for (this.Fd = this.getUid(), a = 0; a < this.Jc.length; a++) if (this.Jc[a]) this.Jc[a](rp(this))
		}
	}
	l.Pi = function (a) {
	...
	var qp = function (a, b) {
		...
		a.l(
			a.Ia.then(function () {
				!a.za && pb(a.Jc, b) && a.Fd !== a.getUid() && ((a.Fd = a.getUid()), b(rp(a)))
			})
		)
	}
	l = S.prototype
	l.delete = function () {
		...
		this.Z = []
		this.Ma && ((a = this.Ma), a.o.removeListener(Uo('local'), a.D, this.Ef))
		this.v && (this.v.unsubscribe(this), this.v.fc())
	...
	l.sendSignInLinkToEmail = function (a, b) {
		...
		return this.l(
			J()
				.then(function () {
					var d = new Gm(b)
					if (!d.Qg) throw new P('argument-error', 'handleCodeInApp must be true when sending sign in link to email')
					return Hm(d)
				})
				.then(function (d) {
	...
	var tp = function (a, b, c, d) {
				...
				if (c.length < e || f < c.length) d = 'Expected ' + (e == f ? (1 == e ? '1 argument' : e + ' arguments') : e + '-' + f + ' arguments') + ' but got ' + c.length + '.'
					...
					for (e = 0; e < c.length; e++)
						if (((f = b[e].optional && void 0 === c[e]), !b[e].X(c[e]) && !f)) {
							b = b[e]
							if (0 > e || e >= sp.length) throw new P('internal-error', 'Argument validator received an unsupported number of arguments.')
							c = sp[e]
		...
		V = function (a, b) {
			return {name: a || '', W: 'a valid object', optional: !!b, X: v}
		},
		vp = function (a, b) {
			return {name: a || '', W: 'a function', optional: !!b, X: uc}
		},
		wp = function (a, b) {
			return {
				name: a || '',
	...
	X(S.prototype, {
		...
		createUserWithEmailAndPassword: {name: 'createUserWithEmailAndPassword', g: [U('email'), U('password')]},
		...
		onAuthStateChanged: {name: 'onAuthStateChanged', g: [W(V(), vp(), 'nextOrObserver'), vp('opt_error', !0), vp('opt_completed', !0)]},
		onIdTokenChanged: {name: 'onIdTokenChanged', g: [W(V(), vp(), 'nextOrObserver'), vp('opt_error', !0), vp('opt_completed', !0)]},
		sendPasswordResetEmail: {name: 'sendPasswordResetEmail', g: [U('email'), W(V('opt_actionCodeSettings', !0), wp(null, !0), 'opt_actionCodeSettings', !0)]},
		sendSignInLinkToEmail: {name: 'sendSignInLinkToEmail', g: [U('email'), V('actionCodeSettings')]},
		setPersistence: {name: 'setPersistence', g: [U('persistence')]},
		signInAndRetrieveDataWithCredential: {name: 'signInAndRetrieveDataWithCredential', g: [Ap()]},
		signInAnonymously: {name: 'signInAnonymously', g: []},
		signInWithCredential: {name: 'signInWithCredential', g: [Ap()]},
		signInWithCustomToken: {name: 'signInWithCustomToken', g: [U('token')]},
		signInWithEmailAndPassword: {name: 'signInWithEmailAndPassword', g: [U('email'), U('password')]},
		signInWithEmailLink: {name: 'signInWithEmailLink', g: [U('email'), U('emailLink', !0)]},
		signInWithPhoneNumber: {name: 'signInWithPhoneNumber', g: [U('phoneNumber'), Fp()]},
		signInWithPopup: {name: 'signInWithPopup', g: [Cp()]},
		signInWithRedirect: {name: 'signInWithRedirect', g: [Cp()]},
		updateCurrentUser: {
	...
	Hp(S.prototype, {lc: {name: 'languageCode', df: W(U(), wp(), 'languageCode')}, ti: {name: 'tenantId', df: W(U(), wp(), 'tenantId')}})
	S.Persistence = Um
	...
	X(R.prototype, {
		...
		getIdTokenResult: {name: 'getIdTokenResult', g: [up('opt_forceRefresh', !0)]},
		getIdToken: {name: 'getIdToken', g: [up('opt_forceRefresh', !0)]},
		linkAndRetrieveDataWithCredential: {name: 'linkAndRetrieveDataWithCredential', g: [Ap()]},
		linkWithCredential: {name: 'linkWithCredential', g: [Ap()]},
		linkWithPhoneNumber: {name: 'linkWithPhoneNumber', g: [U('phoneNumber'), Fp()]},
		linkWithPopup: {name: 'linkWithPopup', g: [Cp()]},
		linkWithRedirect: {name: 'linkWithRedirect', g: [Cp()]},
		reauthenticateAndRetrieveDataWithCredential: {name: 'reauthenticateAndRetrieveDataWithCredential', g: [Ap()]},
		reauthenticateWithCredential: {name: 'reauthenticateWithCredential', g: [Ap()]},
		reauthenticateWithPhoneNumber: {name: 'reauthenticateWithPhoneNumber', g: [U('phoneNumber'), Fp()]},
		reauthenticateWithPopup: {name: 'reauthenticateWithPopup', g: [Cp()]},
		reauthenticateWithRedirect: {name: 'reauthenticateWithRedirect', g: [Cp()]},
		reload: {name: 'reload', g: []},
		sendEmailVerification: {name: 'sendEmailVerification', g: [W(V('opt_actionCodeSettings', !0), wp(null, !0), 'opt_actionCodeSettings', !0)]},
		toJSON: {name: 'toJSON', g: [U(null, !0)]},
		unlink: {name: 'unlink', g: [U('provider')]},
		updateEmail: {name: 'updateEmail', g: [U('email')]},
		updatePassword: {name: 'updatePassword', g: [U('password')]},
		updatePhoneNumber: {name: 'updatePhoneNumber', g: [Ap('phone')]},
		updateProfile: {name: 'updateProfile', g: [V('profile')]},
		verifyBeforeUpdateEmail: {name: 'verifyBeforeUpdateEmail', g: [U('email'), W(V('opt_actionCodeSettings', !0), wp(null, !0), 'opt_actionCodeSettings', !0)]}
	})
	X(Kl.prototype, {execute: {name: 'execute'}, render: {name: 'render'}, reset: {name: 'reset'}, getResponse: {name: 'getResponse'}})
	X(Fl.prototype, {execute: {name: 'execute'}, render: {name: 'render'}, reset: {name: 'reset'}, getResponse: {name: 'getResponse'}})
	X(I.prototype, {Ab: {name: 'finally'}, h: {name: 'catch'}, then: {name: 'then'}})
	Hp(Fm.prototype, {appVerificationDisabled: {name: 'appVerificationDisabledForTesting', df: up('appVerificationDisabledForTesting')}})
	X(Im.prototype, {confirm: {name: 'confirm', g: [U('verificationCode')]}})
	Y(
		kj,
		'fromJSON',
		function (a) {
			a = 'string' === typeof a ? JSON.parse(a) : a
			for (var b, c = [sj, Kj, Rj, qj], d = 0; d < c.length; d++) if ((b = c[d](a))) return b
			return null
		},
		[W(U(), V(), 'json')]
	)
	...
	X(Fj.prototype, {m: {name: 'toJSON', g: [U(null, !0)]}})
	X(wj.prototype, {addScope: {name: 'addScope', g: [U('scope')]}, setCustomParameters: {name: 'setCustomParameters', g: [V('customOAuthParameters')]}})
	Y(wj, 'credential', xj, [W(U(), V(), 'token')])
	Y(Ej, 'credentialWithLink', Mj, [U('email'), U('emailLink')])
	X(yj.prototype, {addScope: {name: 'addScope', g: [U('scope')]}, setCustomParameters: {name: 'setCustomParameters', g: [V('customOAuthParameters')]}})
	Y(yj, 'credential', zj, [W(U(), V(), 'token')])
	X(Aj.prototype, {addScope: {name: 'addScope', g: [U('scope')]}, setCustomParameters: {name: 'setCustomParameters', g: [V('customOAuthParameters')]}})
	Y(Aj, 'credential', Bj, [W(U(), W(V(), wp()), 'idToken'), W(U(), wp(), 'accessToken', !0)])
	X(Cj.prototype, {setCustomParameters: {name: 'setCustomParameters', g: [V('customOAuthParameters')]}})
	Y(Cj, 'credential', Dj, [W(U(), V(), 'token'), U('secret', !0)])
	X(vj.prototype, {
		addScope: {name: 'addScope', g: [U('scope')]},
		credential: {name: 'credential', g: [W(U(), W(V(), wp()), 'optionsOrIdToken'), W(U(), wp(), 'accessToken', !0)]},
		setCustomParameters: {name: 'setCustomParameters', g: [V('customOAuthParameters')]}
	})
	X(rj.prototype, {m: {name: 'toJSON', g: [U(null, !0)]}})
	X(mj.prototype, {m: {name: 'toJSON', g: [U(null, !0)]}})
							...
							X: function (c) {
								return c
									? c.session && c.phoneNumber
										? Dp(c.session, 'enroll') && 'string' === typeof c.phoneNumber
										: c.session && c.multiFactorHint
											? Dp(c.session, 'signin') && Ep(c.multiFactorHint)
											: c.session && c.multiFactorUid
												? Dp(c.session, 'signin') && 'string' === typeof c.multiFactorUid
												: c.phoneNumber
	...
	X(Nj.prototype, {m: {name: 'toJSON', g: [U(null, !0)]}})
	X(P.prototype, {toJSON: {name: 'toJSON', g: [U(null, !0)]}})
	X(Zj.prototype, {toJSON: {name: 'toJSON', g: [U(null, !0)]}})
	X(ej.prototype, {toJSON: {name: 'toJSON', g: [U(null, !0)]}})
	X(Sn.prototype, {toJSON: {name: 'toJSON', g: [U(null, !0)]}})
	X(Rn.prototype, {resolveSignIn: {name: 'resolveSignIn', g: [Bp()]}})
	X(ao.prototype, {
		getSession: {name: 'getSession', g: []},
		enroll: {name: 'enroll', g: [Bp(), U('displayName', !0)]},
		unenroll: {name: 'unenroll', g: [W({name: 'multiFactorInfo', W: 'a valid multiFactorInfo', optional: !1, X: Ep}, U(), 'multiFactorInfoIdentifier')]}
	})
	X(Vl.prototype, {clear: {name: 'clear', g: []}, render: {name: 'render', g: []}, verify: {name: 'verify', g: []}})
	...
	;(function () {
		if ('undefined' !== typeof firebase && firebase.INTERNAL && firebase.INTERNAL.registerService) {
			...
			firebase.INTERNAL.registerService(
				...
				function (b, c) {
					b = new S(b)
					c({INTERNAL: {getUid: w(b.getUid, b), getToken: w(b.hj, b), addAuthTokenListener: w(b.Pi, b), removeAuthTokenListener: w(b.Zj, b)}})
					return b
				},
				a,
				function (b, c) {
	...
	var Kp = function () {
		this.Qa = ('undefined' == typeof document ? null : document) || {cookie: ''}
	}
	l = Kp.prototype
	l.isEnabled = function () {
		if (!u.navigator.cookieEnabled) return !1
		if (!this.Ch()) return !0
		this.set('TESTCOOKIESENABLED', '1', {Tf: 60})
	...
	l.remove = function (a, b, c) {
		var d = this.Pc(a)
		this.set(a, '', {Tf: 0, path: b, domain: c})
		return d
	}
	l.ae = function () {
		return Lp(this).keys
	...
	l.clear = function () {
		for (var a = Lp(this).keys, b = a.length - 1; 0 <= b; b--) this.remove(a[b])
	}
	l.qg = function (a) {
		this.Qa.cookie = a
	}
	...
	var Lp = function (a) {
			...
			for (var b = [], c = [], d, e, f = 0; f < a.length; f++)
				((e = Pa(a[f])), (d = e.indexOf('=')), -1 == d ? (b.push(''), c.push(e)) : (b.push(e.substring(0, d)), c.push(e.substring(d + 1))))
	...
	var Op = function () {
		...
		for (b in a) {
			...
			'undefined' !== typeof this.N[c].stagingRollout &&
				(0 > this.N[c].stagingRollout && (this.N[c].stagingRollout = 0), 1 < this.N[c].stagingRollout && (this.N[c].stagingRollout = 1))
			'undefined' !== typeof this.N[c].rollout && (0 > this.N[c].rollout && (this.N[c].rollout = 0), 1 < this.N[c].rollout && (this.N[c].rollout = 1))
		}
	}
	Op.prototype.isEnabled = function (a) {
		...
		if ('undefined' !== typeof this.N[a]) {
			...
			if (!(c && c.navigator && c.navigator.cookieEnabled) || (this.N[a].expiration && this.N[a].expiration.getTime() <= Date.now())) return !!this.N[a].defaultValue
			var d
			c = this.Yc('e_gcip_' + b)
			null === c &&
			...
			b = parseFloat(c)
			var e
			return (e = void 0 === e ? u.window : e) && e.location && e.location.hostname && Np.test(e.location.hostname) && 'undefined' !== typeof this.N[a].stagingRollout
				? 0 === b
					? !1
	...
	Op.prototype.qg = function (a, b, c) {
		Mp.set(a, b, {Tf: c ? c : 2592e3, path: '/__/auth/', domain: u.window.location.hostname, mk: !0})
	}
	...
	var Xp = function (a, b) {
		b instanceof ad && b.constructor === ad ? (b = b.fg) : (Ia("expected object of type SafeStyleSheet, got '" + b + "' of type " + xa(b)), (b = 'type_error:SafeStyleSheet'))
...
*/
	var Z = {Bi: function () {}, Ci: function () {}, Di: function () {}, Dg: function () {}, di: function () {}, register: function () {}, gh: function () {}}
	Z = (function () {
		function a(p, r) {
			for (var t = 0; t < k.length; t++) if (k[t].className === p) return ('undefined' !== typeof r && (k[t] = r), k[t])
			return !1
		}
		function b(p) {
		...
		function d(p, r, t) {
			if ('CustomEvent' in window && 'function' === typeof window.CustomEvent) return new CustomEvent(p, {bubbles: r, cancelable: t})
			var z = document.createEvent('Events')
			z.initEvent(p, r, t)
			return z
		}
		function e(p, r) {
			if ('undefined' === typeof p && 'undefined' === typeof r) for (p = 0; p < k.length; p++) e(k[p].className, k[p].ob)
			else {
				...
				for (t = 0; t < r.length; t++) f(r[t], p)
			}
		}
		function f(p, r) {
			if (!('object' === typeof p && p instanceof Element)) throw Error('Invalid argument provided to upgrade MDL element.')
			var t = d('mdl-componentupgrading', !0, !0)
			p.dispatchEvent(t)
			if (!t.defaultPrevented) {
				t = b(p)
				var z = []
				if (r) c(p, r) || z.push(a(r))
				else {
					var ca = p.classList
				...
				for (var qb = z.length, ra; r < qb; r++) {
					if ((ra = z[r])) {
						...
						m.push(Dh)
						for (var Eh = 0, wq = ra.kf.length; Eh < wq; Eh++) ra.kf[Eh](p)
		...
		function g(p) {
			...
			for (var r = 0, t = p.length, z; r < t; r++) ((z = p[r]), z instanceof HTMLElement && (f(z), 0 < z.children.length && g(z.children)))
		}
		function h(p) {
			if (p) {
		...
		return {
			...
			Di: g,
			Dg: function () {
				for (var p = 0; p < k.length; p++) e(k[p].className)
			},
			di: function (p, r) {
				;(p = a(p)) && p.kf.push(r)
			},
			register: function (p) {
				var r = !0
				if ('undefined' !== typeof p.We || 'undefined' !== typeof p.widget) r = p.We || p.widget
				var t = {Ti: p.constructor || p.constructor, className: p.nf || p.classAsString, ob: p.ob || p.cssClass, We: r, kf: []}
				k.forEach(function (z) {
					if (z.ob === t.ob) throw Error('The provided cssClass has already been registered: ' + z.ob)
					if (z.className === t.className) throw Error('The provided className has already been registered')
				})
			...
			gh: function (p) {
				...
				if (p instanceof Array || p instanceof NodeList) for (var t = 0; t < p.length; t++) r(p[t])
				else if (p instanceof Node) r(p)
	...
	window.addEventListener('load', function () {
		'classList' in document.createElement('div') &&
			...
			(document.documentElement.classList.add('mdl-js'), Z.Dg())
	})
	;(function () {
		var a = function (b) {
			this.S = b
		...
		a.prototype.Li = {Mi: 'mdl-progress__indeterminate'}
		...
		Z.register({constructor: a, nf: 'MaterialProgress', ob: 'mdl-js-progress', We: !0})
	})()
	var Yp = {
			'244437093285883777': {
		...
		aq = function (a, b) {
			if (!Zp) {
				Zp = {}
				for (var c in Yp) Zp[Yp[c].en] = c
			}
			b = b.replace('-', '_').toLowerCase()
			return 'undefined' !== typeof Zp[a] && ((c = Zp[a]), 'undefined' !== typeof Yp[c][b]) ? Yp[c][b] : a
		}
	var bq = function (a, b) {
		this.Bk = a
		this.Ak = b
	...
	bq.prototype.render = function (a) {
		var b = (0, this.Bk)(this.Ak || df, void 0)
		var c = Ea || (Ea = new af())
		if (b && b.ak) c = b.ak()
		else {
			...
			d = c
			if (jd()) for (; d.lastChild; ) d.removeChild(d.lastChild)
			d.innerHTML = ed(b)
		}
	...
	bq.prototype.Gb = function () {
		this.S && (this.Nd(), Te(this.S), (this.S = null))
	}
	var cq = function () {
		bq.call(this, ef)
	}
	...
	dq.prototype.Nd = function () {
		this.ab && (Sf(this.ab), (this.ab = null))
	}
	var eq = function (a) {
		bq.call(this, gf, {errorMessage: a})
	}
	q(eq, bq)
	var fq = function (a, b) {
		bq.call(this, hf, {})
	...
	var hq = function (a) {
			this.kg = Oe('DIV', {id: 'progressBarContainer'})
			var b = this
			this.zb = new gn()
			this.uri = G(a)
		...
		nq = function (a) {
			if (a.Ba)
				...
				if (a.Oa) return 'file://asset/www/index.html?apn=' + encodeURIComponent(a.Oa)
		...
		pq = function (a) {
			if (!a.apiKey) throw (si('No API key available'), new P('bad-request'))
	...
	var tq = function (a, b, c, d) {
		...
		sq = function (a, b) {
			...
			return e
				.then(function () {
					if ((a.Oa || a.sb) && a.ib) return ((d = !0), uq(a.ib, b, a.Oa, a.sb, a.clientId, a.Wb, a.bf, a.Ib, a.pb, a.publicKey))
					if ('verifyApp' === a.authType && b.Y) return ((d = !0), vq(b.getError()))
					if (c) {
						var f = a.zb
				...
				.then(function () {
					if (c) return a.zb.o.remove(hn, c)
				})
				.Ab(function () {
					d
						? qq(a)
				...
				.then(function () {
					if ('verifyApp' === b.getType() && d) {
						...
						return 'verifyApp' === b.getType() && c
							? yq(null, b, c, d, e, f, g, h, k, m)
							: c
								? Ck(a, c, f).then(function () {
										var p = null
										p = f ? J('playservices.app.goo.gl') : Q(a, ll, {returnDynamicLink: !0})
		...
		vq = function (a) {
			var b =
				...
				('auth/dynamic-link-not-activated' != a.code &&
					...
					? (Ae['fireauth.oauthhelper.ui.soy.temporaryErrorMessage']
							? Ae['fireauth.oauthhelper.ui.soy.temporaryErrorMessage'](void 0, void 0)
		...
		yq = function (a, b, c, d, e, f, g, h, k, m) {
			...
			var p = c ? c : d,
				r = null
			f
				? ((r = zq(b, c, h, m)), (p = 'com.google.android.gms'))
				: (e || k) && d && 'verifyApp' !== b.getType() && !b.Y
					? ((r = window.location.protocol + '//' + window.location.host + '/__/auth/callback?authType=' + encodeURIComponent(b.getType()) + '&link=' + encodeURIComponent(b.Xa)),
						h && (r += '&eventId=' + h))
					: b.Y
						? ((r =
		...
		zq = function (a, b, c, d) {
			if ('android_non_gmscore' === d) {
				...
				c && (b += 'S.eventId=' + c + ';')
				a.Y ? (b += 'S.firebaseError=' + encodeURIComponent(ji(a.getError().m())) + ';') : ((b += 'S.link=' + encodeURIComponent(d) + ';'), (b += 'B.encryptionEnabled=false;'))
		...
		xq = function (a, b, c) {
			...
			if (Sp() && d && /popup/i.test(c.getType() || '')) {
				...
				if (0 === e.length) return ln(a, b, c)
				var m = []
				e.forEach(function (p) {
					var r = !1
					m.push(
						Zl(p, 'sendAuthEvent', {storageKey: b, authEvent: c.m()}, 2e4).then(function (t) {
	...
	var Aq = function (a) {
		this.Ug = !1
		this.Oc = Oe('DIV')
		if ('verifyApp' !== oq(G(a), 'authType')) throw Error('Invalid mode!')
	...
	Aq.prototype.cb = function () {
		...
		return J()
			...
			.then(function () {
				pq(a)
				if (a.clientId) return Dk(a.ib, a.clientId)
				if (a.pb) return Ek(a.ib, a.pb)
				if (a.Oa && a.Wb) return Ck(a.ib, a.Oa, a.Wb)
				throw new P('internal-error')
			})
	}
	var Bq = function (a) {
		...
		return a.Vf.then(function () {
			...
			a.Ug || ((a.Ug = !0), document.body.appendChild(a.Oc))
			qq(a)
			a.Kd.render(a.Oc)
			b = Ke('verify')
			a.Cb = new Sl(
	...
	var Dq = function (a) {
		...
		if (!a.Ba && b && /popup/i.test(a.authType || '')) {
			...
			for (c = 0; c < a.wd.length; c++)
				b.push(
					Zl(a.wd[c], 'getParentOrigin', null, 2e4).then(function (f) {
						for (var g = 0; g < f.length; g++) f[g].fulfilled && f[g].value && (a.Ba = f[g].value)
						if (!a.Ba) throw Error('Unable to determine origin')
					})
				)
			return Jg(b)
				.h(function () {})
				.then(function () {
					for (var f = 0; f < a.wd.length; f++) a.wd[f].close()
				})
		}
		return J()
	}
				...
				return (
					a.Ba
						? Ak(a.ib)
								...
								.then(function (c) {
									if (!Rh(c, a.Ba)) throw (si('App domain is unauthorized'), new P('bad-request'))
								})
						: J()
				).then(function () {
					...
					if (c.ff && c.ff.includes(a.providerId))
						throw new P(
							'operation-not-supported-in-this-environment',
							'This web-based operation for the ' + a.providerId + " provider is not supported in this environment. Please use the identity provider's native SDK instead."
						)
	...
	var Eq = function (a, b, c, d, e) {
			var f,
				g = Ad(Bd(G(a.uri.toString()), ''), '').toString(),
				h = null
			return wk(a.ib, b, g, c, d, e)
				.then(function (k) {
					f = k
					return Dq(a)
				})
				.then(function () {
					var k = G(f.authUri),
						m = nq(a),
						p
					;(p = (p = u.window) && p.innerWidth && p.innerHeight ? {width: parseFloat(p.innerWidth), height: parseFloat(p.innerHeight)} : null) &&
						800 > p.width &&
						'facebook.com' == b &&
						!a.Ba &&
						E(k, 'display', 'popup')
		...
		Fq = function (a) {
			...
			return new I(function (c, d) {
				var e = function () {
					10 <= b++
						? (si('Unable to save initial state.'), d(new P('bad-request', 'Unable to save initial state. This may happen if browser sessionStorage is inaccessible.')))
						: kn(a.zb).then(function (f) {
								f ? c() : setTimeout(e, 1)
							})
				}
				e()
	...
	Gq.prototype.cb = function () {
		...
		return kn(this.zb).then(function (b) {
			if (!b)
				throw (
					si('Unable to process request due to missing initial state.'),
	...
	var Iq = function (a, b) {
			if (a.Ce && 'apple.com' === a.providerId) {
				...
				var c = yi(a.Ce)
				a.Ce = null
				for (var d in c) c.hasOwnProperty(d) && E(b, d, c[d])
				return b.toString()
			}
			return b
		},
	...
	function Lq() {
		...
		0 === a.length ? (a = bd) : (y(!A(a, '<'), "Forbidden '<' character in style sheet string: " + a), (a = new ad(a, $c)))
		var b = Ea || (Ea = new af()),
			c = b.Qa
		if (xb && c.createStyleSheet) ((b = c.createStyleSheet()), Xp(b, a))
		else {
			c = bf(b, 'HEAD')[0]
			if (!c) {
				var d = bf(b, 'BODY')[0]
	...
	for (var Qq; Oq.length && (Qq = Oq.shift()); ) Oq.length || void 0 === Nq ? (Pq = Pq[Qq] && Pq[Qq] !== Object.prototype[Qq] ? Pq[Qq] : (Pq[Qq] = {})) : (Pq[Qq] = Nq)
}).call(this)
