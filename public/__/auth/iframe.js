...
*/
	...
	ea('Promise', function (a) {
		...
		e.prototype.vg = function () {
			...
			var h = this,
				l = !1
			return {resolve: g(this.Ul), reject: g(this.wh)}
		}
		e.prototype.Ul = function (g) {
			if (g === this) this.wh(new TypeError('A Promise cannot resolve to itself'))
		...
		e.prototype.Ik = function () {
			if (null != this.yd) {
				for (var g = 0; g < this.yd.length; ++g) f.Vh(this.yd[g])
				this.yd = null
			}
		}
		var f = new b()
		...
		e.race = function (g) {
			return new e(function (h, l) {
				for (var m = ha(g), q = m.next(); !q.done; q = m.next()) c(q.value).Qe(h, l)
			})
		}
		e.all = function (g) {
			var h = ha(g),
			...
			return l.done
				...
				: new e(function (m, q) {
						...
						var B = [],
							S = 0
						do (B.push(void 0), S++, c(l.value).Qe(y(B.length - 1), q), (l = h.next()))
						while (!l.done)
					})
		}
		return e
	...
	ea('Map', function (a) {
		...
		c.prototype.set = function (h, l) {
			...
			m.Oa
				? (m.Oa.value = l)
				: ((m.Oa = {next: this[1], Yb: this[1].Yb, head: this[1], key: h, value: l}), m.list.push(m.Oa), (this[1].Yb.next = m.Oa), (this[1].Yb = m.Oa), this.size++)
			return this
		}
		c.prototype.delete = function (h) {
			h = d(this, h)
			return h.Oa && h.list
				? (h.list.splice(h.index, 1), h.list.length || delete this[0][h.id], (h.Oa.Yb.next = h.Oa.next), (h.Oa.next.Yb = h.Oa.Yb), (h.Oa.head = null), this.size--, !0)
				: !1
		}
		...
		c.prototype.forEach = function (h, l) {
			for (var m = this.entries(), q; !(q = m.next()).done; ) ((q = q.value), h.call(l, q[1], q[0], this))
		}
		...
		var d = function (h, l) {
				...
				if (q && qa(h[0], m))
					for (h = 0; h < q.length; h++) {
						var y = q[h]
						if ((l !== l && y.key !== y.key) || l === y.key) return {id: m, list: q, index: h, Oa: y}
					}
	...
	var mb = function (a) {
			if (a instanceof lb && a.constructor === lb && a.hk === kb) return a.Nh
		...
		jb = {}
	var ob = function (a, b) {
		if (b !== nb) throw Error('TrustedResourceUrl is not meant to be built directly')
		this.mh = a
	}
	...
	var pb = function (a) {
			if (a instanceof ob && a.constructor === ob) return a.mh
	...
	var Cb = function (a, b) {
		if (b !== Bb) throw Error('SafeUrl is not meant to be built directly')
		this.lh = a
	}
	...
	var Db = function (a) {
			if (a instanceof Cb && a.constructor === Cb) return a.lh
		...
		Hb = function (a) {
			...
			Fb.test(a) ? (a = Gb(a)) : ((a = String(a).replace(/(%0A|%0D)/g, '')), (a = a.match(Eb) ? Gb(a) : null))
			return a
		},
		Ib
	try {
	...
	var Xb = {},
		Yb = function (a, b) {
			if (b !== Xb) throw Error('SafeHtml is not meant to be built directly')
			this.kh = a
			this.tc = !0
		}
	...
	var Zb = function (a) {
		if (a instanceof Yb && a.constructor === Yb) return a.kh
	...
	var ac = new $b('OFF', Infinity),
		bc = new $b('SEVERE', 1e3),
		cc = new $b('WARNING', 900),
		dc = new $b('CONFIG', 700),
		ec = new $b('FINE', 500),
		fc = function () {
			this.Re = 0
	...
	var ic = function (a) {
		...
		jc = function (a) {
			...
			if (a.parent) return jc(a.parent)
		...
		pc = function (a, b, c) {
			if (a && a && b && b.value >= (a ? jc(nc(oc(), null)) : ac).value) {
				...
				if (0 < d.Re) {
					var e = (d.ii + 1) % d.Re
					d.ii = e
					d.Ri ? ((d = d.Yh[e]), d.reset(b, c, null)) : ((d.Ri = e == d.Re - 1), (d = d.Yh[e] = new hc(b, c)))
				} else d = new hc(b, c)
				kc(a, d)
			}
		},
...
*/
	...
	var xc = Ub() ? !1 : A('Opera'),
		...
		zc = A('Edge'),
		Ac = zc || yc,
		Bc = A('Gecko') && !(z(Qb().toLowerCase(), 'webkit') && !A('Edge')) && !(A('Trident') || A('MSIE')) && !A('Edge'),
		Cc = z(Qb().toLowerCase(), 'webkit') && !A('Edge'),
		Dc = Cc && A('Mobile'),
		Ec = function () {
			var a = p.document
	...
	var Rc = function (a, b) {
		...
		Tc = function (a, b) {
			...
			a: {
				...
				if (c.querySelector && (c = c.querySelector('script[nonce]')) && (c = c.nonce || c.getAttribute('nonce')) && Sc.test(c)) break a
				c = ''
			}
 ...
 gapi.loader.OBJECT_CREATE_TEST_OVERRIDE &&*/
	var C = window,
		...
		md = function (a, b, c) {
			if (a)
				...
				} else for (d in (D('object' === typeof a, 'objectForEach was called with a non object value'), (c = c || a), a)) ld(a, d) && void 0 !== a[d] && b.call(c, a[d], d)
		},
		nd = /&/g,
		od = /</g,
		pd = />/g,
		...
		td = function () {
			var a
			if ((a = Object.create) && hd.test(a)) a = a(null)
			else {
				a = {}
	...
	var wd = function (a, b, c) {
		...
		Gd = function (a, b) {
			...
			var d = ''
			2e3 < b.length && ((d = b), (b = b.substr(0, 2e3)), (b = b.replace(Fd, '')), (d = d.substr(b.length)))
			...
			if (1 === e.nodeType && ((c = e.tagName), 'SCRIPT' === c || 'STYLE' === c))
	...
	var Md = /^https?:\/\/(?:\w|[\-\.])+\.google\.(?:\w|[\-:\.])+(?:\/[^\?#]*)?\/u\/(\d)\//,
		...
		Od = function () {
			...
			'string' === typeof a && 254 < a.length && (a = null)
			null == a && ((b = window.location.href), (a = wd(b, 'authuser') || null), null == a && (a = (a = b.match(Md)) ? a[1] : null))
	...
	var Rd,
			...
			if ('undefined' !== d) {
				...
				if (
					...
					(Object.prototype.hasOwnProperty.call(a, 'toJSON') ||
						((e !== ae || (a.constructor !== Array && a.constructor !== Object)) &&
							(e !== $d || (a.constructor !== Array && a.constructor !== Object)) &&
							e !== Zd &&
							e !== Wd &&
							e !== Yd &&
							e !== Xd))
				...
				else if (e === Wd) ((a = Number(a)), isNaN(a) || isNaN(a - a) ? (a = 'null') : -0 === a && 0 > 1 / a && (a = '-0'), (b[b.length] = String(a)))
				else if (e === Yd) b[b.length] = String(!!Number(a))
				else {
					if (e === Xd) return be(a.toISOString.call(a), c)
					if (e === ae && Vd(a.length) === Wd) {
						b[b.length] = '['
						var f = 0
						for (d = Number(a.length) >> 0; f < d; ++f) (f && (b[b.length] = ','), (b[b.length] = be(a[f], c) || 'null'))
						b[b.length] = ']'
						...
						for (f in a)
							Object.prototype.hasOwnProperty.call(a, f) &&
								((e = be(a[f], c)), void 0 !== e && (d++ && (b[b.length] = ','), (b[b.length] = be(f)), (b[b.length] = ':'), (b[b.length] = e)))
						b[b.length] = '}'
					} else return
				}
				return b.join('')
		...
		ce = /[\0-\x07\x0b\x0e-\x1f]/,
		de = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*[\0-\x1f]/,
		ee = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\[^\\\/"bfnrtu]/,
		fe = /^([^"]*"([^\\"]|\\.)*")*[^"]*"([^"\\]|\\.)*\\u([0-9a-fA-F]{0,3}[^0-9a-fA-F])/,
		ge = /"([^\0-\x1f\\"]|\\[\\\/"bfnrt]|\\u[0-9a-fA-F]{4})*"/g,
		he = /-?(0|[1-9][0-9]*)(\.[0-9]+)?([eE][-+]?[0-9]+)?/g,
		ie = /[ \t\n\r]+/g,
		je = /[^"]:/,
		ke = /""/g,
		le = /true|false|null/g,
		me = /00/,
		oe = /[\{]([^0\}]|0[^:])/,
		pe = /(^|\[)[,:]|[,:](\]|\}|[,:]|$)/,
		qe = /[^\[,:][\[\{]/,
		...
		ue = function (a) {
			a = String(a)
			if (ce.test(a) || de.test(a) || ee.test(a) || fe.test(a)) return !1
			var b = a.replace(ge, '""')
			b = b.replace(he, '0')
			b = b.replace(ie, '')
			if (je.test(b)) return !1
			b = b.replace(ke, '0')
			b = b.replace(le, '0')
			if (me.test(b) || oe.test(b) || pe.test(b) || qe.test(b) || !b || (b = b.replace(re, ''))) return !1
			...
			if ((void 0 === Rd || void 0 === Td || Sd !== a) && -1 !== Sd) {
				...
				try {
					try {
						Td =
							!!p.JSON &&
							'{"a":[3,true,"1970-01-01T00:00:00.000Z"]}' === p.JSON.stringify.call(p.JSON, {a: [3, !0, new Date(0)], c: function () {}}) &&
							!0 === Ud('true') &&
							3 === Ud('[{"a":3}]')[0].a
					} catch (b) {}
		...
		xe = function (a) {
			if (-1 !== Sd) return (ve(), Td ? p.JSON.stringify.call(p.JSON, a) : be(a))
		},
		ye = !Date.prototype.toISOString || 'function' !== typeof Date.prototype.toISOString || '1970-01-01T00:00:00.000Z' !== new Date(0).toISOString(),
		ze = function () {
	...
	var Be = function () {
		...
		this.Cf = []
		this.Cf[0] = 128
		for (var a = 1; a < this.blockSize; ++a) this.Cf[a] = 0
		this.bc = this.ud = 0
		this.reset()
	}
	v(Be, Ae)
	...
	var Ce = function (a, b, c) {
		...
		for (e = 0; 80 > e; e++) {
			...
			else 60 > e ? ((f = (c & g) | (h & (c | g))), (m = 2400959708)) : ((f = c ^ g ^ h), (m = 3395469782))
	...
	Be.prototype.update = function (a, b) {
		if (null != a) {
			...
			for (var c = b - this.blockSize, d = 0, e = this.ng, f = this.ud; d < b; ) {
				if (0 == f) for (; d <= c; ) (Ce(this, a, d), (d += this.blockSize))
				if ('string' === typeof a)
					for (; d < b; ) {
	...
	Be.prototype.digest = function () {
		...
		for (var c = this.blockSize - 1; 56 <= c; c--) ((this.ng[c] = b & 255), (b /= 256))
		Ce(this, this.ng)
		for (c = b = 0; 5 > c; c++) for (var d = 24; 0 <= d; d -= 8) ((a[b] = (this.va[c] >> d) & 255), ++b)
		return a
	}
	var De = function () {
		this.Hh = new Be()
	...
	Fe ||
		((Je = 1e6 * (screen.width * screen.width + screen.height)),
	...
	var Re = {allowtransparency: 'true', frameborder: '0', hspace: '0', marginheight: '0', marginwidth: '0', scrolling: 'no', style: '', tabindex: '0', vspace: '0', width: '100%'},
		Se = {allowtransparency: !0, onload: !0},
		Te = 0,
		Ue = function (a, b) {
			var c = 0
			do var d = b.id || ['I', Te++, '_', new Date().getTime()].join('')
		...
		We = function (a, b, c, d) {
			...
			g = g || ''
			!g && c && ((g = wd(a.location.href, '_gfid', '') || wd(a.location.href, 'id', '')), (g = Ve(g, wd(a.location.href, 'pfname', ''))))
			g || ((c = we(wd(a.location.href, 'jcp', ''))) && 'object' == typeof c && (g = Ve(c.id, c.pfname)))
			h.pfname = g
			d.connectWithJsonParam && ((g = {}), (g.jcp = xe(h)), (h = g))
			...
			if (!g) {
				if (!(g = d.rpctoken)) {
					...
					if (Fe) {
						...
						m = Number('0.' + m[0])
					} else ((m = Ie), (m += parseInt(Ke.substr(0, 20), 16)), (Ke = Me(Ke)), (m /= Je + Math.pow(16, 20)))
					g = g(l.call(c, 1e8 * m))
				}
				h.rpctoken = g
			}
		...
		Ye = function (a, b, c, d, e) {
			...
			try {
				document.all &&
					(f = a.createElement('<iframe frameborder="' + sd(String(c.frameborder)) + '" scrolling="' + sd(String(c.scrolling)) + '" ' + h + ' name="' + sd(String(c.name)) + '"/>'))
			} catch (m) {
			} finally {
				f ||
					((f = (a ? new fd(ed(a)) : Ba || (Ba = new fd())).xk('IFRAME')),
					g &&
						((f.onload = function () {
							f.onload = null
							g.call(this)
			...
			for (var l in c) ((a = c[l]), 'style' === l && 'object' === typeof a ? ud(a, f.style) : Se[l] || f.setAttribute(l, String(a)))
	...
	var Ze = /^:[\w]+$/,
		...
		af = function (a, b) {
			...
			Id = {socialhost: g, ctx_socialhost: e ? h : g, session_index: a, session_delegate: c, session_prefix: d, im_prefix: f}
			return Id[b] || ''
		},
		bf = function (a) {
			var b = a
			Ze.test(a) && ((b = za('iframes/' + b.substring(1) + '/url')), D(!!b, 'Unknown iframe url config for - ' + a))
	...
	;(window.___jsl.cd = window.___jsl.cd || []).push({
		...
		gappsutil: {required_scopes: ['https://www.googleapis.com/auth/plus.me', 'https://www.googleapis.com/auth/plus.people.recommended'], display_on_page_ready: !1},
		appsutil: {required_scopes: ['https://www.googleapis.com/auth/plus.me', 'https://www.googleapis.com/auth/plus.people.recommended'], display_on_page_ready: !1},
		'oauth-flow': {authUrl: 'https://accounts.google.com/o/oauth2/auth', proxyUrl: 'https://accounts.google.com/o/oauth2/postmessageRelay', redirectUri: 'postmessage'},
		iframes: {
			...
			card: {params: {s: '#', userid: '&'}, url: ':socialhost:/:session_prefix:_/hovercard/internalcard'},
		...
		report: {apis: ['iframes\\..*', 'gadgets\\..*', 'gapi\\.appcirclepicker\\..*', 'gapi\\.client\\..*'], rate: 1e-4},
	...
	var df = function (a) {
			...
			if (b && 'object' === typeof b)
				for (var d in b)
					!Object.prototype.hasOwnProperty.call(b, d) ||
						...
						(a[d] && b[d] && 'object' === typeof a[d] && 'object' === typeof b[d] && !ff(a[d]) && !ff(b[d])
							? gf(a[d], b[d])
							: b[d] && 'object' === typeof b[d]
								? ((a[d] = ff(b[d]) ? [] : {}), gf(a[d], b[d]))
								: (a[d] = b[d]))
		},
		hf = function (a) {
			if (a && !/^\s+$/.test(a)) {
		...
		kf = function (a) {
			...
			var b = window.___gcfg,
				c = df('cu'),
				d = window.___gu
			b && b !== d && (jf(c, b), (window.___gu = b))
			b = df('cu')
			var e = document.scripts || document.getElementsByTagName('script') || []
			d = []
			var f = []
			f.push.apply(f, df('us'))
			for (var g = 0; g < e.length; ++g) for (var h = e[g], l = 0; l < f.length; ++l) h.src && 0 == h.src.indexOf(f[l]) && d.push(h)
			...
			d = df('cd')
			a = 0
			for (b = d.length; a < b; ++a) gf(ef(), d[a], !0)
			d = df('ci')
			a = 0
			for (b = d.length; a < b; ++a) gf(ef(), d[a], !0)
			a = 0
			for (b = c.length; a < b; ++a) gf(ef(), c[a], !0)
		}
	var lf = function () {
		var a = window.__GOOGLEAPIS
		a && (a.googleapis && !a['googleapis.config'] && (a['googleapis.config'] = a.googleapis), id(Qd, 'ci', []).push(a), (window.__GOOGLEAPIS = void 0))
	}
	lf && lf()
	kf()
	...
	function sf(a) {
		...
		var d = []
		b = b(a, d)
		!b && d && ((a = 'Expected exists, got ' + qf(a)), d.push(a))
	...
	var yf = function (a, b, c) {
			c =
				void 0 === c
					...
					: c
			if (!b.Ve) return b.instance
			c = c(b.Ve)
			a.rk && (delete b.Ve, (b.instance = c))
			return c
		},
		zf = function () {
	...
	Ff.prototype.put = function (a) {
		this.Sl(a)
		this.Af < this.wl && (this.Af++, (a.next = this.ff), (this.ff = a))
	}
	var Gf,
		Hf = function () {
	...
	Jf.prototype.add = function (a, b) {
		var c = Kf.get()
		c.set(a, b)
		this.Zf ? (this.Zf.next = c) : (w(!this.Zc), (this.Zc = c))
		this.Zf = c
	}
	Jf.prototype.remove = function () {
		var a = null
		this.Zc && ((a = this.Zc), (this.Zc = this.Zc.next), this.Zc || (this.Zf = null), (a.next = null))
		return a
	}
	var Kf = new Ff(
			function () {
	...
	var Pf,
		...
		Sf = function () {
			if (p.Promise && p.Promise.resolve) {
				...
				Pf = function () {
					var b = Uf
					'function' !== typeof p.setImmediate || (p.Window && p.Window.prototype && (Ub() || !A('Edge')) && p.Window.prototype.setImmediate == p.setImmediate)
						? (Gf || (Gf = Hf()), Gf(b))
						: p.setImmediate(b)
				}
		},
				...
				if (c)
					for (
						var e = function (h, l, m) {
								c--
								d[h] = l ? {zi: !0, value: m} : {zi: !1, reason: m}
								0 == c && b(d)
							},
							f = 0,
							g;
	...
	var gg = function (a, b) {
			if (0 == a.Ba)
				if (a.Ha) {
					var c = a.Ha
					if (c.Wb) {
						for (var d = 0, e = null, f = null, g = c.Wb; g && (g.Rd || (d++, g.child == a && (e = g), !(e && 1 < d))); g = g.next) e || (f = g)
						e && (0 == c.Ba && 1 == d ? gg(c, b) : (f ? ((d = f), w(c.Wb), w(null != d), d.next == c.hd && (c.hd = d), (d.next = d.next.next)) : hg(c), ig(c, e, 3, b)))
					}
					a.Ha = null
				} else Wf(a, 3, b)
		},
	...
	var Wf = function (a, b, c) {
			0 == a.Ba &&
				(a === c && ((b = 3), (c = new TypeError('Promise cannot resolve to itself'))),
				(a.Ba = 1),
				ag(c, a.sm, a.tm, a) || ((a.Ua = c), (a.Ba = b), (a.Ha = null), jg(a), 3 != b || c instanceof Xf || kg(a, c)))
		},
		ag = function (a, b, c, d) {
			if (a instanceof E)
				return (
					null != b && Ja(b, 'opt_onFulfilled should be a function.'),
			...
			if (t(a))
				try {
					var e = a.then
					if ('function' === typeof e) return (lg(a, e, b, c, d), !0)
				} catch (f) {
					return (c.call(d, f), !0)
				}
			return !1
	...
	E.prototype.Hk = function () {
		for (var a; (a = hg(this)); ) ig(this, a, this.Ba, this.Ua)
		this.Cg = !1
	}
	var ig = function (a, b, c, d) {
			if (3 == c && b.xd && !b.Rd) for (; a && a.af; a = a.Ha) a.af = !1
			if (b.child) ((b.child.Ha = null), mg(b, c, d))
			else
				try {
	...
	var og,
		...
		ug = function (a) {
			for (var b = td(), c = 0; c < a.length; c++) b[a[c]] = !0
			return function (d) {
				return !!b[d.Ib]
			}
		},
		...
		yg = function (a, b, c) {
			D('_default' != a, 'Cannot update default api')
			id(pg, a, {map: {}, filter: sg}).map[b] = c
		},
		zg = function (a, b) {
			id(pg, '_default', {map: {}, filter: tg}).map[a] = b
			md(qg.kb, function (c) {
				c.register(a, b, tg)
			})
		},
	...
	var ih = new hh()
	var qh = function () {
		this.He = {Aj: jh ? '../' + jh : null, Bk: kh, Ei: lh, Pm: mh, getToken: nh, Qm: oh}
		this.ub = C
		this.uj = this.Ak
	...
	qh.prototype.setup = function (a, b) {
		'..' === a || this.Sh[a] ? (b(), delete this.Sh[a]) : (this.Ih[a] = b)
	}
	...
	var th = 0,
		...
		Ih = function (a, b, c) {
			a = Gh(a)
			wh[a.name] = {Zd: b, le: a.le, Ca: c || Eh}
			Hh()
		},
		Jh = {},
		Kh = function (a, b) {
		...
		Nh = function (a) {
			...
			if (b && b.ready) {
				var c = b.rh
				for (b.rh = []; c.length; ) Dh.send(a, xe(c.shift()), b.origin)
			}
		},
		Gh = function (a) {
			return 0 === a.indexOf('legacy__') ? {name: a.substring(8), le: !0} : {name: a, le: !1}
		},
		Hh = function () {
			for (var a = za('rpc/residenceSec') || 60, b = new Date().getTime() / 1e3, c, d = 0; (c = uh[d]); ++d) {
				var e = c.rpc
				if (!e || (0 < a && b - c.timestamp > a)) (uh.splice(d, 1), --d)
				else {
					var f = e.s,
						g = wh[f] || wh['*']
					if (g)
						if ((uh.splice(d, 1), --d, (e.origin = c.origin), (c = Mh(e)), (e.callback = c), g.Ca(e))) {
							if ('__cb' !== f && !!g.le != !!e.g) break
							e = g.Zd.apply(e, e.a)
							void 0 !== e && c(e)
						} else ih.debug('gapix.rpc.rejected(' + mh + '): ' + f)
				}
			}
		},
		Ph = function (a, b, c) {
			uh.push({rpc: a, origin: b, timestamp: new Date().getTime() / 1e3})
			c || Hh()
		},
		kh = function (a, b) {
			a = we(a)
		...
		Qh = function (a) {
			for (; a.length; ) Ph(a.shift(), this.origin, !0)
			Hh()
		},
		Rh = function (a) {
			var b = !1
		...
		Sh = function (a, b, c, d) {
			...
			if (!vh.hasOwnProperty(a)) {
				...
				if ('..' === a) ((d = mf(zh)), (c = c || yh))
					...
					f && ((f = f.src), (d = mf(f)), (c = c || wd(f, 'rpctoken')))
				}
		...
		Lh = function (a, b, c, d) {
				...
				if (y.Qg) {
					if (!(l = vh[a].am)) {
						...
						for (var B = C.parent; B !== C.top; ) {
							var S = B.parent
							if (!q--) {
								for (var Ca = null, Fc = S.frames.length, ne = 0; ne < Fc; ++ne) S.frames[ne] == B && (Ca = ne)
								l.unshift('{' + Ca + '}')
							}
							B = S
						}
			...
			g && y ? ((m = Eh), y.Qg && (m = Fh(y)), (Jh['_' + ++th] = [g, m]), (g = th)) : (g = null)
	...
	var Vh = function (a, b, c) {
			a.setTimeout(function () {
				b.closed || 5 == c ? Uh(b) : (b.close(), c++, Vh(a, b, c))
			}, 1e3)
		},
		Uh = function (a) {
	...
	k.register = function (a, b, c) {
		...
		c = Wh(this, a)
		1 == id(og, c, []).push(b) && (this.Bb.push(a), Ih(c, wg(c, this, '_g_wasClosed' === a)))
	}
	k.unregister = function (a, b) {
		var c = Wh(this, a),
			d = og[c]
		d &&
			(b ? ((b = kd.call(d, b)), 0 <= b && d.splice(b, 1)) : d.splice(0, d.length),
			0 == d.length && ((b = kd.call(this.Bb, a)), 0 <= b && this.Bb.splice(b, 1), delete wh[Gh(c).name]))
	}
	k.Qk = function () {
		return this.Bb
	}
	k.applyIframesApi = function (a) {
		...
		if (!(0 <= kd.call(this.fg, a))) {
			this.fg.push(a)
			a = pg[a] || {map: {}}
			for (var b in a.map) ld(a.map, b) && this.register(b, a.map[b], a.filter)
		}
	}
	k.getWindow = function () {
		if (!sg(this)) return null
	...
	var Xh = function (a) {
		var b = {}
		if (a) for (var c in a) ld(a, c) && ld(Cf, c) && Df.test(a[c]) && (b[c] = a[c])
		return b
	}
	k = I.prototype
	...
	k.Zl = function (a) {
		...
		;(b = this.getIframeEl()) && a && 'object' === typeof a && (ld(a, 'height') && (a.height = Ef(a.height)), ld(a, 'width') && (a.width = Ef(a.width)), ud(a, b.style))
	}
	k.tk = function (a) {
		...
		if ((b = this.getOptions().i._popupWindow)) {
			...
			Dc && Th && c ? (c.focus(), Vh(c, b, 0)) : (b.close(), Uh(b))
		}
	...
	k.wk = function (a) {
		...
		for (var b = a.rpcAddr, c = (this.ob() + '/' + b).split('/'), d = this.getContext().getWindow(), e; (e = c.shift()) && d; ) d = '..' == e ? d.parent : d.frames[e]
	...
	k.uk = function (a) {
		...
		if (a.i.selfConnect) var c = this
			...
			(D(Bg.test(b.getOrigin()), 'Illegal origin for connected iframe - ' + b.getOrigin()), (c = this.getContext().kb[b.getFrameName()]), c)
				? Gg(b) && (c.ac(), J(c, '_g_rpcReady'))
				: ((b = Zg(bh(ah($g(new H(), b.ob()), b.Fb()), b.getOrigin()), b.getFrameName())
						.ac(Gg(b))
						.Wc(Hg(b))),
		...
		Zh(b)
		d = d || ''
		id(b.sg, d, []).push({kf: c, data: a})
		$h(c, a, b.Xg[d])
	}
	k.Jj = function (a, b) {
		new H(b).i._relayedDepth || ((b = {}), Ig(Eg(new Xg(b), '_opener')), J(a, '_g_connect', b))
	}
	k.qj = function (a) {
		var b = this,
	...
	k.zh = function (a) {
		...
		var c = Ug(a).value()
		b = {}
		for (var d in c) ld(c, d) && ld(Cg, d) && (b[d] = c[d])
		ld(c, 'style') && ((d = c.style), 'object' === typeof d && (b.style = Xh(d)))
	...
	var hi = function () {
			...
			for (var b = 0, c = [document.body]; 0 < c.length; ) {
				...
				if ('undefined' !== typeof d.style) {
					...
					if (
						'visible' != f &&
						'inherit' != f &&
						((f = d.style.height), f || (f = (f = document.defaultView.getComputedStyle(d, null)) ? f.height : ''), 0 < f.length && 'auto' != f)
					)
						continue
				}
		...
		ii = function () {
			...
			if (0 <= navigator.userAgent.indexOf('AppleWebKit')) return hi()
			if (b && c) {
	...
	k.Ic = function () {
		if (!this.isDisposed()) {
			for (var a = ha(Object.values(this.kb)), b = a.next(); !b.done; b = a.next()) b.value.Ic()
			this.Cb = !0
		}
	}
	k.getFrameName = function () {
	...
	var Yh = function (a, b) {
		...
		var f = b.Fb(),
			g = Hg(b)
		g || ((g = ((g = b.getIframeEl()) && (g.getAttribute('data-postorigin') || g.src)) || b.getUrl()), (g = wd(g, 'rpctoken')))
	...
	K.prototype.zh = function (a) {
		Zg(a, null)
		var b = a.getId()
		!b || (rg.test(b) && !this.getWindow().document.getElementById(b)) || (ih.log('Ignoring requested iframe ID - ' + b), (a.i.id = null))
	}
	var ji = function (a, b) {
		var c = wd(a, b)
		c || (c = we(wd(a, 'jcp', ''))[b])
	...
	K.prototype.openChild = function (a) {
		...
		d || ((d = b.i.where), D(!!d, 'No location for new iframe'), (c = cf(c, d, a)), (b.i.iframeEl = c), (d = c.getAttribute('id')))
		$g(b, d).i.id = d
		bh(b, mf(b.i.eurl || ''))
	...
	var li = function (a, b, c) {
		...
		mi = function (a, b, c) {
			...
			if (d) {
				...
				d instanceof I ? ((e = d), (b.i.relayOpen = 0)) : 0 < Number(d) && (b.i.relayOpen = Number(d) - 1)
				if (e) {
					D(!!e.qj, 'Relaying iframe open is disabled')
					if ((d = b.getStyle())) if ((d = bi[d])) (ch(b, a), d(b.value()), ch(b, null))
		...
		ni = function (a, b, c) {
			var d = b.getStyle()
			if (d)
				if ((D(!!di, 'Defer style is disabled, when requesting style ' + d), ai[d])) ki(a, b)
				else
					return (
						ei(d, function () {
	...
	K.prototype.open = function (a, b) {
		...
		if (mi(this, c, d) || ni(this, c, d) || mi(this, c, d)) return d.promise
		if (null != Wg(c)) {
			var e = setTimeout(function () {
					g.getIframeEl().src = 'about:blank'
					d.reject({timeout: 'Exceeded time limit of :' + Wg(c) + 'milliseconds'})
				}, Wg(c)),
				f = d.resolve
	...
	k.restyleSelf = function (a, b, c) {
		a = a || {}
		b = new gh(b)
		b.resolve(oi(this, {message: '_g_restyleMe', params: a, kf: c, filter: this.getGlobalParam('onRestyleSelfFilter'), ym: !0, rj: this.Vj}))
		return b.promise
	}
	k.Vj = function (a) {
	...
	K.prototype.connectIframes = function (a, b) {
		...
		if (e) {
			...
			d && J(e, '_g_connect', h.value())
		} else ((c = {}), Fg(Eg(Ig(new Xg(c)), a.i.role), a.i.data), J(b, '_g_connect', c))
	}
	var Zh = function (a) {
		a.sg || ((a.sg = td()), (a.Xg = td()))
	}
	K.prototype.addOnConnectHandler = function (a, b, c, d) {
		Zh(this)
		'object' === typeof a ? ((b = new Mg(a)), (c = b.i.role || '')) : ((b = Pg(Og(Ng(a), b).Be(c), d)), (c = a))
		d = this.sg[c] || []
		a = !1
		for (var e = 0; e < d.length && !a; e++) ($h(this.kb[d[e].kf.getFrameName()], d[e].data, [b]), (a = b.i.runOnce))
		c = id(this.Xg, c, [])
		a || b.i.dontWait || c.push(b)
	}
	K.prototype.removeOnConnectHandler = function (a, b) {
		a = id(this.Xg, a, [])
		if (b) for (var c = !1, d = 0; !c && d < a.length; d++) a[d].i.handler === b && ((c = !0), a.splice(d, 1))
	...
	var Ai = function (a, b) {
		...
		yi
	v(Ai, Ae)
	for (var Bi = [], Ci = 0; 63 > Ci; Ci++) Bi[Ci] = 0
	...
	Ai.prototype.update = function (a, b) {
		...
		var c = 0,
			d = this.td
		if ('string' === typeof a) for (; c < b; ) ((this.Te[d++] = a.charCodeAt(c++)), d == this.blockSize && (Ei(this), (d = 0)))
		else if (ua(a))
			for (; c < b; ) {
				var e = a[c++]
	...
	Ai.prototype.digest = function () {
		...
		for (var c = 63; 56 <= c; c--) ((this.Te[c] = b & 255), (b /= 256))
		Ei(this)
		for (c = b = 0; c < this.Bl; c++) for (var d = 24; 0 <= d; d -= 8) a[b++] = (this.na[c] >> d) & 255
		return a
	}
	var zi = [
	...
	Hi.prototype.Ic = function () {
		this.Cb || ((this.Cb = !0), this.Xd())
	}
	Hi.prototype.Xd = function () {
		if (this.Bf) for (; this.Bf.length; ) this.Bf.shift()()
	}
	var Ii = function (a, b) {
		this.type = a
	...
	v(Ki, Ii)
	var Li = Va({2: 'touch', 3: 'pen', 4: 'mouse'})
	Ki.prototype.init = function (a, b) {
		...
		d
			...
			: ((this.offsetX = Cc || void 0 !== a.offsetX ? a.offsetX : a.layerX),
	...
	Qi.prototype.add = function (a, b, c, d, e) {
		var f = a.toString()
		a = this.Qa[f]
		a || ((a = this.Qa[f] = []), this.Ie++)
		var g = Ri(a, b, d, e)
		;-1 < g ? ((b = a[g]), c || (b.Pe = !1)) : ((b = new Oi(b, this.src, f, !!d, e)), (b.Pe = c), a.push(b))
		return b
	}
	Qi.prototype.remove = function (a, b, c, d) {
		...
		var e = this.Qa[a]
		b = Ri(e, b, c, d)
		return -1 < b ? (Pi(e[b]), Ra(e, b), 0 == e.length && (delete this.Qa[a], this.Ie--), !0) : !1
	}
	var Si = function (a, b) {
		var c = b.type
		c in a.Qa && Qa(a.Qa[c], b) && (Pi(b), 0 == a.Qa[c].length && (delete a.Qa[c], a.Ie--))
	}
	Qi.prototype.removeAll = function (a) {
		...
		for (c in this.Qa)
			if (!a || c == a) {
				for (var d = this.Qa[c], e = 0; e < d.length; e++) (++b, Pi(d[e]))
				delete this.Qa[c]
				this.Ie--
			}
		return b
	...
	var Ri = function (a, b, c, d) {
		for (var e = 0; e < a.length; ++e) {
			var f = a[e]
			if (!f.ze && f.listener == b && f.capture == !!c && f.ef == d) return e
		}
		return -1
	}
	var Ti = 'closure_lm_' + ((1e6 * Math.random()) | 0),
		...
		Xi = function (a, b, c, d, e) {
			if (d && d.once) Wi(a, b, c, d, e)
			else if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Xi(a, b[f], c, d, e)
			else ((c = Yi(c)), a && a[Mi] ? a.listen(b, c, t(d) ? !!d.capture : !!d, e) : Zi(a, b, c, !1, d, e))
		},
		...
		Wi = function (a, b, c, d, e) {
			if (Array.isArray(b)) for (var f = 0; f < b.length; f++) Wi(a, b[f], c, d, e)
			else ((c = Yi(c)), a && a[Mi] ? dj(a, b, c, t(d) ? !!d.capture : !!d, e) : Zi(a, b, c, !0, d, e))
		},
		ej = function (a, b, c, d, e) {
			if (Array.isArray(b)) for (var f = 0; f < b.length; f++) ej(a, b[f], c, d, e)
			else ((d = t(d) ? !!d.capture : !!d), (c = Yi(c)), a && a[Mi] ? a.Eb.remove(String(b), c, d, e) : a && (a = $i(a)) && (b = a.Gg(b, c, d, e)) && fj(b))
		},
		fj = function (a) {
			if ('number' !== typeof a && a && !a.ze) {
				...
				if (b && b[Mi]) Si(b.Eb, a)
					...
					Vi--
					;(c = $i(b)) ? (Si(c, a), 0 == c.Ie && ((c.src = null), (b[Ti] = null))) : Pi(a)
				}
			}
		},
		bj = function (a) {
	...
	k.dispatchEvent = function (a) {
		...
		if (b) {
			var c = []
			for (var d = 1; b; b = b.dh) (c.push(b), w(1e3 > ++d, 'infinite loop'))
		}
		b = this.jk
		d = a.type || a
		if ('string' === typeof a) a = new Ii(a, b)
		else if (a instanceof Ii) a.target = a.target || b
		else {
			var e = a
			a = new Ii(d, b)
			ab(a, e)
		...
		a.ve || ((g = a.currentTarget = b), (e = jj(g, d, !0, a) && e), a.ve || (e = jj(g, d, !1, a) && e))
		if (c) for (f = 0; !a.ve && f < c.length; f++) ((g = a.currentTarget = c[f]), (e = jj(g, d, !1, a) && e))
		return e
	}
	k.Xd = function () {
		hj.Kd.Xd.call(this)
	...
	var nj = function (a) {
		if (!a.Mi && 'undefined' == typeof XMLHttpRequest && 'undefined' != typeof ActiveXObject) {
			for (var b = ['MSXML2.XMLHTTP.6.0', 'MSXML2.XMLHTTP.3.0', 'MSXML2.XMLHTTP', 'Microsoft.XMLHTTP'], c = 0; c < b.length; c++) {
				var d = b[c]
				try {
					return (new ActiveXObject(d), (a.Mi = d))
				} catch (e) {}
			}
	...
	oj.prototype.Ud = function () {
		...
		if ('undefined' != typeof XDomainRequest) return new pj()
	...
	sj.prototype.send = function (a) {
		...
		this.Sb = !0
		var b = {headers: this.xh, method: this.cj, credentials: this.Hc, cache: this.ad}
		a && (b.body = a)
	...
	sj.prototype.abort = function () {
		...
		this.status = 0
		this.Vd &&
			this.Vd.cancel('Request was aborted.').catch(function () {
				var b = a.Ea
				b && pc(b, cc, 'Fetch reader cancellation error.')
			})
		1 <= this.readyState && this.Sb && 4 != this.readyState && ((this.Sb = !1), uj(this))
		this.readyState = 0
	}
	sj.prototype.Zk = function (a) {
		if (
			this.Sb &&
			((this.Xe = a),
			this.Hd || ((this.status = this.Xe.status), (this.statusText = this.Xe.statusText), (this.Hd = a.headers), (this.readyState = 2), tj(this)),
			this.Sb && ((this.readyState = 3), tj(this), this.Sb))
		)
			if ('arraybuffer' === this.responseType) a.arrayBuffer().then(this.Xk.bind(this), this.df.bind(this))
			else if ('undefined' !== typeof p.ReadableStream && 'body' in a) {
				this.Vd = a.body.getReader()
				if (this.De) {
					if (this.responseType) throw Error('responseType must be empty for "streamBinaryChunks" mode responses.')
					this.response = []
				} else ((this.response = this.responseText = ''), (this.Oh = new TextDecoder()))
				vj(this)
			} else a.text().then(this.Yk.bind(this), this.df.bind(this))
	}
	var vj = function (a) {
	...
	sj.prototype.Sk = function (a) {
		if (this.Sb) {
			if (this.De && a.value) this.response.push(a.value)
			else if (!this.De) {
				var b = a.value ? a.value : new Uint8Array(0)
				if ((b = this.Oh.decode(b, {stream: !a.done}))) this.response = this.responseText += b
			}
	...
	sj.prototype.Yk = function (a) {
		this.Sb && ((this.response = this.responseText = a), uj(this))
	}
	sj.prototype.Xk = function (a) {
		this.Sb && ((this.response = a), uj(this))
	}
	...
	k.getResponseHeader = function (a) {
		return this.Hd
			? this.Hd.get(a.toLowerCase()) || ''
			: ((a = this.Ea) && pc(a, cc, 'Attempting to get response header but no headers have been received for url: ' + this.hb), '')
	}
	k.getAllResponseHeaders = function () {
		...
		a = []
		for (var b = this.Hd.entries(), c = b.next(); !c.done; ) ((c = c.value), a.push(c[0] + ': ' + c[1]), (c = b.next()))
		return a.join('\r\n')
	}
	k.Ch = function (a) {
		this.Hc = a
...
*/
	...
	xj.prototype.cancel = function (a) {
		if (this.od) this.Ua instanceof xj && this.Ua.cancel()
		else {
			if (this.Ha) {
				var b = this.Ha
				delete this.Ha
				a ? b.cancel(a) : (b.mg--, 0 >= b.mg && b.cancel())
			}
	...
	var Ij = function (a) {
		...
		Bj = function (a) {
			if (a.Wf && a.od && Ij(a)) {
				var b = a.Wf,
					c = Jj[b]
				c && (p.clearTimeout(c.Pa), delete Jj[b])
				a.Wf = 0
			}
			a.Ha && (a.Ha.mg--, delete a.Ha)
			b = a.Ua
			for (var d = (c = !1); a.Qf.length && !a.lg; ) {
				...
				if ((f = a.fe ? g : f))
					try {
						...
						h === Hj && (h = void 0)
						void 0 !== h && ((a.fe = a.fe && (h == b || h instanceof Error)), (a.Ua = b = h))
						if (Vf(b) || ('function' === typeof p.Promise && b instanceof p.Promise)) ((d = !0), (a.lg = !0))
					} catch (l) {
						;((b = l), (a.fe = !0), Ij(a) || (c = !0))
					}
			}
			a.Ua = b
			d && ((h = u(a.fi, a, !0)), (d = u(a.fi, a, !1)), b instanceof xj ? (Fj(b, h, d), (b.Xh = !0)) : b.then(h, d))
			c && ((b = new Kj(b)), (Jj[b.Pa] = b), (a.Wf = b.Pa))
		},
		Cj = function () {
			Aa.call(this)
		}
	...
	var Pj = function (a) {
			...
			e.onload = e.onreadystatechange = function () {
				;(e.readyState && 'loaded' != e.readyState && 'complete' != e.readyState) || (Mj(e, b.Nm || !1, h), g.callback(null))
			}
			e.onerror = function () {
				Mj(e, !0, h)
	...
	Uj.prototype.send = function (a, b, c, d) {
		if (this.u) throw Error('[goog.net.XhrIo] Object is active with another request=' + this.vf + '; newUri=' + a)
		...
		try {
			;(rc(this.Ea, Xj(this, 'Opening Xhr')), (this.Mg = !0), this.u.open(b, String(a), !0), (this.Mg = !1))
		} catch (g) {
		...
		try {
			;(Yj(this),
				0 < this.Ld &&
					...
					this.Xf ? ((this.u.timeout = this.Ld), (this.u.ontimeout = u(this.Ge, this))) : (this.Uf = Qj(this.Ge, this.Ld, this))),
				rc(this.Ea, Xj(this, 'Sending request')),
				(this.nf = !0),
				this.u.send(a),
				(this.nf = !1))
		} catch (g) {
			;(rc(this.Ea, Xj(this, 'Send error: ' + g.message)), this.yb(5, g))
		}
	}
	var Zj = function (a) {
	...
	Uj.prototype.Ge = function () {
		'undefined' != typeof sa && this.u && ((this.ke = 'Timed out after ' + this.Ld + 'ms, aborting'), rc(this.Ea, Xj(this, this.ke)), this.dispatchEvent('timeout'), this.abort(8))
	}
	Uj.prototype.yb = function (a, b) {
		this.kc = !1
		this.u && ((this.Oc = !0), this.u.abort(), (this.Oc = !1))
		this.ke = b
		ak(this)
		bk(this)
	}
	var ak = function (a) {
		a.Ag || ((a.Ag = !0), a.dispatchEvent('complete'), a.dispatchEvent('error'))
	}
	Uj.prototype.abort = function () {
		this.u &&
			this.kc &&
			(rc(this.Ea, Xj(this, 'Aborting')), (this.kc = !1), (this.Oc = !0), this.u.abort(), (this.Oc = !1), this.dispatchEvent('complete'), this.dispatchEvent('abort'), bk(this))
	}
	Uj.prototype.Xd = function () {
		this.u && (this.kc && ((this.kc = !1), (this.Oc = !0), this.u.abort(), (this.Oc = !1)), bk(this, !0))
		Uj.Kd.Xd.call(this)
	}
	...
	var ck = function (a) {
		if (a.kc && 'undefined' != typeof sa)
			if (a.ag[1] && 4 == dk(a) && 2 == a.getStatus()) rc(a.Ea, Xj(a, 'Local request error detected and ignored'))
			else if (a.nf && 4 == dk(a)) Qj(a.oj, 0, a)
				...
				try {
					...
					if (d) (a.dispatchEvent('complete'), a.dispatchEvent('success'))
						...
						try {
							...
							;(rc(a.Ea, 'Can not get status: ' + h.message), (g = ''))
						}
						a.ke = g + ' [' + a.getStatus() + ']'
						ak(a)
					}
	...
	var ek = function (a, b) {
		...
		Yj = function (a) {
			...
			a.Uf && (p.clearTimeout(a.Uf), (a.Uf = null))
		}
	...
	Uj.prototype.getResponse = function () {
		try {
			...
			return (rc(this.Ea, 'Can not get response: ' + a.message), null)
		}
	}
	Uj.prototype.getResponseHeader = function (a) {
		if (this.u && 4 == dk(this)) return ((a = this.u.getResponseHeader(a)), null === a ? void 0 : a)
	}
	...
	var fk = function (a) {
		...
		hk = function (a, b, c) {
			...
			else for (var d = gk(a), e = fk(a), f = e.length, g = 0; g < f; g++) b.call(c, e[g], d && d[g], a)
		}
	var ik = function (a) {
		...
		if (a instanceof ik) {
			...
			a && (b = String(a).match(Sj))
				? ((this.Ab = !1),
					...
					kk(this),
					(this.Lc = ok(a)))
				: ((this.Ab = !1), (this.rb = new pk(null, this.Ab)))
	}
	ik.prototype.toString = function () {
		...
		if ((c = this.getPath())) (this.Ga && '/' != c.charAt(0) && a.push('/'), a.push(qk(c, '/' == c.charAt(0) ? sk : tk, !0)))
	...
	var nk = function (a, b, c) {
		kk(a)
		b instanceof pk ? ((a.rb = b), a.rb.Eh(a.Ab)) : (c || (b = qk(b, vk)), (a.rb = new pk(b, a.Ab)))
	}
	...
	var M = function (a) {
		...
		qk = function (a, b, c) {
			return 'string' === typeof a ? ((a = encodeURI(a).replace(b, yk)), c && (a = a.replace(/%25([0-9a-fA-F]{2})/g, '%$1')), a) : null
		},
		yk = function (a) {
			a = a.charCodeAt(0)
	...
	pk.prototype.remove = function (a) {
		zk(this)
		a = this.nb(a)
		return this.qa.has(a) ? ((this.mb = null), (this.Na = Ha(this.Na) - this.qa.get(a).length), this.qa.delete(a)) : !1
	}
	...
	k.Fg = function () {
		zk(this)
		for (var a = Array.from(this.qa.values()), b = Array.from(this.qa.keys()), c = [], d = 0; d < b.length; d++) for (var e = a[d], f = 0; f < e.length; f++) c.push(b[d])
		return c
	}
	k.Nc = function (a) {
		zk(this)
		var b = []
		if ('string' === typeof a) Bk(this, a) && (b = b.concat(this.qa.get(this.nb(a))))
		else {
	...
	k.setValues = function (a, b) {
		this.remove(a)
		0 < b.length && ((this.mb = null), this.qa.set(this.nb(a), Ta(b)), (this.Na = Ha(this.Na) + b.length))
	}
	k.toString = function () {
	...
	var Ck = {
		...
		Dk = function (a) {
			for (var b in Ck) if (Ck[b].id === a) return ((a = Ck[b]), {firebaseEndpoint: a.Ye, secureTokenEndpoint: a.Nf, identityPlatformEndpoint: a.jf})
			return null
		},
		Ek
	...
	var angular,
		...
		Ok = function (a, b, c) {
			...
			'Firefox' == Kk(Fk()) && ((a = a || 'http://localhost'), (b.scrollbars = !0))
			e = a || ''
			b || (b = {})
			a = window
			...
			var h = f.join(',')
			;(vc() || A('iPad') || A('iPod')) && a.navigator && a.navigator.standalone && e && '_self' != e
				? ((h = ad(document, 'A')),
					Rc(h, d),
					(h.target = e),
					c && (h.rel = 'noreferrer'),
				...
				: c
					? ((h = Uc('', a, e, h)),
						...
						h &&
							...
							(d = h.document) && d.write && (d.write(Zb(a)), d.close())))
					: ((h = Uc(d, a, e, h)) && b.noopener && (h.opener = null), h && b.noreferrer && (h.opener = null))
			if (h)
				try {
					h.focus()
				} catch (l) {}
		...
		bl = {DEFAULT: 'FirebaseCore-web', Fm: 'FirebaseUI-web', Im: 'gcip-iap'},
		cl = function (a, b, c) {
			c = c || []
			var d = [],
				e = {},
				f
			for (f in bl) e[bl[f]] = !0
		...
		el = function () {
			try {
				var a = p.localStorage,
					b = dl()
				if (a) return (a.setItem(b, '1'), a.removeItem(b), Gk() ? !!p.indexedDB : !0)
			} catch (c) {
	...
	nl.prototype.get = function () {
		var a = p.navigator
		return (a && 'boolean' === typeof a.onLine && (fl() || 'chrome-extension:' === Wk() || 'undefined' !== typeof a.connection) ? a.onLine : 1)
			? this.tl
				? this.zl
				: this.Nj
	...
	var ol = function () {
		...
		pl = function () {
			...
			return ol() || !a
				...
				: new E(function (c) {
						b = function () {
							ol() && (a.removeEventListener('visibilitychange', b, !1), c())
						}
	...
	try {
		var yl = {}
		Object.defineProperty(yl, 'abcd', {configurable: !0, enumerable: !0, value: 1})
		Object.defineProperty(yl, 'abcd', {configurable: !0, enumerable: !0, value: 2})
		xl = 2 == yl.abcd
	} catch (a) {
		xl = !1
	}
	var O = function (a, b, c) {
			xl ? Object.defineProperty(a, b, {configurable: !0, enumerable: !0, value: c}) : (a[b] = c)
		},
		zl = function (a, b) {
	...
	var Dl = 'oauth_consumer_key oauth_nonce oauth_signature oauth_signature_method oauth_timestamp oauth_token oauth_version'.split(' '),
		...
		Fl = {
			Em: {je: 'locale', Bd: 700, Ad: 600, providerId: 'facebook.com', If: El},
			Gm: {je: null, Bd: 500, Ad: 750, providerId: 'github.com', If: El},
			Hm: {je: 'hl', Bd: 515, Ad: 680, providerId: 'google.com', If: El},
			Mm: {je: 'lang', Bd: 485, Ad: 705, providerId: 'twitter.com', If: Dl},
			Cm: {je: 'locale', Bd: 640, Ad: 600, providerId: 'apple.com', If: []}
		},
		Gl = function (a) {
			for (var b in Fl) if (Fl[b].providerId == a) return Fl[b]
			return null
		}
	var P = function (a, b, c) {
		this.code = 'auth/' + a
	...
	var Jl = function (a, b, c, d, e, f, g) {
		...
		this.yb = e || null
		if (this.Nd || this.yb) {
			if (this.Nd && this.yb) throw new P('invalid-auth-event')
			if (this.Nd && !this.Ae) throw new P('invalid-auth-event')
	...
	k.T = function () {
		return {type: this.Qh, eventId: this.Ja, urlResponse: this.Nd, sessionId: this.Ae, postBody: this.jh, tenantId: this.ma, error: this.yb && this.yb.T()}
	}
	var Kl = function (a) {
		a = a || {}
	...
	var Ol = function (a) {
			try {
				if (a.phoneInfo) return new Ml(a)
				if (a.totpInfo) return new Nl(a)
			} catch (b) {}
			return null
		},
		Ml = function (a) {
	...
	var Rl = function (a) {
			...
			zl(this, {apiKey: b, operation: d, code: c, continueUrl: wk(a, 'continueUrl') || null, languageCode: wk(a, 'languageCode') || null, tenantId: wk(a, 'tenantId') || null})
		},
		Sl = function (a) {
			try {
				return new Rl(a)
	...
	Zl.prototype.T = function () {
		return 'enroll' == this.type ? {multiFactorSession: {idToken: this.hf}} : {multiFactorSession: {pendingCredential: this.dj}}
	}
	var $l = function () {}
	...
	k.T = function () {
		return {providerId: this.providerId, signInMethod: this.signInMethod, pendingToken: this.Xb}
	}
	var fm = function (a) {
	...
	k.Qc = function () {
		...
		a = {postBody: Ak(a).toString(), requestUri: 'http://localhost'}
	...
	var hm = function (a) {
		...
		im = function (a, b) {
			this.Rl = b || []
			zl(this, {providerId: a, isOAuthProvider: !0})
			this.ki = {}
	...
	km.prototype.credential = function (a, b) {
		a = t(a) ? {idToken: a.idToken || null, accessToken: a.accessToken || null, nonce: a.rawNonce || null} : {idToken: a || null, accessToken: b || null}
	...
	var mm = function (a) {
			...
			var b = a
			t(a) && (b = a.accessToken)
			return new lm().credential({accessToken: b})
		},
		nm = function () {
	...
	var om = function (a) {
			...
			var b = a
			t(a) && (b = a.accessToken)
			return new nm().credential({accessToken: b})
		},
		pm = function () {
	...
	var qm = function (a, b) {
			...
			return new pm().credential({idToken: c, accessToken: b})
		},
		rm = function () {
	...
	um.prototype.Mc = function (a) {
		return this.signInMethod == tm.EMAIL_LINK_SIGN_IN_METHOD ? Q(a, vm, {email: this.Jc, oobCode: this.ne}) : Q(a, wm, {email: this.Jc, password: this.ne})
	}
	um.prototype.wd = function (a, b) {
		return this.signInMethod == tm.EMAIL_LINK_SIGN_IN_METHOD ? Q(a, xm, {idToken: b, email: this.Jc, oobCode: this.ne}) : Q(a, ym, {idToken: b, email: this.Jc, password: this.ne})
	}
	um.prototype.me = function (a, b) {
		return am(this.Mc(a), b)
	}
	um.prototype.T = function () {
		return {email: this.Jc, password: this.ne, signInMethod: this.signInMethod}
	}
	var zm = function (a) {
			return a && a.email && a.password ? new um(a.email, a.password, a.signInMethod) : null
		},
		tm = function () {
			zl(this, {providerId: 'password', isOAuthProvider: !1})
		},
		Bm = function (a, b) {
			b = Am(b)
	...
	zl(tm, {PROVIDER_ID: 'password'})
	zl(tm, {EMAIL_LINK_SIGN_IN_METHOD: 'emailLink'})
	zl(tm, {EMAIL_PASSWORD_SIGN_IN_METHOD: 'password'})
	var Cm = function (a) {
		if (!((a.verificationId && a.Yf) || (a.Fe && a.phoneNumber))) throw new P('internal-error')
		this.wa = a
	...
	var Gm = function (a) {
		...
		Dm = function (a) {
			return a.wa.Fe && a.wa.phoneNumber ? {temporaryProof: a.wa.Fe, phoneNumber: a.wa.phoneNumber} : {sessionInfo: a.wa.verificationId, code: a.wa.Yf}
		},
		Hm = function (a) {
			try {
			...
			zl(this, {providerId: 'phone', isOAuthProvider: !1})
		}
		...
		return F(b.verify()).then(function (d) {
			...
			switch (b.type) {
				case 'recaptcha':
					...
					return (
						e && 'enroll' == e.type
							? e.be().then(function (g) {
									return Im(c, {idToken: g, phoneEnrollmentInfo: {phoneNumber: f, recaptchaToken: d}})
								})
							: e && 'signin' == e.type
								? e.be().then(function (g) {
										return Jm(c, {mfaPendingCredential: g, mfaEnrollmentId: (a.multiFactorHint && a.multiFactorHint.uid) || a.multiFactorUid, phoneSignInInfo: {recaptchaToken: d}})
									})
								: Km(c, {phoneNumber: f, recaptchaToken: d})
					).then(
						function (g) {
	...
	var Lm = function (a, b) {
		...
		return new Cm({verificationId: a, Yf: b})
	}
	zl(Hm, {PROVIDER_ID: 'phone'})
	zl(Hm, {PHONE_SIGN_IN_METHOD: 'phone'})
	var Mm = function (a) {
			if (a.temporaryProof && a.phoneNumber) return new Cm({Fe: a.temporaryProof, phoneNumber: a.phoneNumber})
					...
					default:
						return c || d || f || g
							? g
								? 0 == b.indexOf('saml.')
									? new bm(b, g)
									: new gm(b, {pendingToken: g, idToken: a.oauthIdToken, accessToken: a.oauthAccessToken}, b)
								: new km(b).credential({idToken: f, accessToken: c, rawNonce: e})
							: null
				}
			} catch (h) {
				return null
	...
	var Pm = function (a) {
		if (a.code) {
			...
			var c = {credential: Mm(a), tenantId: a.tenantId}
	...
	var Vm = function (a, b, c) {
			...
			c && ((this.nd['X-Client-Version'] = c), (this.Of['X-Client-Version'] = c))
			a = 'Node' == Zk()
			a = p.XMLHttpRequest || (a && firebase.INTERNAL.node && firebase.INTERNAL.node.XMLHttpRequest)
			if (!a && !Yk()) throw new P('internal-error', 'The XMLHttpRequest compatibility library was not found.')
			this.Mf = void 0
			Yk() ? (this.Mf = new rj({Am: self})) : $k() ? (this.Mf = new Qm(a)) : (this.Mf = new oj())
			this.ma = null
		},
		Wm,
		Xm = function (a, b) {
		...
		Zm = function (a, b) {
			b &&
				((a.Ej = Ym('https://securetoken.googleapis.com/v1/token', b)),
		...
		$m = function (a, b) {
			b ? ((a.nd['X-Client-Version'] = b), (a.Of['X-Client-Version'] = b)) : (delete a.nd['X-Client-Version'], delete a.Of['X-Client-Version'])
		},
		bn = function (a, b, c, d, e, f, g) {
			Lk() || Yk()
				? (a = u(a.km, a))
				: (Wm ||
						(Wm = new E(function (h, l) {
							an(h, l)
						})),
					(a = u(a.jm, a)))
			a(b, c, d, e, f, g)
		...
		g.listen('complete', function () {
			...
			try {
				...
				try {
					...
					;(rc(this.Ea, 'Can not get responseText: ' + B.message), (y = ''))
				}
				l = q.call(m, y) || null
			} catch (B) {
				l = null
	...
	var fn = function (a, b) {
		...
		hn = function (a) {
			a = a.email
			if ('string' !== typeof a || !Sk.test(a)) throw new P('invalid-email')
		},
		jn = function (a) {
			'email' in a && hn(a)
		},
		ln = function (a, b) {
			return Q(a, kn, {identifier: b, continueUri: fl() ? Hk() : 'http://localhost'}).then(function (c) {
	...
	k.updateEmail = function (a, b) {
		return Q(this, rn, {idToken: a, email: b})
	}
	k.updatePassword = function (a, b) {
		return Q(this, ym, {idToken: a, password: b})
	}
	...
	var Im = function (a, b) {
		...
		Dn = function (a, b, c) {
			return Q(a, Cn, {idToken: b, deleteProvider: c})
		},
		En = function (a) {
		...
		Fn = function (a, b) {
			b.oauthIdToken &&
				...
				!b.pendingToken &&
				(a.sessionId ? (b.nonce = a.sessionId) : a.postBody && ((a = new pk(a.postBody)), Bk(a, 'nonce') && (b.nonce = a.get('nonce'))))
			return b
		},
		Hn = function (a) {
			var b = null
			a.needConfirmation
				? ((a.code = 'account-exists-with-different-credential'), (b = Pm(a)))
				: 'FEDERATED_USER_ID_ALREADY_LINKED' == a.errorMessage
					? ((a.code = 'credential-already-in-use'), (b = Pm(a)))
					: 'EMAIL_EXISTS' == a.errorMessage
						? ((a.code = 'email-already-in-use'), (b = Pm(a)))
						: a.errorMessage && (b = Gn(a.errorMessage))
			if (b) throw b
			on(a)
		},
		cm = function (a, b) {
	...
	Vm.prototype.confirmPasswordReset = function (a, b) {
		return Q(this, Mn, {oobCode: a, newPassword: b})
	}
	Vm.prototype.checkActionCode = function (a) {
		return Q(this, Nn, {oobCode: a})
	}
	Vm.prototype.applyActionCode = function (a) {
		return Q(this, On, {oobCode: a})
	}
	var Q = function (a, b, c) {
			if (!Bl(c, b.Ma)) return G(new P('internal-error'))
			var d = !!b.Je,
				e = b.httpMethod || 'POST',
				f
			return F(c)
		...
		Gn = function (a) {
			return en({error: {errors: [{message: a}], code: 400, reason: a}})
		},
		en = function (a, b) {
		...
		Rm = new nl(3e4, 6e4),
		Sm = {'Content-Type': 'application/x-www-form-urlencoded'},
		Tm = new nl(3e4, 6e4),
		Um = {'Content-Type': 'application/json'},
		dn = new lb(jb, 'https://apis.google.com/js/client.js?onload=%{onload}'),
		cn = '__fcb' + Math.floor(1e6 * Math.random()).toString(),
		sn = {displayName: 'DISPLAY_NAME', photoUrl: 'PHOTO_URL'},
		On = {endpoint: 'setAccountInfo', oa: Ln, Zb: 'email', ta: !0},
		Nn = {
		...
		kn = {endpoint: 'createAuthUri', ta: !0},
		Qn = {endpoint: 'deleteAccount', Ma: ['idToken']},
		Cn = {
		...
		vm = {endpoint: 'emailLinkSignin', Ma: ['email', 'oobCode'], oa: hn, Aa: on, Mb: !0, ta: !0},
		xm = {endpoint: 'emailLinkSignin', Ma: ['idToken', 'email', 'oobCode'], oa: hn, Aa: on, Mb: !0},
		Rn = {endpoint: 'accounts/mfaEnrollment:finalize', Ma: ['idToken', 'phoneVerificationInfo'], oa: An, Aa: on, ta: !0, Je: !0},
		Sn = {endpoint: 'accounts/mfaSignIn:finalize', Ma: ['mfaPendingCredential', 'phoneVerificationInfo'], oa: An, Aa: on, ta: !0, Je: !0},
		Tn = {endpoint: 'getAccountInfo'},
		un = {
		...
		mn = {og: !0, endpoint: 'getProjectConfig', httpMethod: 'GET'},
		Un = {
			og: !0,
		...
		Mn = {endpoint: 'resetPassword', oa: Ln, Zb: 'email', ta: !0},
		xn = {endpoint: 'sendVerificationCode', Ma: ['phoneNumber', 'recaptchaToken'], Zb: 'sessionInfo', ta: !0},
		rn = {endpoint: 'setAccountInfo', Ma: ['idToken'], oa: jn, Mb: !0},
		ym = {
			endpoint: 'setAccountInfo',
			Ma: ['idToken'],
			oa: function (a) {
		...
		qn = {endpoint: 'signupNewUser', Aa: on, Mb: !0, ta: !0},
		zn = {
		...
		In = {endpoint: 'verifyAssertion', oa: En, Jf: Fn, Aa: Hn, Mb: !0, ta: !0},
		Kn = {
			...
			Aa: function (a) {
				...
				if (a.errorMessage) throw Gn(a.errorMessage)
				on(a)
			},
			Mb: !0,
			ta: !0
		...
		yn = {endpoint: 'verifyPhoneNumber', oa: pn, Aa: on, ta: !0},
		Em = {
			...
			Aa: function (a) {
				if (a.temporaryProof) throw ((a.code = 'credential-already-in-use'), Pm(a))
				on(a)
			}
		},
		Fm = {ji: {USER_NOT_FOUND: 'user-not-found'}, endpoint: 'verifyPhoneNumber', oa: pn, Aa: on, ta: !0},
		Wn = {
	...
	var eo = function (a, b, c, d) {
		...
		this.N = d
		this.Yc = null
		this.N ? ((a = M(this.N.url)), (a = xk(a.Va, a.Ga, a.Tb, '/emulator/auth/iframe'))) : (a = xk('https', this.ya, null, '/__/auth/iframe'))
		this.hc = a
	...
	fo.prototype.toString = function () {
		...
		} else a = xk('https', this.ya, null, '/__/auth/handler')
		L(a, 'apiKey', this.ha)
		L(a, 'appName', this.ka)
		...
		'function' === typeof this.Dd.Di && ((c = this.Dd.Di()), c.length && L(a, 'scopes', c.join(',')))
		...
		if (this.Me) for (var g in this.Me) this.Me.hasOwnProperty(g) && !wk(a, g) && L(a, g, this.Me[g])
	...
	var ko = function (a) {
		a.o || ((a.Ai = a.Gc ? cl('JsCore', a.Gc, go(a.ka)) : null), (a.o = new Vm(a.ha, Dk(a.Ia), a.Ai)), a.N && Zm(a.o, a.N))
		return a.o
	}
	...
	ho.prototype.uh = function () {
		if (!this.lf) throw Error('IfcHandler must be initialized!')
		var a = this
	...
	var zo = function (a, b, c, d, e, f, g) {
		...
		this.ei = b
		this.ee = null
		g ? (yo || (yo = new xo()), (g = yo)) : (qo || (qo = new no()), (g = qo))
		this.zj = g
		this.vc = c || {theme: 'light', type: 'image'}
		this.Ka = []
		if (this.vc.sitekey) throw new P('argument-error', 'sitekey should not be provided for reCAPTCHA as one is automatically provisioned for the current project.')
		...
		if (!Wc(b) || (!this.tf && Wc(b).hasChildNodes())) throw new P('argument-error', 'reCAPTCHA container is either not found or already contains inner elements!')
	...
	Eo.prototype.send = function (a, b, c) {
		...
		var f,
			...
			h,
			l = null
		if (this.di) return G(Error('connection_unavailable'))
		var m = c ? 800 : 50,
					...
					(f = function (S) {
						S.data.eventId === e &&
							('ack' === S.data.status
								...
								: 'done' === S.data.status
									? (clearTimeout(h), 'undefined' !== typeof S.data.response ? y(S.data.response) : B(Error('unknown_error')))
									: (clearTimeout(g), clearTimeout(h), B(Error('invalid_response'))))
					}),
	...
	Eo.prototype.close = function () {
		for (; 0 < this.xf.length; ) Fo(this, this.xf[0])
		this.di = !0
	}
	var Go = function (a) {
			this.Bg = a
	...
	Go.prototype.Tk = function (a) {
		...
		if (d && 0 < d.length) {
			...
			dg(e).then(function (f) {
				var g = []
				x(f, function (h) {
					g.push({fulfilled: h.zi, value: h.value, reason: h.reason ? h.reason.message : void 0})
				})
				x(g, function (h) {
	...
	var Jo = function (a) {
		...
		if (!this.tb) throw new P('internal-error', 'The React Native compatibility library was not found.')
	...
	var No = function () {
			if (!Lo()) {
				if ('Node' == Zk()) throw new P('internal-error', 'The LocalStorage compatibility library was not found.')
	...
	var Ro = function () {
			if (!Po()) {
				if ('Node' == Zk()) throw new P('internal-error', 'The SessionStorage compatibility library was not found.')
				throw new P('web-storage-unsupported')
			}
	...
	k.Bc = function () {}
	var Uo = function () {
			if (!So()) throw new P('web-storage-unsupported')
				...
				? ((this.wc = Io(Yk() ? self : null)),
					this.wc.subscribe('keyChanged', function (b, c) {
						return To(a).then(function (d) {
							...
							return {keyProcessed: Pa(d, c.key)}
						})
					}),
		...
		Xo = function (a) {
			return new E(function (b, c) {
				...
				d.onupgradeneeded = function (e) {
					e = e.target.result
					try {
						e.createObjectStore(a.zf, {keyPath: a.wg})
					} catch (f) {
						c(f)
					}
				}
				d.onsuccess = function (e) {
					e = e.target.result
					e.objectStoreNames.contains(a.zf)
						? b(e)
						: Wo(a)
								.then(function () {
									return Xo(a)
		...
		return Zo(this, function (e) {
			...
			.then(function (e) {
				return Zo(c, function (f) {
					f = $o(c, ap(c, f, !0))
					if (e) return ((e.value = b), bp(f.put(e)))
					c.oe++
					d = !0
					var g = {}
					g[c.wg] = a
	...
	var cp = function (a, b) {
		return a.Pf && a.eg && tl() === a.eg
			? a.Pf.send('keyChanged', {key: b}, a.Gj)
					.then(function () {})
					.l(function () {})
			: F()
	}
		...
		return Yo(a)
			...
			.then(function (b) {
				var c = {},
					d = []
				if (0 == a.oe) {
					for (d = 0; d < b.length; d++) c[b[d][a.wg]] = b[d][a.Zj]
					d = Jk(a.Ra, c)
					a.Ra = c
				}
				return d
	...
	Uo.prototype.Sf = function () {
		...
		this.Gf && (clearTimeout(this.Gf), (this.Gf = null))
	}
	function dp(a) {
		var b = this,
			c = null
	...
	var ip = function () {
			this.zg = {Browser: ep, Node: fp, ReactNative: gp, Worker: hp}[Zk()]
		},
		jp,
		ep = {ua: No, Tf: Ro},
		fp = {ua: No, Tf: Ro},
	...
	lp.prototype.Pg = function (a) {
		...
		if ((b = a.iOS) && 'object' === typeof b)
			if (((b = b.bundleId), 'string' === typeof b && b.length)) this.Ki = b
			else {
	...
	var mp = function (a) {
		...
		if ((b.androidPackageName = a.hg)) ((b.androidMinimumVersion = a.Uh), (b.androidInstallApp = a.Qi))
		b.iOSBundleId = a.Ki
	...
	var pp = function (a, b, c) {
		...
		this.zd = null
		this.Rc = this.wf
		if (this.Th < this.wf) throw Error('Proactive refresh lower bound greater than upper bound!')
	}
	...
	pp.prototype.stop = function () {
		this.zd && (this.zd.cancel(), (this.zd = null))
	}
	var yp = function (a) {
			var b = {}
			b['facebook.com'] = sp
			...
			try {
				if (c) return b[c] ? new b[c](a) : new wp(a)
				if ('undefined' !== typeof a.idToken) return new xp(a)
			} catch (d) {}
			return null
		},
		xp = function (a) {
	...
	n(vp, wp)
	var zp = {LOCAL: 'local', NONE: 'none', SESSION: 'session'},
		Ap = function (a) {
			...
			switch (Zk()) {
				...
				case 'Node':
					...
					break
				case 'Worker':
					if ('session' === a || (!So() && 'none' !== a)) throw c
					break
				default:
					if (!el() && 'none' !== a) throw c
			}
		},
		Bp = function () {
			var a = !ll(Fk()) && Xk() ? !0 : !1,
			...
			a.Ug = setInterval(function () {
				for (var b in a.Za) {
					var c = p.localStorage.getItem(b),
						d = a.Ra[b]
					c != d && ((a.Ra[b] = c), (c = new Ki({type: 'storage', key: b, target: window, oldValue: d, newValue: c, fh: !0})), a.Qj(c))
				}
			}, 1e3)
		},
		Hp = function (a) {
		...
		if (a && a.Nk) {
			...
			if (null == b)
				...
				if (this.em)
					...
					else if (this.Ra[b] === d && 'undefined' === typeof a.Ya.fh) return
				var f = this
				c = function () {
					if ('undefined' !== typeof a.Ya.fh || f.Ra[b] !== p.localStorage.getItem(b)) ((f.Ra[b] = p.localStorage.getItem(b)), f.qg(b))
				}
				yc && Nc && 10 == Nc && p.localStorage.getItem(b) !== a.Ya.newValue && a.Ya.newValue !== a.Ya.oldValue ? setTimeout(c, 10) : c()
			}
		} else x(a, u(this.qg, this))
	}
	...
	var Np = function (a) {
		...
		Jp = {name: 'authEvent', ua: 'local'},
		Mp = {name: 'redirectEvent', ua: 'session'}
	var Op = function () {
		this.O = Dp()
	}
	...
	var Pp = {name: 'sessionId', ua: 'session'}
	var Qp = function () {
		this.Vg = null
		this.Se = []
	}
	Qp.prototype.subscribe = function (a) {
		...
		this.Vg ||
			((this.Vg = function (c) {
				for (var d = 0; d < b.Se.length; d++) b.Se[d](c)
			}),
	...
	Sp.prototype.Pc = function () {
		return this.ie
			...
			: (this.ie = Vk().then(
					function () {
						if ('function' !== typeof N('universalLinks.subscribe', p)) throw Tp('cordova-universal-links-plugin-fix is not installed')
						if ('undefined' === typeof N('BuildInfo.packageName', p)) throw Tp('cordova-plugin-buildinfo is not installed')
						if ('function' !== typeof N('cordova.plugins.browsertab.openUrl', p)) throw Tp('cordova-plugin-browsertab is not installed')
						if ('function' !== typeof N('cordova.InAppBrowser.open', p)) throw Tp('cordova-plugin-inappbrowser is not installed')
					},
					function () {
	...
	k.ue = function (a, b, c, d) {
		if (this.Ff) return G(new P('redirect-operation-pending'))
		var e = this,
			f = p.document,
			g = null,
			h = null,
			...
			.then(function () {
				return new E(function (q, y) {
					h = function () {
						...
						q()
						'function' === typeof B && B()
						e.he && 'function' === typeof e.he.close && (e.he.close(), (e.he = null))
						return !1
					}
					e.Ec(h)
					l = function () {
						g ||
							(g = Rj(e.Pl).then(function () {
	...
	var Xp = function (a, b, c, d, e) {
		...
		return a
			...
			.then(function () {
				...
				if ('function' !== typeof y) throw new P('invalid-cordova-configuration')
				var B = null
				y(function (S) {
					if (S) {
						B = N('cordova.plugins.browsertab.openUrl', p)
						if ('function' !== typeof B) throw new P('invalid-cordova-configuration')
						B(q)
					} else {
	...
	var Wp = function (a) {
		...
		Zp = function (a) {
			...
			p.handleOpenURL = function (g) {
				0 == g.toLowerCase().indexOf(N('BuildInfo.packageName', p).toLowerCase() + '://') && e({url: g})
				if ('function' === typeof f)
					try {
						f(g)
					} catch (h) {
	...
	Sp.prototype.Ec = function (a) {
		...
		Wp(this).l(function (b) {
			'auth/invalid-cordova-configuration' === b.code && ((b = new Jl('unknown', null, null, null, new P('no-auth-event'))), a(b))
		})
	}
	...
	var $p = function (a) {
		...
		aq = {name: 'pendingRedirect', ua: 'session'}
	...
	iq.prototype.initialize = function () {
		var a = this
		this.vd || ((this.vd = !0), this.qb.Ec(this.kg))
		var b = this.qb
	...
	k.Ig = function (a) {
		...
		6e5 <= Date.now() - this.Tg && ((this.Hf = {}), (this.Tg = 0))
		if (a && a.getUid() && this.Hf.hasOwnProperty(a.getUid())) return !1
		for (var b = !1, c = 0; c < this.Ee.length; c++) {
			var d = this.Ee[c]
			if (d.ai(a.getType(), a.Ja)) {
				if ((b = this.Dc[a.getType()])) (b.xj(a, d), a && (a.de() || a.Ja) && ((this.Hf[a.getUid()] = !0), (this.Tg = Date.now())))
				b = !0
				break
			}
		}
	...
	iq.prototype.ue = function (a, b, c, d) {
		...
		return bq(this.qe).then(function () {
			return e.qb
				.ue(a, b, c, d)
				.l(function (g) {
					if (jq(g)) throw new P('operation-not-supported-in-this-environment')
					f = g
	...
	eq.prototype.xj = function (a, b) {
		if (a) {
			...
			this.Uj = !(!e && !f)
			'unknown' != c || e || f ? (a.yb ? this.nh(a, b) : b.ae(c, d) ? this.oh(a, b) : G(new P('invalid-auth-event'))) : (qq(this, !1, null, null), F())
		} else G(new P('invalid-auth-event'))
	}
	var kq = function (a) {
		a.ye || ((a.ye = !0), qq(a, !1, null, null))
	}
	...
	var rq = function (a, b) {
			...
			if (a.we.length) for (var c = 0; c < a.we.length; c++) a.we[c](b)
		},
		sq = function (a, b) {
			a.Fd = function () {
				return F(b)
			}
			if (a.xe.length) for (var c = 0; c < a.xe.length; c++) a.xe[c](b)
		},
		qq = function (a, b, c, d) {
			b ? (d ? rq(a, d) : sq(a, c)) : sq(a, {user: null})
			a.xe = []
			a.we = []
		}
	eq.prototype.getRedirectResult = function () {
		var a = this
		return new E(function (b, c) {
			a.Fd ? a.Fd().then(b, c) : (a.xe.push(b), a.we.push(c), tq(a))
		})
	}
	var tq = function (a) {
			var b = new P('timeout')
	...
	var yq = function (a, b, c, d) {
			return c.be().then(function (e) {
				...
				ab(e, {phoneVerificationInfo: Dm(a.Wg)})
				return Q(b, Rn, e)
			})
		},
		zq = function (a, b, c) {
			return c.be().then(function (d) {
				...
				ab(d, {phoneVerificationInfo: Dm(a.Wg)})
				return Q(b, Sn, d)
			})
		},
		Aq = function (a) {
	...
	var Bq = function (a) {
		Aq.call(this, a)
		if (this.Wg.providerId != Hm.PROVIDER_ID) throw new P('argument-error', 'firebase.auth.PhoneMultiFactorAssertion requires a valid firebase.auth.PhoneAuthCredential')
	}
	v(Bq, Aq)
	var Cq = function (a, b) {
		Ii.call(this, a)
	...
	k.unenroll = function (a) {
		...
		return this.jc
			.getIdToken()
			.then(function (e) {
				return Q(d, Wn, {idToken: e, mfaEnrollmentId: c})
			})
			.then(function (e) {
	...
	Hq.prototype.T = function () {
		return {apiKey: this.o.ha, refreshToken: this.Ta, accessToken: this.Wa && this.Wa.toString(), expirationTime: this.md}
	}
	var Iq = function (a, b) {
			'undefined' === typeof b && (a.Wa ? ((b = a.Wa), (b = b.Dg - b.kl)) : (b = 0))
			a.md = Date.now() + 1e3 * b
		},
		Jq = function (a, b) {
			a.Wa = Xl(b.idToken || '')
	...
	Hq.prototype.getToken = function (a) {
		...
		return this.Wa && !this.Ta
			...
			: a || !this.Wa || Date.now() > this.md - 3e4
				? this.Ta
					? Kq(this, {grant_type: 'refresh_token', refresh_token: this.Ta})
					: F(null)
	...
	var Lq = function (a, b) {
		this.hi = a || null
		this.Vi = b || null
		zl(this, {lastSignInTime: rl(b || null), creationTime: rl(a || null)})
	}
	Lq.prototype.clone = function () {
		return new Lq(this.hi, this.Vi)
	}
	Lq.prototype.T = function () {
		return {lastLoginAt: this.Vi, createdAt: this.hi}
	}
	var Mq = function (a, b, c, d, e, f) {
			zl(this, {uid: a, displayName: d || null, photoURL: e || null, email: c || null, phoneNumber: f || null, providerId: b})
		},
		R = function (a, b, c) {
			hj.call(this)
			this.Ka = []
	...
	var Qq = function (a, b) {
			a.N = b
			Zm(a.o, b)
			a.W && ((b = a.W), (a.W = oq(a.ya, a.ha, a.ka, a.N)), a.re && (b.unsubscribe(a), a.W.subscribe(a)))
		},
		Sq = function (a, b) {
	...
	R.prototype.Kg = function () {
		this.Cd.zd && (this.Cd.stop(), this.Cd.start())
	}
	var Vq = function (a) {
			try {
		...
		Wq = function (a) {
			a.ld || a.Cd.zd || (a.Cd.start(), ej(a, 'tokenChanged', a.Pd), Xi(a, 'tokenChanged', a.Pd))
		},
		Xq = function (a) {
		...
		Zq = function (a) {
			for (var b = [], c = 0; c < a.Rf.length; c++) b.push(a.Rf[c](a))
			return dg(b).then(function () {
				return a
			})
		},
		$q = function (a) {
			a.W && !a.re && ((a.re = !0), a.W.subscribe(a))
		},
		Oq = function (a, b) {
			zl(a, {
				uid: b.uid,
		...
		er = function (a, b) {
			b && (dr(a, b.providerId), a.providerData.push(b))
		},
		dr = function (a, b) {
		...
		return this.v(
			br(this)
				...
				.then(function (c) {
					...
					c.accessToken != b.Ui && (Nq(b, c.accessToken), b.uc())
	...
	var Gq = function (a, b) {
		b.idToken && a.Ui != b.idToken && (Jq(a.Nb, b), a.uc(), Nq(a, b.idToken), fr(a, 'refreshToken', a.Nb.Ta))
	}
	...
	var ir = function (a, b, c) {
			var d = Mm(b)
			b = yp(b)
			return Al({user: a, credential: d, additionalUserInfo: b, operationType: c})
		},
		kr = function (a, b) {
			Gq(a, b)
	...
	k.updateProfile = function (a) {
		if (void 0 === a.displayName && void 0 === a.photoURL) return br(this)
		var b = this
		return this.v(
			this.getIdToken()
				.then(function (c) {
	...
	k.unlink = function (a) {
		var b = this
		return this.v(
			gr(this).then(function (c) {
				return Pa(cr(b), a)
					? Dn(b.o, c, [a]).then(function (d) {
							var e = {}
	...
	k.ai = function (a, b) {
		return ('linkViaPopup' == a && (this.Kb || null) == b && this.Jb) ||
			...
			('linkViaRedirect' == a && (this.yc || null) == b) ||
			('reauthViaRedirect' == a && (this.yc || null) == b)
			? !0
			: !1
	}
	k.Vc = function (a, b, c, d) {
		;('linkViaPopup' != a && 'reauthViaPopup' != a) ||
			d != (this.Kb || null) ||
			(c && this.Tc ? this.Tc(c) : b && !c && this.Jb && this.Jb(b), this.La && (this.La.cancel(), (this.La = null)), delete this.Jb, delete this.Tc)
	}
	k.ae = function (a, b) {
	...
	var lr = function (a, b, c, d, e) {
		if (!gl()) return G(new P('operation-not-supported-in-this-environment'))
	...
	var nr = function (a, b, c, d, e) {
			...
			d = d()
				...
				.then(function (h) {
					a.zc && ((h = a.zc), (h = h.O.set(or, a.T(), h.V)))
					return h
				})
				.then(function () {
		...
		mr = function (a) {
			if (!a.W || !a.re) {
				if (a.W && !a.re) throw new P('internal-error')
	...
	k.vi = function (a, b, c, d) {
		...
		c = this.getIdToken()
			.then(function (g) {
				return dm(e.o, {requestUri: a, postBody: d, sessionId: b, idToken: g})
			})
			.then(function (g) {
				f = ir(e, g, 'link')
				return kr(e, g)
	...
	k.wi = function (a, b, c, d) {
		...
		var f = null,
			g = F()
				.then(function () {
					return am(em(e.o, {requestUri: a, sessionId: b, postBody: d, tenantId: c}), e.uid)
				})
				.then(function (h) {
	...
	var qr = function (a, b, c) {
		return a.Ob && !c
			? (b.cancel(), G(a.Ob))
			: b.l(function (d) {
					!d || ('auth/user-disabled' != d.code && 'auth/user-token-expired' != d.code) || (a.Ob || a.dispatchEvent(new Cq('userInvalidated')), (a.Ob = d))
					throw d
				})
	}
	...
	var ur = function (a) {
		...
		or = {name: 'redirectUser', ua: 'session'}
	var xr = function (a) {
		this.V = a
		this.O = Dp()
		this.Xa = null
	...
	var zr = function (a, b) {
		var c = [],
			d
		for (d in zp) zp[d] !== b && c.push(a.O.remove(wr(zp[d]), a.V))
					...
					: a.O.get(d, a.V).then(function (f) {
							return f
								...
								: a.O.get(b, a.V).then(function (g) {
										return g
											? b
											: a.O.get(Ar, a.V).then(function (h) {
													return h ? wr(h) : b
												})
									})
						})
	...
	var Br = function (a) {
		...
		Ar = {name: 'persistence', ua: 'session'}
	var T = function (a) {
		hj.call(this)
		this.wb = !1
		this.Lj = new kp()
		...
		if (this.U().options && this.U().options.apiKey)
			((a = firebase.SDK_VERSION ? cl('JsCore', firebase.SDK_VERSION) : null), (this.o = new Vm(this.U().options && this.U().options.apiKey, Dk(Ek), a)))
		else throw new P('invalid-api-key')
		this.Ka = []
		this.Fc = []
		this.Od = []
	...
	T.prototype.Id = function (a) {
		this.Gb === a || this.wb || ((this.Gb = a), Xm(this.o, this.Gb), this.dispatchEvent(new Kr(this.Gb)))
	}
	...
	var Jr = function (a) {
		...
		Object.defineProperty(a, 'emulatorConfig', {
			get: function () {
				if (this.N) {
					var b = M(this.N.url)
					b = Al({protocol: b.Va, host: b.Ga, port: b.Tb, options: Al({disableWarnings: this.N.disableWarnings})})
				} else b = null
				return b
			},
			enumerable: !1
	...
	T.prototype.toJSON = function () {
		return {apiKey: this.U().options.apiKey, authDomain: this.U().options.authDomain, appName: this.U().name, currentUser: U(this) && U(this).T()}
	}
	var Or = function (a) {
	...
	k.signInWithPopup = function (a) {
		...
		;(!hl() || Xk()) &&
			...
			a.isOAuthProvider &&
			(e = lo(this.U().options.authDomain, this.U().options.apiKey, this.U().name, 'signInViaPopup', a, null, d, firebase.SDK_VERSION || null, null, null, this.ma, this.N))
	...
	var Rr = function (a, b) {
		...
		Fr = function (a, b) {
			U(a) && (Yq(U(a), a.Yj), ej(U(a), 'tokenChanged', a.Pd), ej(U(a), 'userDeleted', a.Wj), ej(U(a), 'userInvalidated', a.Xj), Xq(U(a)))
			b && (b.Rf.push(a.Yj), Xi(b, 'tokenChanged', a.Pd), Xi(b, 'userDeleted', a.Wj), Xi(b, 'userInvalidated', a.Xj), 0 < a.Kc && Wq(b))
			O(a, 'currentUser', b)
			b && (b.Id(a.Gb), Sq(b, a), Rq(b, a.Da), Uq(b, a), Qq(b, a.N), Tq(b, a))
		}
	...
	k.om = function () {
		...
		return Er(this.Pb, b).then(function (c) {
			if (!a.wb) {
				...
				if (U(a) || c) (Fr(a, c), c && ($q(c), (c.zc = a.Uc)), a.W && a.W.subscribe(a), a.uc())
			}
		})
	}
	k.qc = function (a) {
	...
	var Pr = function (a, b) {
		...
		return a.v(
			b
				...
				.then(function () {
					return Al({user: U(a), credential: c, additionalUserInfo: d, operationType: 'signIn'})
				})
		)
	}
	k = T.prototype
	...
	k.signInWithEmailAndPassword = function (a, b) {
		var c = this
		return this.Lb.then(function () {
			return Pr(c, Q(c.o, wm, {email: a, password: b}))
		})
	}
	k.createUserWithEmailAndPassword = function (a, b) {
		var c = this
		return this.Lb.then(function () {
			return Pr(c, Q(c.o, Pn, {email: a, password: b}))
		})
	}
	...
	k.signInAnonymously = function () {
		...
		return this.Lb.then(function () {
			var b = U(a)
			if (b && b.isAnonymous) {
				var c = Al({providerId: null, isNewUser: !1})
				return Al({user: b, credential: null, additionalUserInfo: c, operationType: 'signIn'})
			}
	...
	k.uc = function () {
		if (this.uf) {
			for (var a = 0; a < this.Fc.length; a++) if (this.Fc[a]) this.Fc[a](Ur(this))
			if (this.Ke !== this.getUid() && this.Od.length) for (this.Ke = this.getUid(), a = 0; a < this.Od.length; a++) if (this.Od[a]) this.Od[a](Ur(this))
		}
	}
	k.kk = function (a) {
	...
	var Tr = function (a, b) {
		...
		a.v(
			a.Lb.then(function () {
				!a.wb && Pa(a.Od, b) && a.Ke !== a.getUid() && ((a.Ke = a.getUid()), b(Ur(a)))
			})
		)
	}
	k = T.prototype
	k.delete = function () {
		...
		for (var a = 0; a < this.Ka.length; a++) this.Ka[a].cancel('app-deleted')
		this.Ka = []
		this.Pb && ((a = this.Pb), a.O.removeListener(wr('local'), a.V, this.Hg))
	...
	k.sendSignInLinkToEmail = function (a, b) {
		...
		return this.v(
			F()
				.then(function () {
					var d = new lp(b)
					if (!d.bi) throw new P('argument-error', 'handleCodeInApp must be true when sending sign in link to email')
					return mp(d)
				})
				.then(function (d) {
	...
	var Wr = function (a, b, c, d) {
				...
				if (c.length < e || f < c.length) d = 'Expected ' + (e == f ? (1 == e ? '1 argument' : e + ' arguments') : e + '-' + f + ' arguments') + ' but got ' + c.length + '.'
					...
					for (e = 0; e < c.length; e++)
						if (((f = b[e].optional && void 0 === c[e]), !b[e].Ca(c[e]) && !f)) {
							b = b[e]
							if (0 > e || e >= Vr.length) throw new P('internal-error', 'Argument validator received an unsupported number of arguments.')
							c = Vr[e]
		...
		Yr = function (a, b) {
			return {name: a || '', Fa: 'a function', optional: !!b, Ca: Pc}
		},
		Zr = function (a, b) {
			return {
				name: a || '',
	...
	Y(T.prototype, {
		...
		createUserWithEmailAndPassword: {name: 'createUserWithEmailAndPassword', j: [V('email'), V('password')]},
		...
		onAuthStateChanged: {name: 'onAuthStateChanged', j: [X(W(), Yr(), 'nextOrObserver'), Yr('opt_error', !0), Yr('opt_completed', !0)]},
		onIdTokenChanged: {name: 'onIdTokenChanged', j: [X(W(), Yr(), 'nextOrObserver'), Yr('opt_error', !0), Yr('opt_completed', !0)]},
		sendPasswordResetEmail: {name: 'sendPasswordResetEmail', j: [V('email'), X(W('opt_actionCodeSettings', !0), Zr(null, !0), 'opt_actionCodeSettings', !0)]},
		sendSignInLinkToEmail: {name: 'sendSignInLinkToEmail', j: [V('email'), W('actionCodeSettings')]},
		setPersistence: {name: 'setPersistence', j: [V('persistence')]},
		signInAndRetrieveDataWithCredential: {name: 'signInAndRetrieveDataWithCredential', j: [cs()]},
		signInAnonymously: {name: 'signInAnonymously', j: []},
		signInWithCredential: {name: 'signInWithCredential', j: [cs()]},
		signInWithCustomToken: {name: 'signInWithCustomToken', j: [V('token')]},
		signInWithEmailAndPassword: {name: 'signInWithEmailAndPassword', j: [V('email'), V('password')]},
		signInWithEmailLink: {name: 'signInWithEmailLink', j: [V('email'), V('emailLink', !0)]},
		signInWithPhoneNumber: {name: 'signInWithPhoneNumber', j: [V('phoneNumber'), hs()]},
		signInWithPopup: {name: 'signInWithPopup', j: [es()]},
		signInWithRedirect: {name: 'signInWithRedirect', j: [es()]},
		updateCurrentUser: {
	...
	js(T.prototype, {lc: {name: 'languageCode', jg: X(V(), Zr(), 'languageCode')}, ti: {name: 'tenantId', jg: X(V(), Zr(), 'tenantId')}})
	T.Persistence = zp
	...
	Y(R.prototype, {
		...
		getIdTokenResult: {name: 'getIdTokenResult', j: [Xr('opt_forceRefresh', !0)]},
		getIdToken: {name: 'getIdToken', j: [Xr('opt_forceRefresh', !0)]},
		linkAndRetrieveDataWithCredential: {name: 'linkAndRetrieveDataWithCredential', j: [cs()]},
		linkWithCredential: {name: 'linkWithCredential', j: [cs()]},
		linkWithPhoneNumber: {name: 'linkWithPhoneNumber', j: [V('phoneNumber'), hs()]},
		linkWithPopup: {name: 'linkWithPopup', j: [es()]},
		linkWithRedirect: {name: 'linkWithRedirect', j: [es()]},
		reauthenticateAndRetrieveDataWithCredential: {name: 'reauthenticateAndRetrieveDataWithCredential', j: [cs()]},
		reauthenticateWithCredential: {name: 'reauthenticateWithCredential', j: [cs()]},
		reauthenticateWithPhoneNumber: {name: 'reauthenticateWithPhoneNumber', j: [V('phoneNumber'), hs()]},
		reauthenticateWithPopup: {name: 'reauthenticateWithPopup', j: [es()]},
		reauthenticateWithRedirect: {name: 'reauthenticateWithRedirect', j: [es()]},
		reload: {name: 'reload', j: []},
		sendEmailVerification: {name: 'sendEmailVerification', j: [X(W('opt_actionCodeSettings', !0), Zr(null, !0), 'opt_actionCodeSettings', !0)]},
		toJSON: {name: 'toJSON', j: [V(null, !0)]},
		unlink: {name: 'unlink', j: [V('provider')]},
		updateEmail: {name: 'updateEmail', j: [V('email')]},
		updatePassword: {name: 'updatePassword', j: [V('password')]},
		updatePhoneNumber: {name: 'updatePhoneNumber', j: [cs('phone')]},
		updateProfile: {name: 'updateProfile', j: [W('profile')]},
		verifyBeforeUpdateEmail: {name: 'verifyBeforeUpdateEmail', j: [V('email'), X(W('opt_actionCodeSettings', !0), Zr(null, !0), 'opt_actionCodeSettings', !0)]}
	})
	Y(ro.prototype, {execute: {name: 'execute'}, render: {name: 'render'}, reset: {name: 'reset'}, getResponse: {name: 'getResponse'}})
	Y(mo.prototype, {execute: {name: 'execute'}, render: {name: 'render'}, reset: {name: 'reset'}, getResponse: {name: 'getResponse'}})
	Y(E.prototype, {Cc: {name: 'finally'}, l: {name: 'catch'}, then: {name: 'then'}})
	js(kp.prototype, {appVerificationDisabled: {name: 'appVerificationDisabledForTesting', jg: Xr('appVerificationDisabledForTesting')}})
	Y(np.prototype, {confirm: {name: 'confirm', j: [V('verificationCode')]}})
	Z(
		$l,
		'fromJSON',
		function (a) {
			a = 'string' === typeof a ? JSON.parse(a) : a
			for (var b, c = [hm, zm, Gm, fm], d = 0; d < c.length; d++) if ((b = c[d](a))) return b
			return null
		},
		[X(V(), W(), 'json')]
	)
	...
	Y(um.prototype, {T: {name: 'toJSON', j: [V(null, !0)]}})
	Y(lm.prototype, {addScope: {name: 'addScope', j: [V('scope')]}, setCustomParameters: {name: 'setCustomParameters', j: [W('customOAuthParameters')]}})
	Z(lm, 'credential', mm, [X(V(), W(), 'token')])
	Z(tm, 'credentialWithLink', Bm, [V('email'), V('emailLink')])
	Y(nm.prototype, {addScope: {name: 'addScope', j: [V('scope')]}, setCustomParameters: {name: 'setCustomParameters', j: [W('customOAuthParameters')]}})
	Z(nm, 'credential', om, [X(V(), W(), 'token')])
	Y(pm.prototype, {addScope: {name: 'addScope', j: [V('scope')]}, setCustomParameters: {name: 'setCustomParameters', j: [W('customOAuthParameters')]}})
	Z(pm, 'credential', qm, [X(V(), X(W(), Zr()), 'idToken'), X(V(), Zr(), 'accessToken', !0)])
	Y(rm.prototype, {setCustomParameters: {name: 'setCustomParameters', j: [W('customOAuthParameters')]}})
	Z(rm, 'credential', sm, [X(V(), W(), 'token'), V('secret', !0)])
	Y(km.prototype, {
		addScope: {name: 'addScope', j: [V('scope')]},
		credential: {name: 'credential', j: [X(V(), X(W(), Zr()), 'optionsOrIdToken'), X(V(), Zr(), 'accessToken', !0)]},
		setCustomParameters: {name: 'setCustomParameters', j: [W('customOAuthParameters')]}
	})
	Y(gm.prototype, {T: {name: 'toJSON', j: [V(null, !0)]}})
	Y(bm.prototype, {T: {name: 'toJSON', j: [V(null, !0)]}})
							...
							Ca: function (c) {
								return c
									? c.session && c.phoneNumber
										? fs(c.session, 'enroll') && 'string' === typeof c.phoneNumber
										: c.session && c.multiFactorHint
											? fs(c.session, 'signin') && gs(c.multiFactorHint)
											: c.session && c.multiFactorUid
												? fs(c.session, 'signin') && 'string' === typeof c.multiFactorUid
												: c.phoneNumber
	...
	Y(Cm.prototype, {T: {name: 'toJSON', j: [V(null, !0)]}})
	Y(P.prototype, {toJSON: {name: 'toJSON', j: [V(null, !0)]}})
	Y(Om.prototype, {toJSON: {name: 'toJSON', j: [V(null, !0)]}})
	Y(Ul.prototype, {toJSON: {name: 'toJSON', j: [V(null, !0)]}})
	Y(vq.prototype, {toJSON: {name: 'toJSON', j: [V(null, !0)]}})
	Y(uq.prototype, {resolveSignIn: {name: 'resolveSignIn', j: [ds()]}})
	Y(Eq.prototype, {
		getSession: {name: 'getSession', j: []},
		enroll: {name: 'enroll', j: [ds(), V('displayName', !0)]},
		unenroll: {name: 'unenroll', j: [X({name: 'multiFactorInfo', Fa: 'a valid multiFactorInfo', optional: !1, Ca: gs}, V(), 'multiFactorInfoIdentifier')]}
	})
	Y(Co.prototype, {clear: {name: 'clear', j: []}, render: {name: 'render', j: []}, verify: {name: 'verify', j: []}})
	...
	;(function () {
		if ('undefined' !== typeof firebase && firebase.INTERNAL && firebase.INTERNAL.registerService) {
			...
			firebase.INTERNAL.registerService(
				...
				function (b, c) {
					b = new T(b)
					c({INTERNAL: {getUid: u(b.getUid, b), getToken: u(b.Ok, b), addAuthTokenListener: u(b.kk, b), removeAuthTokenListener: u(b.Ql, b)}})
					return b
				},
				a,
				function (b, c) {
	...
	ms.prototype.th = function (a, b) {
		if (this.Lh) this.ah.register(a, b, tg)
	...
	var os = function (a, b) {
		return a.Df.sendMessage({type: 'authEvent', authEvent: b && b.T()}).then(function (c) {
	...
	var ps = function (a, b, c) {
		...
		this.rc = new ns(function (f) {
			return nn(e.o).then(function (g) {
				if (!Rk(g, f)) throw (e.destroy(), new Ul(f))
			})
		})
		this.wc = Io(p)
		this.Ni = !1
	...
	ps.prototype.lj = function (a) {
		...
		return Kp(this.Jd)
			.then(function (d) {
				if ((c = d)) return os(b.rc, d)
				if (a) return os(b.rc, new Jl('unknown', null, null, null, new P('no-auth-event')))
			})
			.then(function () {
				if (c) return Lp(b.Jd)
			})
			...
			rs.start().l(function (d) {
				if (d && 'auth/unauthorized-domain' == d.code)
					((d = M(rs.rd())),
						...
						ql(d))
				else if (d && d.message) ql(d.message)
				else throw d
			})
		}
