...
<main>
	<div class="text-gray-400 p-4">
		<h2 class="text-2xl text-white mb-4">Om konserter appen</h2>
		<p class="mb-4">
			Konserter er en app for å registrere og holde oversikt over konserter du har vært på. Du kan legge inn informasjon om artist, spillested, festival, pris, dato og notater. Du
			kan også gi konserten en rating og se tidligere registrerte konserter i feeden.
		</p>
		<p class="mb-4">Appen er laget av Alireza Balouch som en hobbyprosjekt.</p>
